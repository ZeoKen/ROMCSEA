...
function DiskFileHandler:EnterServer()
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(userDirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(userDirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(serverDirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(serverDirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  local roleDirectoryPath = IOPathConfig.Paths.USER.Role
  capacity = IOPathConfig.Datas.USER.Role.LRU_Count
  capacity = capacity or 0
  parentLRUCount = IOPathConfig.Datas.USER.Server.LRU_Count
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(roleDirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(roleDirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(accountDirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(accountDirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(accountX_DirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(accountX_DirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(serverX_DirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(serverX_DirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterBeautifulArea()
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(baPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(baPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(baPicturePath, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(baPicturePath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(baThumbnailPath, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(baThumbnailPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(gamePhotoDirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(gamePhotoDirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(scenicSpotPhotoDirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(scenicSpotPhotoDirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  local postcardDirectoryPath = IOPathConfig.Paths.Extension.Postcard
  capacity = IOPathConfig.Datas.Extension.Postcard.LRUCount or 0
  parentLRUCount = IOPathConfig.Datas.Extension.ServerX.LRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(postcardDirectoryPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(postcardDirectoryPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ssPhotoShareDP, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(ssPhotoShareDP, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ssPhotoShareOriginDP, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ssPhotoShareOriginDP, currentServerTime, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = IOPathConfig.Datas.Extension.ScenicSpotPhotoShare.LRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ssPhotoShareThumbnailDP, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ssPhotoShareThumbnailDP, currentServerTime, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = IOPathConfig.Datas.Extension.ScenicSpotPhoto.LRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ssPhotoRolesDP, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(ssPhotoRolesDP, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ssPhotoRolesOriginDP, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ssPhotoRolesOriginDP, currentServerTime, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = IOPathConfig.Datas.Extension.ScenicSpotPhotoRoles.LRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ssPhotoRolesThumbnailDP, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ssPhotoRolesThumbnailDP, currentServerTime, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterUnionWallPhoto()
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(uwpPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(uwpPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(uwpOriginPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(uwpOriginPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(uwpThumbnailPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(uwpThumbnailPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterPersonalPhoto()
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ppPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(ppPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ppOriginPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ppOriginPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ppThumbnailPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ppThumbnailPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterUnionLogo()
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ulPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(ulPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ulOriginPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ulOriginPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
  ...
  parentLRUCount = IOPathConfig.Datas.USER.UnionLogo.LRU_Count or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(ulThumbnailPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(ulThumbnailPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterMarryPhoto()
  ...
  local parentLRUCount = IOPathConfig.Datas.USER.Role.LRU_Count or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(mpPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(mpPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(mpOriginPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(mpOriginPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterPrivateChat()
  ...
  parentLRUCount = parentLRUCount or 0
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(pcPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(pcPath, currentServerTime, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterChat()
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(chatPath, capacity, currentServerTime, 0 < parentLRUCount, false)
  else
    DiskFileManager.Instance:InitializeDirectory(chatPath, currentServerTime, 0 < parentLRUCount)
  end
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(chatSpeechPath, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(chatSpeechPath, currentServerTime, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterActivityPicture()
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(apPath, capacity, currentServerTime / 1000, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(apPath, currentServerTime / 1000, 0 < parentLRUCount)
  end
end
...
function DiskFileHandler:EnterDirectory(path, pCapacity, parent_lru_count)
  ...
  if 0 < capacity then
    DiskFileManager.Instance:InitializeLRUDirectory(path, capacity, currentServerTime, 0 < parentLRUCount, true)
  else
    DiskFileManager.Instance:InitializeDirectory(path, currentServerTime, 0 < parentLRUCount)
  end
end
