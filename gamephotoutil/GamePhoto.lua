...
function GamePhoto.SetPlayerSdkUid(player_sdk_uid)
  GamePhoto.playerSdkUid = player_sdk_uid
end
...
function GamePhoto.SetPhotoFileMD5_Stage(p_index, md5)
  GamePhoto.photoFileMD5[p_index .. "st"] = md5
end

function GamePhoto.GetPhotoFileMD5_Stage(p_index)
  return GamePhoto.photoFileMD5[p_index .. "st"]
end
