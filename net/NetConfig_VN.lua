...
NetConfig.PrivateGameServerUrlPort = 6004
NetConfig.AnnounceAddress = "storage.googleapis.com/ro-sea-notice"
...
NetConfig.UCloud_Report = "https://upm.xindong.com/api/v1/pushmessage"
