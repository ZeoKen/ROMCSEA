ITEMPARAM = {
  ...
  ITEMPARAM_GEM_DECOMPOSE = 163,
  ITEMPARAM_GEM_UPGRADE = 164,
  ITEMPARAM_MEMORY_UPGRADE = 165,
  ITEMPARAM_CARD_LEVELUP = 166
}
EPACKTYPE = {
  EPACKTYPE_MIN = 0,
  EPACKTYPE_MAIN = 1,
...
EITEMTYPE = {
  ...
  EITEMTYPE_ABYSS_CONTRIBUTE = 558,
...
EEXCHANGECARDTYPE = {
  ...
  EEXCHANGECARDTYPE_MVPCOMPOSE_2 = 6
}
ELOTTERYTYPE = {
  ELotteryType_Min = 0,
  ELotteryType_Head = 1,
  ...
  ELotteryType_Mvp_Card_Compose_2 = 42,
  ELotteryType_Max = 43
}
