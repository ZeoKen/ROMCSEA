...
CHATDATA_EXPRESSIONID_FIELD = protobuf.FieldDescriptor()
CHATDATA_PHOTO_FIELD = protobuf.FieldDescriptor()
CHATDATA_POSTCARD_FIELD = protobuf.FieldDescriptor()
...
LISTDATA_CHATTIME_FIELD = protobuf.FieldDescriptor()
...
CHATDATA_EXPRESSIONID_FIELD.name = "expressionId"
CHATDATA_EXPRESSIONID_FIELD.full_name = ".Cmd.ChatData.expressionId"
CHATDATA_EXPRESSIONID_FIELD.number = 6
CHATDATA_EXPRESSIONID_FIELD.index = 5
CHATDATA_EXPRESSIONID_FIELD.label = 1
CHATDATA_EXPRESSIONID_FIELD.has_default_value = false
CHATDATA_EXPRESSIONID_FIELD.default_value = 0
CHATDATA_EXPRESSIONID_FIELD.type = 13
CHATDATA_EXPRESSIONID_FIELD.cpp_type = 3
CHATDATA_PHOTO_FIELD.name = "photo"
CHATDATA_PHOTO_FIELD.full_name = ".Cmd.ChatData.photo"
CHATDATA_PHOTO_FIELD.number = 7
CHATDATA_PHOTO_FIELD.index = 6
CHATDATA_PHOTO_FIELD.label = 1
CHATDATA_PHOTO_FIELD.has_default_value = false
CHATDATA_PHOTO_FIELD.default_value = ""
CHATDATA_PHOTO_FIELD.type = 9
CHATDATA_PHOTO_FIELD.cpp_type = 9
CHATDATA_POSTCARD_FIELD.name = "postcard"
CHATDATA_POSTCARD_FIELD.full_name = ".Cmd.ChatData.postcard"
CHATDATA_POSTCARD_FIELD.number = 8
CHATDATA_POSTCARD_FIELD.index = 7
CHATDATA_POSTCARD_FIELD.label = 1
CHATDATA_POSTCARD_FIELD.has_default_value = false
CHATDATA_POSTCARD_FIELD.default_value = ""
CHATDATA_POSTCARD_FIELD.type = 9
CHATDATA_POSTCARD_FIELD.cpp_type = 9
...
CHATDATA.fields = {
  ...
  CHATDATA_EXPRESSIONID_FIELD,
  CHATDATA_PHOTO_FIELD,
  CHATDATA_POSTCARD_FIELD
}
...
LISTDATA_CHATTIME_FIELD.name = "chatTime"
LISTDATA_CHATTIME_FIELD.full_name = ".Cmd.ListData.chatTime"
LISTDATA_CHATTIME_FIELD.number = 3
LISTDATA_CHATTIME_FIELD.index = 2
LISTDATA_CHATTIME_FIELD.label = 1
LISTDATA_CHATTIME_FIELD.has_default_value = false
LISTDATA_CHATTIME_FIELD.default_value = 0
LISTDATA_CHATTIME_FIELD.type = 4
LISTDATA_CHATTIME_FIELD.cpp_type = 4
