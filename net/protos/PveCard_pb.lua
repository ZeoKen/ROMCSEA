...
EPVECARDPARAM_EPVE_GET_REWARD_CMD_ENUM = protobuf.EnumValueDescriptor()
...
INVITEPVECARDCMD_ENTRANCEID_FIELD = protobuf.FieldDescriptor()
INVITEPVECARDCMD_LEFTTIME_FIELD = protobuf.FieldDescriptor()
...
ENTERPVECARDCMD_ZONEID_FIELD = protobuf.FieldDescriptor()
...
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD = protobuf.FieldDescriptor()
...
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD = protobuf.FieldDescriptor()
...
GETPVECARDREWARDCMD = protobuf.Descriptor()
GETPVECARDREWARDCMD_CMD_FIELD = protobuf.FieldDescriptor()
GETPVECARDREWARDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
...
EPVECARDPARAM_EPVE_GET_REWARD_CMD_ENUM.name = "EPVE_GET_REWARD_CMD"
EPVECARDPARAM_EPVE_GET_REWARD_CMD_ENUM.index = 10
EPVECARDPARAM_EPVE_GET_REWARD_CMD_ENUM.number = 11
EPVECARDPARAM.name = "EPveCardParam"
EPVECARDPARAM.full_name = ".Cmd.EPveCardParam"
EPVECARDPARAM.values = {
  EPVECARDPARAM_EPVE_INVITE_TEAM_CMD_ENUM,
  EPVECARDPARAM_EPVE_REPLY_TEAM_CMD_ENUM,
  EPVECARDPARAM_EPVE_ENTER_RAID_CMD_ENUM,
  EPVECARDPARAM_EPVE_QUERY_ALL_CARD_CMD_ENUM,
  EPVECARDPARAM_EPVE_SELECT_CARD_CMD_ENUM,
  EPVECARDPARAM_EPVE_SELECTED_CARD_CMD_ENUM,
  EPVECARDPARAM_EPVE_UPDATE_CARD_CMD_ENUM,
  EPVECARDPARAM_EPVE_BEGIN_FIRE_CMD_ENUM,
  EPVECARDPARAM_EPVE_FINISH_CARD_CMD_ENUM,
  EPVECARDPARAM_EPVE_PLAY_CARD_CMD_ENUM,
  EPVECARDPARAM_EPVE_GET_REWARD_CMD_ENUM
}
...
INVITEPVECARDCMD_ENTRANCEID_FIELD.name = "entranceid"
INVITEPVECARDCMD_ENTRANCEID_FIELD.full_name = ".Cmd.InvitePveCardCmd.entranceid"
INVITEPVECARDCMD_ENTRANCEID_FIELD.number = 5
INVITEPVECARDCMD_ENTRANCEID_FIELD.index = 4
INVITEPVECARDCMD_ENTRANCEID_FIELD.label = 1
INVITEPVECARDCMD_ENTRANCEID_FIELD.has_default_value = false
INVITEPVECARDCMD_ENTRANCEID_FIELD.default_value = 0
INVITEPVECARDCMD_ENTRANCEID_FIELD.type = 13
INVITEPVECARDCMD_ENTRANCEID_FIELD.cpp_type = 3
INVITEPVECARDCMD_LEFTTIME_FIELD.name = "lefttime"
INVITEPVECARDCMD_LEFTTIME_FIELD.full_name = ".Cmd.InvitePveCardCmd.lefttime"
INVITEPVECARDCMD_LEFTTIME_FIELD.number = 6
INVITEPVECARDCMD_LEFTTIME_FIELD.index = 5
INVITEPVECARDCMD_LEFTTIME_FIELD.label = 1
INVITEPVECARDCMD_LEFTTIME_FIELD.has_default_value = false
INVITEPVECARDCMD_LEFTTIME_FIELD.default_value = 0
INVITEPVECARDCMD_LEFTTIME_FIELD.type = 13
INVITEPVECARDCMD_LEFTTIME_FIELD.cpp_type = 3
...
INVITEPVECARDCMD.fields = {
  INVITEPVECARDCMD_CMD_FIELD,
  INVITEPVECARDCMD_PARAM_FIELD,
  INVITEPVECARDCMD_CONFIGID_FIELD,
  INVITEPVECARDCMD_ISCANCEL_FIELD,
  INVITEPVECARDCMD_ENTRANCEID_FIELD,
  INVITEPVECARDCMD_LEFTTIME_FIELD
}
...
REPLYPVECARDCMD.fields = {
  REPLYPVECARDCMD_CMD_FIELD,
  REPLYPVECARDCMD_PARAM_FIELD,
  REPLYPVECARDCMD_AGREE_FIELD,
  REPLYPVECARDCMD_CHARID_FIELD
}
...
ENTERPVECARDCMD_ZONEID_FIELD.name = "zoneid"
ENTERPVECARDCMD_ZONEID_FIELD.full_name = ".Cmd.EnterPveCardCmd.zoneid"
ENTERPVECARDCMD_ZONEID_FIELD.number = 4
ENTERPVECARDCMD_ZONEID_FIELD.index = 3
ENTERPVECARDCMD_ZONEID_FIELD.label = 1
ENTERPVECARDCMD_ZONEID_FIELD.has_default_value = true
ENTERPVECARDCMD_ZONEID_FIELD.default_value = 0
ENTERPVECARDCMD_ZONEID_FIELD.type = 13
ENTERPVECARDCMD_ZONEID_FIELD.cpp_type = 3
...
ENTERPVECARDCMD.fields = {
  ENTERPVECARDCMD_CMD_FIELD,
  ENTERPVECARDCMD_PARAM_FIELD,
  ENTERPVECARDCMD_CONFIGID_FIELD,
  ENTERPVECARDCMD_ZONEID_FIELD
}
...
PVECARDINFO.fields = {
  PVECARDINFO_INDEX_FIELD,
  PVECARDINFO_CARDIDS_FIELD
}
...
QUERYCARDINFOCMD.fields = {
  QUERYCARDINFOCMD_CMD_FIELD,
  QUERYCARDINFOCMD_PARAM_FIELD,
  QUERYCARDINFOCMD_CARDS_FIELD
}
...
SELECTPVECARDCMD.fields = {
  SELECTPVECARDCMD_CMD_FIELD,
  SELECTPVECARDCMD_PARAM_FIELD,
  SELECTPVECARDCMD_INDEX_FIELD
}
...
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.name = "totalprocess"
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.full_name = ".Cmd.SyncProcessPveCardCmd.totalprocess"
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.number = 5
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.index = 4
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.label = 1
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.has_default_value = false
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.default_value = 0
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.type = 13
SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD.cpp_type = 3
...
SYNCPROCESSPVECARDCMD.fields = {
  SYNCPROCESSPVECARDCMD_CMD_FIELD,
  SYNCPROCESSPVECARDCMD_PARAM_FIELD,
  SYNCPROCESSPVECARDCMD_CARD_FIELD,
  SYNCPROCESSPVECARDCMD_PROCESS_FIELD,
  SYNCPROCESSPVECARDCMD_TOTALPROCESS_FIELD
}
...
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.name = "totalprocess"
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.full_name = ".Cmd.UpdateProcessPveCardCmd.totalprocess"
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.number = 4
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.index = 3
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.label = 1
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.has_default_value = false
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.default_value = 0
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.type = 13
UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD.cpp_type = 3
...
UPDATEPROCESSPVECARDCMD.fields = {
  UPDATEPROCESSPVECARDCMD_CMD_FIELD,
  UPDATEPROCESSPVECARDCMD_PARAM_FIELD,
  UPDATEPROCESSPVECARDCMD_PROCESS_FIELD,
  UPDATEPROCESSPVECARDCMD_TOTALPROCESS_FIELD
}
...
BEGINFIREPVECARDCMD.fields = {
  BEGINFIREPVECARDCMD_CMD_FIELD,
  BEGINFIREPVECARDCMD_PARAM_FIELD
}
...
FINISHPLAYCARDCMD.fields = {
  FINISHPLAYCARDCMD_CMD_FIELD,
  FINISHPLAYCARDCMD_PARAM_FIELD
}
...
PLAYPVECARDCMD.fields = {
  PLAYPVECARDCMD_CMD_FIELD,
  PLAYPVECARDCMD_PARAM_FIELD,
  PLAYPVECARDCMD_NPCGUID_FIELD,
  PLAYPVECARDCMD_CARDIDS_FIELD
}
PLAYPVECARDCMD.is_extendable = false
PLAYPVECARDCMD.extensions = {}
GETPVECARDREWARDCMD_CMD_FIELD.name = "cmd"
GETPVECARDREWARDCMD_CMD_FIELD.full_name = ".Cmd.GetPveCardRewardCmd.cmd"
GETPVECARDREWARDCMD_CMD_FIELD.number = 1
GETPVECARDREWARDCMD_CMD_FIELD.index = 0
GETPVECARDREWARDCMD_CMD_FIELD.label = 1
GETPVECARDREWARDCMD_CMD_FIELD.has_default_value = true
GETPVECARDREWARDCMD_CMD_FIELD.default_value = 66
GETPVECARDREWARDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
GETPVECARDREWARDCMD_CMD_FIELD.type = 14
GETPVECARDREWARDCMD_CMD_FIELD.cpp_type = 8
GETPVECARDREWARDCMD_PARAM_FIELD.name = "param"
GETPVECARDREWARDCMD_PARAM_FIELD.full_name = ".Cmd.GetPveCardRewardCmd.param"
GETPVECARDREWARDCMD_PARAM_FIELD.number = 2
GETPVECARDREWARDCMD_PARAM_FIELD.index = 1
GETPVECARDREWARDCMD_PARAM_FIELD.label = 1
GETPVECARDREWARDCMD_PARAM_FIELD.has_default_value = true
GETPVECARDREWARDCMD_PARAM_FIELD.default_value = 11
GETPVECARDREWARDCMD_PARAM_FIELD.enum_type = EPVECARDPARAM
GETPVECARDREWARDCMD_PARAM_FIELD.type = 14
GETPVECARDREWARDCMD_PARAM_FIELD.cpp_type = 8
GETPVECARDREWARDCMD.name = "GetPveCardRewardCmd"
GETPVECARDREWARDCMD.full_name = ".Cmd.GetPveCardRewardCmd"
GETPVECARDREWARDCMD.nested_types = {}
GETPVECARDREWARDCMD.enum_types = {}
GETPVECARDREWARDCMD.fields = {
  GETPVECARDREWARDCMD_CMD_FIELD,
  GETPVECARDREWARDCMD_PARAM_FIELD
}
GETPVECARDREWARDCMD.is_extendable = false
GETPVECARDREWARDCMD.extensions = {}
...
GetPveCardRewardCmd = protobuf.Message(GETPVECARDREWARDCMD)
