...
TOWERPARAM_ETOWERPARAM_LAUNCH_ENUM = protobuf.EnumValueDescriptor()
...
TOWERLAUNCHCMD = protobuf.Descriptor()
TOWERLAUNCHCMD_CMD_FIELD = protobuf.FieldDescriptor()
TOWERLAUNCHCMD_PARAM_FIELD = protobuf.FieldDescriptor()
TOWERLAUNCHCMD_TOLAYER_FIELD = protobuf.FieldDescriptor()
TOWERLAUNCHCMD_SUCCESS_FIELD = protobuf.FieldDescriptor()
...
TOWERPARAM_ETOWERPARAM_LAUNCH_ENUM.name = "ETOWERPARAM_LAUNCH"
TOWERPARAM_ETOWERPARAM_LAUNCH_ENUM.index = 9
TOWERPARAM_ETOWERPARAM_LAUNCH_ENUM.number = 11
...
TOWERPARAM.values = {
  ...
  TOWERPARAM_ETOWERPARAM_LAUNCH_ENUM
}
...
TOWERLAUNCHCMD_CMD_FIELD.name = "cmd"
TOWERLAUNCHCMD_CMD_FIELD.full_name = ".Cmd.TowerLaunchCmd.cmd"
TOWERLAUNCHCMD_CMD_FIELD.number = 1
TOWERLAUNCHCMD_CMD_FIELD.index = 0
TOWERLAUNCHCMD_CMD_FIELD.label = 1
TOWERLAUNCHCMD_CMD_FIELD.has_default_value = true
TOWERLAUNCHCMD_CMD_FIELD.default_value = 20
TOWERLAUNCHCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
TOWERLAUNCHCMD_CMD_FIELD.type = 14
TOWERLAUNCHCMD_CMD_FIELD.cpp_type = 8
TOWERLAUNCHCMD_PARAM_FIELD.name = "param"
TOWERLAUNCHCMD_PARAM_FIELD.full_name = ".Cmd.TowerLaunchCmd.param"
TOWERLAUNCHCMD_PARAM_FIELD.number = 2
TOWERLAUNCHCMD_PARAM_FIELD.index = 1
TOWERLAUNCHCMD_PARAM_FIELD.label = 1
TOWERLAUNCHCMD_PARAM_FIELD.has_default_value = true
TOWERLAUNCHCMD_PARAM_FIELD.default_value = 11
TOWERLAUNCHCMD_PARAM_FIELD.enum_type = TOWERPARAM
TOWERLAUNCHCMD_PARAM_FIELD.type = 14
TOWERLAUNCHCMD_PARAM_FIELD.cpp_type = 8
TOWERLAUNCHCMD_TOLAYER_FIELD.name = "tolayer"
TOWERLAUNCHCMD_TOLAYER_FIELD.full_name = ".Cmd.TowerLaunchCmd.tolayer"
TOWERLAUNCHCMD_TOLAYER_FIELD.number = 3
TOWERLAUNCHCMD_TOLAYER_FIELD.index = 2
TOWERLAUNCHCMD_TOLAYER_FIELD.label = 1
TOWERLAUNCHCMD_TOLAYER_FIELD.has_default_value = false
TOWERLAUNCHCMD_TOLAYER_FIELD.default_value = 0
TOWERLAUNCHCMD_TOLAYER_FIELD.type = 13
TOWERLAUNCHCMD_TOLAYER_FIELD.cpp_type = 3
TOWERLAUNCHCMD_SUCCESS_FIELD.name = "success"
TOWERLAUNCHCMD_SUCCESS_FIELD.full_name = ".Cmd.TowerLaunchCmd.success"
TOWERLAUNCHCMD_SUCCESS_FIELD.number = 4
TOWERLAUNCHCMD_SUCCESS_FIELD.index = 3
TOWERLAUNCHCMD_SUCCESS_FIELD.label = 1
TOWERLAUNCHCMD_SUCCESS_FIELD.has_default_value = false
TOWERLAUNCHCMD_SUCCESS_FIELD.default_value = false
TOWERLAUNCHCMD_SUCCESS_FIELD.type = 8
TOWERLAUNCHCMD_SUCCESS_FIELD.cpp_type = 7
TOWERLAUNCHCMD.name = "TowerLaunchCmd"
TOWERLAUNCHCMD.full_name = ".Cmd.TowerLaunchCmd"
TOWERLAUNCHCMD.nested_types = {}
TOWERLAUNCHCMD.enum_types = {}
TOWERLAUNCHCMD.fields = {
  TOWERLAUNCHCMD_CMD_FIELD,
  TOWERLAUNCHCMD_PARAM_FIELD,
  TOWERLAUNCHCMD_TOLAYER_FIELD,
  TOWERLAUNCHCMD_SUCCESS_FIELD
}
TOWERLAUNCHCMD.is_extendable = false
TOWERLAUNCHCMD.extensions = {}
...
TowerLaunchCmd = protobuf.Message(TOWERLAUNCHCMD)
