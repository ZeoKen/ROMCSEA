...
QUESTPARAM_QUESTPARAM_QUERY_ABYSS_LIST_ENUM = protobuf.EnumValueDescriptor()
QUESTPARAM_QUESTPARAM_UPDATE_ABYSS_HELPCOUNT_ENUM = protobuf.EnumValueDescriptor()
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_INFO_NTF_ENUM = protobuf.EnumValueDescriptor()
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_HP_UPDATE_ENUM = protobuf.EnumValueDescriptor()
QUESTPARAM_QUESTPARAM_ABYSSDRAGON_ONOFF_ENUM = protobuf.EnumValueDescriptor()
...
EQUESTTYPE_EQUESTTYPE_ACC_WORLDBOSS_ENUM = protobuf.EnumValueDescriptor()
EQUESTTYPE_EQUESTTYPE_ABYSS_DAILY_ENUM = protobuf.EnumValueDescriptor()
...
EQUESTSTEP_EQUESTSTEP_CLIENT_DELAY_ENUM = protobuf.EnumValueDescriptor()
EQUESTSTEP_EQUESTSTEP_INHERITSKILL_ENUM = protobuf.EnumValueDescriptor()
...
EQUESTACTION_EQUESTACTION_QUICK_SUBMIT_ABYSS_ENUM = protobuf.EnumValueDescriptor()
...
QUERYABYSSQUESTLISTQUESTCMD = protobuf.Descriptor()
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD = protobuf.FieldDescriptor()
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD = protobuf.FieldDescriptor()
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD = protobuf.FieldDescriptor()
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD = protobuf.FieldDescriptor()
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD = protobuf.FieldDescriptor()
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD = protobuf.FieldDescriptor()
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD = protobuf.FieldDescriptor()
UPDATEABYSSHELPCOUNTQUESTCMD = protobuf.Descriptor()
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD = protobuf.FieldDescriptor()
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD = protobuf.FieldDescriptor()
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD = protobuf.FieldDescriptor()
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD = protobuf.FieldDescriptor()
...
ABYSSDRAGONINFONTFQUESTCMD = protobuf.Descriptor()
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONHPUPDATEQUESTCMD = protobuf.Descriptor()
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONONOFFQUESTCMD = protobuf.Descriptor()
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD = protobuf.FieldDescriptor()
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD = protobuf.FieldDescriptor()
...
QUESTPARAM_QUESTPARAM_QUERY_ABYSS_LIST_ENUM.name = "QUESTPARAM_QUERY_ABYSS_LIST"
QUESTPARAM_QUESTPARAM_QUERY_ABYSS_LIST_ENUM.index = 48
QUESTPARAM_QUESTPARAM_QUERY_ABYSS_LIST_ENUM.number = 54
QUESTPARAM_QUESTPARAM_UPDATE_ABYSS_HELPCOUNT_ENUM.name = "QUESTPARAM_UPDATE_ABYSS_HELPCOUNT"
QUESTPARAM_QUESTPARAM_UPDATE_ABYSS_HELPCOUNT_ENUM.index = 49
QUESTPARAM_QUESTPARAM_UPDATE_ABYSS_HELPCOUNT_ENUM.number = 55
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_INFO_NTF_ENUM.name = "QUESTPARAM_ABYSSDRAGRON_INFO_NTF"
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_INFO_NTF_ENUM.index = 50
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_INFO_NTF_ENUM.number = 56
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_HP_UPDATE_ENUM.name = "QUESTPARAM_ABYSSDRAGRON_HP_UPDATE"
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_HP_UPDATE_ENUM.index = 51
QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_HP_UPDATE_ENUM.number = 57
QUESTPARAM_QUESTPARAM_ABYSSDRAGON_ONOFF_ENUM.name = "QUESTPARAM_ABYSSDRAGON_ONOFF"
QUESTPARAM_QUESTPARAM_ABYSSDRAGON_ONOFF_ENUM.index = 52
QUESTPARAM_QUESTPARAM_ABYSSDRAGON_ONOFF_ENUM.number = 58
...
QUESTPARAM.values = {
  ...
  QUESTPARAM_QUESTPARAM_QUERY_ABYSS_LIST_ENUM,
  QUESTPARAM_QUESTPARAM_UPDATE_ABYSS_HELPCOUNT_ENUM,
  QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_INFO_NTF_ENUM,
  QUESTPARAM_QUESTPARAM_ABYSSDRAGRON_HP_UPDATE_ENUM,
  QUESTPARAM_QUESTPARAM_ABYSSDRAGON_ONOFF_ENUM
}
...
EQUESTTYPE_EQUESTTYPE_ACC_WORLDBOSS_ENUM.name = "EQUESTTYPE_ACC_WORLDBOSS"
EQUESTTYPE_EQUESTTYPE_ACC_WORLDBOSS_ENUM.index = 74
EQUESTTYPE_EQUESTTYPE_ACC_WORLDBOSS_ENUM.number = 74
EQUESTTYPE_EQUESTTYPE_ABYSS_DAILY_ENUM.name = "EQUESTTYPE_ABYSS_DAILY"
EQUESTTYPE_EQUESTTYPE_ABYSS_DAILY_ENUM.index = 75
EQUESTTYPE_EQUESTTYPE_ABYSS_DAILY_ENUM.number = 75
EQUESTTYPE_EQUESTTYPE_MAX_ENUM.name = "EQUESTTYPE_MAX"
EQUESTTYPE_EQUESTTYPE_MAX_ENUM.index = 76
EQUESTTYPE_EQUESTTYPE_MAX_ENUM.number = 76
...
EQUESTTYPE.values = {
  ...
  EQUESTTYPE_EQUESTTYPE_ACC_WORLDBOSS_ENUM,
  EQUESTTYPE_EQUESTTYPE_ABYSS_DAILY_ENUM,
...
EQUESTSTEP_EQUESTSTEP_CLIENT_DELAY_ENUM.name = "EQUESTSTEP_CLIENT_DELAY"
EQUESTSTEP_EQUESTSTEP_CLIENT_DELAY_ENUM.index = 169
EQUESTSTEP_EQUESTSTEP_CLIENT_DELAY_ENUM.number = 175
EQUESTSTEP_EQUESTSTEP_INHERITSKILL_ENUM.name = "EQUESTSTEP_INHERITSKILL"
EQUESTSTEP_EQUESTSTEP_INHERITSKILL_ENUM.index = 170
EQUESTSTEP_EQUESTSTEP_INHERITSKILL_ENUM.number = 176
EQUESTSTEP_EQUESTSTEP_MAX_ENUM.name = "EQUESTSTEP_MAX"
EQUESTSTEP_EQUESTSTEP_MAX_ENUM.index = 171
EQUESTSTEP_EQUESTSTEP_MAX_ENUM.number = 177
...
EQUESTSTEP.values = {
  ...
  EQUESTSTEP_EQUESTSTEP_CLIENT_DELAY_ENUM,
  EQUESTSTEP_EQUESTSTEP_INHERITSKILL_ENUM,
...
EQUESTACTION_EQUESTACTION_QUICK_SUBMIT_ABYSS_ENUM.name = "EQUESTACTION_QUICK_SUBMIT_ABYSS"
EQUESTACTION_EQUESTACTION_QUICK_SUBMIT_ABYSS_ENUM.index = 8
EQUESTACTION_EQUESTACTION_QUICK_SUBMIT_ABYSS_ENUM.number = 8
EQUESTACTION_EQUESTACTION_MAX_ENUM.name = "EQUESTACTION_MAX"
EQUESTACTION_EQUESTACTION_MAX_ENUM.index = 9
EQUESTACTION_EQUESTACTION_MAX_ENUM.number = 9
...
EQUESTACTION.values = {
  ...
  EQUESTACTION_EQUESTACTION_QUICK_SUBMIT_ABYSS_ENUM,
...
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.name = "cmd"
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd.cmd"
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.number = 1
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.index = 0
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.label = 1
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.has_default_value = true
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.default_value = 8
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.type = 14
QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD.cpp_type = 8
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.name = "param"
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd.param"
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.number = 2
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.index = 1
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.label = 1
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.has_default_value = true
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.default_value = 54
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.enum_type = QUESTPARAM
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.type = 14
QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD.cpp_type = 8
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.name = "cur_area"
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd.cur_area"
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.number = 3
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.index = 2
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.label = 1
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.has_default_value = false
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.default_value = 0
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.type = 13
QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD.cpp_type = 3
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.name = "cur_prestige_lv"
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd.cur_prestige_lv"
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.number = 4
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.index = 3
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.label = 1
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.has_default_value = false
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.default_value = 0
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.type = 13
QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD.cpp_type = 3
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.name = "cur_help_count"
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd.cur_help_count"
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.number = 5
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.index = 4
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.label = 1
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.has_default_value = false
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.default_value = 0
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.type = 13
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD.cpp_type = 3
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.name = "cur_help_totalcount"
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd.cur_help_totalcount"
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.number = 6
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.index = 5
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.label = 1
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.has_default_value = false
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.default_value = 0
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.type = 13
QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD.cpp_type = 3
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.name = "list"
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd.list"
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.number = 7
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.index = 6
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.label = 1
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.has_default_value = false
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.default_value = nil
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.message_type = QUESTLIST
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.type = 11
QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD.cpp_type = 10
QUERYABYSSQUESTLISTQUESTCMD.name = "QueryAbyssQuestListQuestCmd"
QUERYABYSSQUESTLISTQUESTCMD.full_name = ".Cmd.QueryAbyssQuestListQuestCmd"
QUERYABYSSQUESTLISTQUESTCMD.nested_types = {}
QUERYABYSSQUESTLISTQUESTCMD.enum_types = {}
QUERYABYSSQUESTLISTQUESTCMD.fields = {
  QUERYABYSSQUESTLISTQUESTCMD_CMD_FIELD,
  QUERYABYSSQUESTLISTQUESTCMD_PARAM_FIELD,
  QUERYABYSSQUESTLISTQUESTCMD_CUR_AREA_FIELD,
  QUERYABYSSQUESTLISTQUESTCMD_CUR_PRESTIGE_LV_FIELD,
  QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_COUNT_FIELD,
  QUERYABYSSQUESTLISTQUESTCMD_CUR_HELP_TOTALCOUNT_FIELD,
  QUERYABYSSQUESTLISTQUESTCMD_LIST_FIELD
}
QUERYABYSSQUESTLISTQUESTCMD.is_extendable = false
QUERYABYSSQUESTLISTQUESTCMD.extensions = {}
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.name = "cmd"
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.full_name = ".Cmd.UpdateAbyssHelpCountQuestCmd.cmd"
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.number = 1
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.index = 0
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.label = 1
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.has_default_value = true
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.default_value = 8
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.type = 14
UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD.cpp_type = 8
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.name = "param"
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.full_name = ".Cmd.UpdateAbyssHelpCountQuestCmd.param"
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.number = 2
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.index = 1
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.label = 1
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.has_default_value = true
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.default_value = 55
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.enum_type = QUESTPARAM
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.type = 14
UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD.cpp_type = 8
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.name = "area"
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.full_name = ".Cmd.UpdateAbyssHelpCountQuestCmd.area"
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.number = 3
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.index = 2
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.label = 1
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.has_default_value = false
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.default_value = 0
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.type = 13
UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD.cpp_type = 3
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.name = "count"
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.full_name = ".Cmd.UpdateAbyssHelpCountQuestCmd.count"
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.number = 4
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.index = 3
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.label = 1
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.has_default_value = false
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.default_value = 0
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.type = 13
UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD.cpp_type = 3
UPDATEABYSSHELPCOUNTQUESTCMD.name = "UpdateAbyssHelpCountQuestCmd"
UPDATEABYSSHELPCOUNTQUESTCMD.full_name = ".Cmd.UpdateAbyssHelpCountQuestCmd"
UPDATEABYSSHELPCOUNTQUESTCMD.nested_types = {}
UPDATEABYSSHELPCOUNTQUESTCMD.enum_types = {}
UPDATEABYSSHELPCOUNTQUESTCMD.fields = {
  UPDATEABYSSHELPCOUNTQUESTCMD_CMD_FIELD,
  UPDATEABYSSHELPCOUNTQUESTCMD_PARAM_FIELD,
  UPDATEABYSSHELPCOUNTQUESTCMD_AREA_FIELD,
  UPDATEABYSSHELPCOUNTQUESTCMD_COUNT_FIELD
}
UPDATEABYSSHELPCOUNTQUESTCMD.is_extendable = false
UPDATEABYSSHELPCOUNTQUESTCMD.extensions = {}
...
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.name = "cmd"
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.cmd"
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.number = 1
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.index = 0
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.has_default_value = true
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.default_value = 8
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.type = 14
ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD.cpp_type = 8
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.name = "param"
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.param"
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.number = 2
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.index = 1
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.has_default_value = true
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.default_value = 56
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.enum_type = QUESTPARAM
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.type = 14
ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD.cpp_type = 8
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.name = "dragon_from_bp"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.dragon_from_bp"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.number = 3
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.index = 2
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.has_default_value = false
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.default_value = 0
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.type = 13
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD.cpp_type = 3
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.name = "dragon_to_bp"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.dragon_to_bp"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.number = 4
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.index = 3
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.has_default_value = false
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.default_value = 0
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.type = 13
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD.cpp_type = 3
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.name = "dragon_hp"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.dragon_hp"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.number = 5
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.index = 4
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.has_default_value = false
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.default_value = 0
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.type = 13
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD.cpp_type = 3
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.name = "dragon_stage"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.dragon_stage"
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.number = 6
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.index = 5
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.has_default_value = false
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.default_value = 0
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.type = 13
ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD.cpp_type = 3
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.name = "anim_start_time"
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.anim_start_time"
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.number = 7
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.index = 6
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.has_default_value = false
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.default_value = 0
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.type = 13
ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD.cpp_type = 3
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.name = "activity_start_time"
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd.activity_start_time"
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.number = 8
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.index = 7
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.label = 1
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.has_default_value = false
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.default_value = 0
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.type = 13
ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD.cpp_type = 3
ABYSSDRAGONINFONTFQUESTCMD.name = "AbyssDragonInfoNtfQuestCmd"
ABYSSDRAGONINFONTFQUESTCMD.full_name = ".Cmd.AbyssDragonInfoNtfQuestCmd"
ABYSSDRAGONINFONTFQUESTCMD.nested_types = {}
ABYSSDRAGONINFONTFQUESTCMD.enum_types = {}
ABYSSDRAGONINFONTFQUESTCMD.fields = {
  ABYSSDRAGONINFONTFQUESTCMD_CMD_FIELD,
  ABYSSDRAGONINFONTFQUESTCMD_PARAM_FIELD,
  ABYSSDRAGONINFONTFQUESTCMD_DRAGON_FROM_BP_FIELD,
  ABYSSDRAGONINFONTFQUESTCMD_DRAGON_TO_BP_FIELD,
  ABYSSDRAGONINFONTFQUESTCMD_DRAGON_HP_FIELD,
  ABYSSDRAGONINFONTFQUESTCMD_DRAGON_STAGE_FIELD,
  ABYSSDRAGONINFONTFQUESTCMD_ANIM_START_TIME_FIELD,
  ABYSSDRAGONINFONTFQUESTCMD_ACTIVITY_START_TIME_FIELD
}
ABYSSDRAGONINFONTFQUESTCMD.is_extendable = false
ABYSSDRAGONINFONTFQUESTCMD.extensions = {}
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.name = "cmd"
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.full_name = ".Cmd.AbyssDragonHpUpdateQuestCmd.cmd"
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.number = 1
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.index = 0
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.label = 1
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.has_default_value = true
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.default_value = 8
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.type = 14
ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD.cpp_type = 8
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.name = "param"
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.full_name = ".Cmd.AbyssDragonHpUpdateQuestCmd.param"
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.number = 2
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.index = 1
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.label = 1
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.has_default_value = true
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.default_value = 57
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.enum_type = QUESTPARAM
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.type = 14
ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD.cpp_type = 8
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.name = "dragon_hp"
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.full_name = ".Cmd.AbyssDragonHpUpdateQuestCmd.dragon_hp"
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.number = 3
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.index = 2
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.label = 1
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.has_default_value = false
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.default_value = 0
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.type = 13
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD.cpp_type = 3
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.name = "dragon_maxhp"
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.full_name = ".Cmd.AbyssDragonHpUpdateQuestCmd.dragon_maxhp"
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.number = 4
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.index = 3
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.label = 1
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.has_default_value = false
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.default_value = 0
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.type = 13
ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD.cpp_type = 3
ABYSSDRAGONHPUPDATEQUESTCMD.name = "AbyssDragonHpUpdateQuestCmd"
ABYSSDRAGONHPUPDATEQUESTCMD.full_name = ".Cmd.AbyssDragonHpUpdateQuestCmd"
ABYSSDRAGONHPUPDATEQUESTCMD.nested_types = {}
ABYSSDRAGONHPUPDATEQUESTCMD.enum_types = {}
ABYSSDRAGONHPUPDATEQUESTCMD.fields = {
  ABYSSDRAGONHPUPDATEQUESTCMD_CMD_FIELD,
  ABYSSDRAGONHPUPDATEQUESTCMD_PARAM_FIELD,
  ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_HP_FIELD,
  ABYSSDRAGONHPUPDATEQUESTCMD_DRAGON_MAXHP_FIELD
}
ABYSSDRAGONHPUPDATEQUESTCMD.is_extendable = false
ABYSSDRAGONHPUPDATEQUESTCMD.extensions = {}
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.name = "cmd"
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.full_name = ".Cmd.AbyssDragonOnOffQuestCmd.cmd"
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.number = 1
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.index = 0
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.label = 1
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.has_default_value = true
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.default_value = 8
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.type = 14
ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD.cpp_type = 8
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.name = "param"
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.full_name = ".Cmd.AbyssDragonOnOffQuestCmd.param"
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.number = 2
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.index = 1
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.label = 1
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.has_default_value = true
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.default_value = 58
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.enum_type = QUESTPARAM
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.type = 14
ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD.cpp_type = 8
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.name = "onoff"
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.full_name = ".Cmd.AbyssDragonOnOffQuestCmd.onoff"
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.number = 3
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.index = 2
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.label = 1
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.has_default_value = false
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.default_value = false
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.type = 8
ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD.cpp_type = 7
ABYSSDRAGONONOFFQUESTCMD.name = "AbyssDragonOnOffQuestCmd"
ABYSSDRAGONONOFFQUESTCMD.full_name = ".Cmd.AbyssDragonOnOffQuestCmd"
ABYSSDRAGONONOFFQUESTCMD.nested_types = {}
ABYSSDRAGONONOFFQUESTCMD.enum_types = {}
ABYSSDRAGONONOFFQUESTCMD.fields = {
  ABYSSDRAGONONOFFQUESTCMD_CMD_FIELD,
  ABYSSDRAGONONOFFQUESTCMD_PARAM_FIELD,
  ABYSSDRAGONONOFFQUESTCMD_ONOFF_FIELD
}
ABYSSDRAGONONOFFQUESTCMD.is_extendable = false
ABYSSDRAGONONOFFQUESTCMD.extensions = {}
AbyssDragonHpUpdateQuestCmd = protobuf.Message(ABYSSDRAGONHPUPDATEQUESTCMD)
AbyssDragonInfoNtfQuestCmd = protobuf.Message(ABYSSDRAGONINFONTFQUESTCMD)
AbyssDragonOnOffQuestCmd = protobuf.Message(ABYSSDRAGONONOFFQUESTCMD)
...
EQUESTACTION_MAX = 9
EQUESTACTION_MIN = 0
EQUESTACTION_QUICK_SUBMIT_ABYSS = 8
...
QUESTPARAM_ABYSSDRAGON_ONOFF = 58
QUESTPARAM_ABYSSDRAGRON_HP_UPDATE = 57
QUESTPARAM_ABYSSDRAGRON_INFO_NTF = 56
...
QUESTPARAM_QUERY_ABYSS_LIST = 54
...
QUESTPARAM_UPDATE_ABYSS_HELPCOUNT = 55
QUESTPARAM_VISIT_NPC = 11
QUESTPARAM_WORLD_COUNT_LIST = 43
QueryAbyssQuestListQuestCmd = protobuf.Message(QUERYABYSSQUESTLISTQUESTCMD)
...
UpdateAbyssHelpCountQuestCmd = protobuf.Message(UPDATEABYSSHELPCOUNTQUESTCMD)
