...
MAILPARAM_MAILPARAM_READ_ENUM = protobuf.EnumValueDescriptor()
MAILPARAM_MAILPARAM_REMOVE_ENUM = protobuf.EnumValueDescriptor()
...
EMAILTYPE_EMAILTYPE_AUTO_GETATTACH_ENUM = protobuf.EnumValueDescriptor()
EMAILTYPE_EMAILTYPE_HINT_ENUM = protobuf.EnumValueDescriptor()
...
EMAILATTACHTYPE_EMAILATTACHTYPE_LIMIT_ENUM = protobuf.EnumValueDescriptor()
...
MAILATTACH_MAILID_FIELD = protobuf.FieldDescriptor()
MAILATTACH_WHITELISTID_FIELD = protobuf.FieldDescriptor()
BLOBATTACH = protobuf.Descriptor()
BLOBATTACH_ATTACHS_FIELD = protobuf.FieldDescriptor()
BLOBATTACH_CUP_MODE_FIELD = protobuf.FieldDescriptor()
BLOBATTACH_CUP_RANK_FIELD = protobuf.FieldDescriptor()
...
MAILDATA_SENDTIME_FIELD = protobuf.FieldDescriptor()
...
GETMAILATTACH_IDS_FIELD = protobuf.FieldDescriptor()
MAILREAD = protobuf.Descriptor()
MAILREAD_CMD_FIELD = protobuf.FieldDescriptor()
MAILREAD_PARAM_FIELD = protobuf.FieldDescriptor()
MAILREAD_ID_FIELD = protobuf.FieldDescriptor()
MAILREMOVE = protobuf.Descriptor()
MAILREMOVE_CMD_FIELD = protobuf.FieldDescriptor()
MAILREMOVE_PARAM_FIELD = protobuf.FieldDescriptor()
MAILREMOVE_IDS_FIELD = protobuf.FieldDescriptor()
...
MAILPARAM_MAILPARAM_READ_ENUM.name = "MAILPARAM_READ"
MAILPARAM_MAILPARAM_READ_ENUM.index = 3
MAILPARAM_MAILPARAM_READ_ENUM.number = 4
MAILPARAM_MAILPARAM_REMOVE_ENUM.name = "MAILPARAM_REMOVE"
MAILPARAM_MAILPARAM_REMOVE_ENUM.index = 4
MAILPARAM_MAILPARAM_REMOVE_ENUM.number = 5
MAILPARAM.name = "MailParam"
MAILPARAM.full_name = ".Cmd.MailParam"
MAILPARAM.values = {
  MAILPARAM_MAILPARAM_QUERYALLMAIL_ENUM,
  MAILPARAM_MAILPARAM_UPDATE_ENUM,
  MAILPARAM_MAILPARAM_GETATTACH_ENUM,
  MAILPARAM_MAILPARAM_READ_ENUM,
  MAILPARAM_MAILPARAM_REMOVE_ENUM
}
...
EMAILSTATUS.values = {
  EMAILSTATUS_EMAILSTATUS_MIN_ENUM,
  EMAILSTATUS_EMAILSTATUS_NEW_ENUM,
  EMAILSTATUS_EMAILSTATUS_ATTACH_ENUM,
  EMAILSTATUS_EMAILSTATUS_READ_ENUM,
  EMAILSTATUS_EMAILSTATUS_INVALID_ENUM,
  EMAILSTATUS_EMAILSTATUS_MAX_ENUM
}
...
EMAILTYPE_EMAILTYPE_AUTO_GETATTACH_ENUM.name = "EMAILTYPE_AUTO_GETATTACH"
EMAILTYPE_EMAILTYPE_AUTO_GETATTACH_ENUM.index = 9
EMAILTYPE_EMAILTYPE_AUTO_GETATTACH_ENUM.number = 9
EMAILTYPE_EMAILTYPE_HINT_ENUM.name = "EMAILTYPE_HINT"
EMAILTYPE_EMAILTYPE_HINT_ENUM.index = 10
EMAILTYPE_EMAILTYPE_HINT_ENUM.number = 10
EMAILTYPE_EMAILTYPE_MAX_ENUM.name = "EMAILTYPE_MAX"
EMAILTYPE_EMAILTYPE_MAX_ENUM.index = 11
EMAILTYPE_EMAILTYPE_MAX_ENUM.number = 11
EMAILTYPE.name = "EMailType"
EMAILTYPE.full_name = ".Cmd.EMailType"
EMAILTYPE.values = {
  EMAILTYPE_EMAILTYPE_MIN_ENUM,
  EMAILTYPE_EMAILTYPE_NORMAL_ENUM,
  EMAILTYPE_EMAILTYPE_SYSTEM_ENUM,
  EMAILTYPE_EMAILTYPE_TRADE_ENUM,
  EMAILTYPE_EMAILTYPE_LOTTERY_GIVE_ENUM,
  EMAILTYPE_EMAILTYPE_WEDDINGMSG_ENUM,
  EMAILTYPE_EMAILTYPE_WEDDINGINVITATION_ENUM,
  EMAILTYPE_EMAILTYPE_USEREVENT_ENUM,
  EMAILTYPE_EMAILTYPE_NORMAL_NOTIME_ENUM,
  EMAILTYPE_EMAILTYPE_AUTO_GETATTACH_ENUM,
  EMAILTYPE_EMAILTYPE_HINT_ENUM,
  EMAILTYPE_EMAILTYPE_MAX_ENUM
}
...
EMAILATTACHTYPE_EMAILATTACHTYPE_LIMIT_ENUM.name = "EMAILATTACHTYPE_LIMIT"
EMAILATTACHTYPE_EMAILATTACHTYPE_LIMIT_ENUM.index = 7
EMAILATTACHTYPE_EMAILATTACHTYPE_LIMIT_ENUM.number = 7
EMAILATTACHTYPE_EAMILATTACHTYPE_MAX_ENUM.name = "EAMILATTACHTYPE_MAX"
EMAILATTACHTYPE_EAMILATTACHTYPE_MAX_ENUM.index = 8
EMAILATTACHTYPE_EAMILATTACHTYPE_MAX_ENUM.number = 8
EMAILATTACHTYPE.name = "EMailAttachType"
EMAILATTACHTYPE.full_name = ".Cmd.EMailAttachType"
EMAILATTACHTYPE.values = {
  EMAILATTACHTYPE_EMAILATTACHTYPE_MIN_ENUM,
  EMAILATTACHTYPE_EMAILATTACHTYPE_REWARD_ENUM,
  EMAILATTACHTYPE_EMAILATTACHTYPE_ITEM_ENUM,
  EMAILATTACHTYPE_EMAILATTACHTYPE_TRADE_BUY_ENUM,
  EMAILATTACHTYPE_EMAILATTACHTYPE_TRADE_RETURN_ENUM,
  EMAILATTACHTYPE_EMAILATTACHTYPE_TRADE_SELL_ENUM,
  EMAILATTACHTYPE_EAMILATTACHTYPE_MSG_PARAMS_ENUM,
  EMAILATTACHTYPE_EMAILATTACHTYPE_LIMIT_ENUM,
...
MAILMSGPARAM.fields = {
  MAILMSGPARAM_MAILID_FIELD,
  MAILMSGPARAM_PARAMS_FIELD
}
...
MAILATTACH_MAILID_FIELD.name = "mailid"
MAILATTACH_MAILID_FIELD.full_name = ".Cmd.MailAttach.mailid"
MAILATTACH_MAILID_FIELD.number = 6
MAILATTACH_MAILID_FIELD.index = 5
MAILATTACH_MAILID_FIELD.label = 1
MAILATTACH_MAILID_FIELD.has_default_value = true
MAILATTACH_MAILID_FIELD.default_value = 0
MAILATTACH_MAILID_FIELD.type = 13
MAILATTACH_MAILID_FIELD.cpp_type = 3
MAILATTACH_WHITELISTID_FIELD.name = "whitelistid"
MAILATTACH_WHITELISTID_FIELD.full_name = ".Cmd.MailAttach.whitelistid"
MAILATTACH_WHITELISTID_FIELD.number = 7
MAILATTACH_WHITELISTID_FIELD.index = 6
MAILATTACH_WHITELISTID_FIELD.label = 1
MAILATTACH_WHITELISTID_FIELD.has_default_value = true
MAILATTACH_WHITELISTID_FIELD.default_value = 0
MAILATTACH_WHITELISTID_FIELD.type = 4
MAILATTACH_WHITELISTID_FIELD.cpp_type = 4
MAILATTACH.name = "MailAttach"
MAILATTACH.full_name = ".Cmd.MailAttach"
MAILATTACH.nested_types = {}
MAILATTACH.enum_types = {}
MAILATTACH.fields = {
  MAILATTACH_TYPE_FIELD,
  MAILATTACH_ID_FIELD,
  MAILATTACH_ITEMS_FIELD,
  MAILATTACH_ITEMDATAS_FIELD,
  MAILATTACH_MSGDATAS_FIELD,
  MAILATTACH_MAILID_FIELD,
  MAILATTACH_WHITELISTID_FIELD
}
...
BLOBATTACH_CUP_MODE_FIELD.name = "cup_mode"
BLOBATTACH_CUP_MODE_FIELD.full_name = ".Cmd.BlobAttach.cup_mode"
BLOBATTACH_CUP_MODE_FIELD.number = 2
BLOBATTACH_CUP_MODE_FIELD.index = 1
BLOBATTACH_CUP_MODE_FIELD.label = 1
BLOBATTACH_CUP_MODE_FIELD.has_default_value = false
BLOBATTACH_CUP_MODE_FIELD.default_value = 0
BLOBATTACH_CUP_MODE_FIELD.type = 13
BLOBATTACH_CUP_MODE_FIELD.cpp_type = 3
BLOBATTACH_CUP_RANK_FIELD.name = "cup_rank"
BLOBATTACH_CUP_RANK_FIELD.full_name = ".Cmd.BlobAttach.cup_rank"
BLOBATTACH_CUP_RANK_FIELD.number = 3
BLOBATTACH_CUP_RANK_FIELD.index = 2
BLOBATTACH_CUP_RANK_FIELD.label = 1
BLOBATTACH_CUP_RANK_FIELD.has_default_value = false
BLOBATTACH_CUP_RANK_FIELD.default_value = 0
BLOBATTACH_CUP_RANK_FIELD.type = 13
BLOBATTACH_CUP_RANK_FIELD.cpp_type = 3
BLOBATTACH.name = "BlobAttach"
BLOBATTACH.full_name = ".Cmd.BlobAttach"
BLOBATTACH.nested_types = {}
BLOBATTACH.enum_types = {}
BLOBATTACH.fields = {
  BLOBATTACH_ATTACHS_FIELD,
  BLOBATTACH_CUP_MODE_FIELD,
  BLOBATTACH_CUP_RANK_FIELD
}
...
MAILDATA_SENDTIME_FIELD.full_name = ".Cmd.MailData.sendtime"
MAILDATA_SENDTIME_FIELD.number = 21
MAILDATA_SENDTIME_FIELD.index = 18
MAILDATA_SENDTIME_FIELD.label = 1
MAILDATA_SENDTIME_FIELD.has_default_value = true
MAILDATA_SENDTIME_FIELD.default_value = 0
MAILDATA_SENDTIME_FIELD.type = 13
MAILDATA_SENDTIME_FIELD.cpp_type = 3
MAILDATA_EXPIRETIME_FIELD.name = "expiretime"
MAILDATA_EXPIRETIME_FIELD.full_name = ".Cmd.MailData.expiretime"
MAILDATA_EXPIRETIME_FIELD.number = 22
MAILDATA_EXPIRETIME_FIELD.index = 19
MAILDATA_EXPIRETIME_FIELD.label = 1
MAILDATA_EXPIRETIME_FIELD.has_default_value = true
MAILDATA_EXPIRETIME_FIELD.default_value = 0
MAILDATA_EXPIRETIME_FIELD.type = 13
MAILDATA_EXPIRETIME_FIELD.cpp_type = 3
MAILDATA_SERVERIDS_FIELD.name = "serverids"
MAILDATA_SERVERIDS_FIELD.full_name = ".Cmd.MailData.serverids"
MAILDATA_SERVERIDS_FIELD.number = 23
MAILDATA_SERVERIDS_FIELD.index = 20
MAILDATA_SERVERIDS_FIELD.label = 1
MAILDATA_SERVERIDS_FIELD.has_default_value = false
MAILDATA_SERVERIDS_FIELD.default_value = ""
MAILDATA_SERVERIDS_FIELD.type = 9
MAILDATA_SERVERIDS_FIELD.cpp_type = 9
MAILDATA_ATTACHTIME_FIELD.name = "attachtime"
MAILDATA_ATTACHTIME_FIELD.full_name = ".Cmd.MailData.attachtime"
MAILDATA_ATTACHTIME_FIELD.number = 24
MAILDATA_ATTACHTIME_FIELD.index = 21
MAILDATA_ATTACHTIME_FIELD.label = 1
MAILDATA_ATTACHTIME_FIELD.has_default_value = true
...
MAILDATA.fields = {
  MAILDATA_ID_FIELD,
  MAILDATA_SYSID_FIELD,
  MAILDATA_SENDERID_FIELD,
  MAILDATA_RECEIVEID_FIELD,
  MAILDATA_RECEIVEACCID_FIELD,
  MAILDATA_TIME_FIELD,
  MAILDATA_MAILID_FIELD,
  MAILDATA_TYPE_FIELD,
  MAILDATA_STATUS_FIELD,
  MAILDATA_TITLE_FIELD,
  MAILDATA_SENDER_FIELD,
  MAILDATA_MSG_FIELD,
  MAILDATA_ATTACH_FIELD,
  MAILDATA_GROUPID_FIELD,
  MAILDATA_STARTTIME_FIELD,
  MAILDATA_ENDTIME_FIELD,
  MAILDATA_WEDDINGMSG_FIELD,
  MAILDATA_EVENTMSG_FIELD,
...
MAILTEMPLATEDATA.fields = {
  MAILTEMPLATEDATA_MSGS_FIELD
}
...
QUERYALLMAIL.fields = {
  QUERYALLMAIL_CMD_FIELD,
  QUERYALLMAIL_PARAM_FIELD,
  QUERYALLMAIL_DATAS_FIELD
}
...
MAILUPDATE.fields = {
  MAILUPDATE_CMD_FIELD,
  MAILUPDATE_PARAM_FIELD,
  MAILUPDATE_UPDATES_FIELD,
  MAILUPDATE_DELS_FIELD
}
...
GETMAILATTACH_IDS_FIELD.name = "ids"
GETMAILATTACH_IDS_FIELD.full_name = ".Cmd.GetMailAttach.ids"
GETMAILATTACH_IDS_FIELD.number = 3
GETMAILATTACH_IDS_FIELD.index = 2
GETMAILATTACH_IDS_FIELD.label = 3
GETMAILATTACH_IDS_FIELD.has_default_value = false
GETMAILATTACH_IDS_FIELD.default_value = {}
GETMAILATTACH_IDS_FIELD.type = 4
GETMAILATTACH_IDS_FIELD.cpp_type = 4
...
GETMAILATTACH.fields = {
  GETMAILATTACH_CMD_FIELD,
  GETMAILATTACH_PARAM_FIELD,
  GETMAILATTACH_IDS_FIELD
}
GETMAILATTACH.is_extendable = false
GETMAILATTACH.extensions = {}
MAILREAD_CMD_FIELD.name = "cmd"
MAILREAD_CMD_FIELD.full_name = ".Cmd.MailRead.cmd"
MAILREAD_CMD_FIELD.number = 1
MAILREAD_CMD_FIELD.index = 0
MAILREAD_CMD_FIELD.label = 1
MAILREAD_CMD_FIELD.has_default_value = true
MAILREAD_CMD_FIELD.default_value = 55
MAILREAD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
MAILREAD_CMD_FIELD.type = 14
MAILREAD_CMD_FIELD.cpp_type = 8
MAILREAD_PARAM_FIELD.name = "param"
MAILREAD_PARAM_FIELD.full_name = ".Cmd.MailRead.param"
MAILREAD_PARAM_FIELD.number = 2
MAILREAD_PARAM_FIELD.index = 1
MAILREAD_PARAM_FIELD.label = 1
MAILREAD_PARAM_FIELD.has_default_value = true
MAILREAD_PARAM_FIELD.default_value = 4
MAILREAD_PARAM_FIELD.enum_type = MAILPARAM
MAILREAD_PARAM_FIELD.type = 14
MAILREAD_PARAM_FIELD.cpp_type = 8
MAILREAD_ID_FIELD.name = "id"
MAILREAD_ID_FIELD.full_name = ".Cmd.MailRead.id"
MAILREAD_ID_FIELD.number = 3
MAILREAD_ID_FIELD.index = 2
MAILREAD_ID_FIELD.label = 1
MAILREAD_ID_FIELD.has_default_value = false
MAILREAD_ID_FIELD.default_value = 0
MAILREAD_ID_FIELD.type = 4
MAILREAD_ID_FIELD.cpp_type = 4
MAILREAD.name = "MailRead"
MAILREAD.full_name = ".Cmd.MailRead"
MAILREAD.nested_types = {}
MAILREAD.enum_types = {}
MAILREAD.fields = {
  MAILREAD_CMD_FIELD,
  MAILREAD_PARAM_FIELD,
  MAILREAD_ID_FIELD
}
MAILREAD.is_extendable = false
MAILREAD.extensions = {}
MAILREMOVE_CMD_FIELD.name = "cmd"
MAILREMOVE_CMD_FIELD.full_name = ".Cmd.MailRemove.cmd"
MAILREMOVE_CMD_FIELD.number = 1
MAILREMOVE_CMD_FIELD.index = 0
MAILREMOVE_CMD_FIELD.label = 1
MAILREMOVE_CMD_FIELD.has_default_value = true
MAILREMOVE_CMD_FIELD.default_value = 55
MAILREMOVE_CMD_FIELD.enum_type = XCMD_PB_COMMAND
MAILREMOVE_CMD_FIELD.type = 14
MAILREMOVE_CMD_FIELD.cpp_type = 8
MAILREMOVE_PARAM_FIELD.name = "param"
MAILREMOVE_PARAM_FIELD.full_name = ".Cmd.MailRemove.param"
MAILREMOVE_PARAM_FIELD.number = 2
MAILREMOVE_PARAM_FIELD.index = 1
MAILREMOVE_PARAM_FIELD.label = 1
MAILREMOVE_PARAM_FIELD.has_default_value = true
MAILREMOVE_PARAM_FIELD.default_value = 5
MAILREMOVE_PARAM_FIELD.enum_type = MAILPARAM
MAILREMOVE_PARAM_FIELD.type = 14
MAILREMOVE_PARAM_FIELD.cpp_type = 8
MAILREMOVE_IDS_FIELD.name = "ids"
MAILREMOVE_IDS_FIELD.full_name = ".Cmd.MailRemove.ids"
MAILREMOVE_IDS_FIELD.number = 3
MAILREMOVE_IDS_FIELD.index = 2
MAILREMOVE_IDS_FIELD.label = 3
MAILREMOVE_IDS_FIELD.has_default_value = false
MAILREMOVE_IDS_FIELD.default_value = {}
MAILREMOVE_IDS_FIELD.type = 4
MAILREMOVE_IDS_FIELD.cpp_type = 4
MAILREMOVE.name = "MailRemove"
MAILREMOVE.full_name = ".Cmd.MailRemove"
MAILREMOVE.nested_types = {}
MAILREMOVE.enum_types = {}
MAILREMOVE.fields = {
  MAILREMOVE_CMD_FIELD,
  MAILREMOVE_PARAM_FIELD,
  MAILREMOVE_IDS_FIELD
}
MAILREMOVE.is_extendable = false
MAILREMOVE.extensions = {}
...
MailRead = protobuf.Message(MAILREAD)
MailRemove = protobuf.Message(MAILREMOVE)
