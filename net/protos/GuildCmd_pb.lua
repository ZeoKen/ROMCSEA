...
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_MAX_ENUM.index = 6
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_MAX_ENUM.number = 6
...
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.index = 5
