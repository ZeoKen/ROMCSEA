...
GUILDPARAM_GUILDPARAM_GVG_FIRE_REPORT_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_BUILDING_UPDATE_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_MODIFY_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_QUERY_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_EXCHANGE_GVGGROUP_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_INFO_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_TARGET_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_INVITE_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPLY_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_OPEN_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_ENTER_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_DETAIL_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_LIST_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_RANK_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_REDTIP_OPT_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_REDTIP_BROWSE_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_FLAG_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_GVG_DATA_QUERY_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_UI_STATE_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_QUERY_SUPER_GVG_STAT_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_QUERY_ENUM = protobuf.EnumValueDescriptor()
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_UPDATE_ENUM = protobuf.EnumValueDescriptor()
...
EPRAYTYPE_EPRAYTYPE_FOUR_ENUM = protobuf.EnumValueDescriptor()
...
EAUTH_EAUTH_EDIT_AUTH_ENUM = protobuf.EnumValueDescriptor()
EAUTH_EAUTH_MERCENARY_ENABLE_ENUM = protobuf.EnumValueDescriptor()
EAUTH_EAUTH_REMOVE_OTHER_PHOTO_ENUM = protobuf.EnumValueDescriptor()
EAUTH_EAUTH_GVG_SELECT_CITY_ENUM = protobuf.EnumValueDescriptor()
EAUTH_EAUTH_EXCHANGE_GVG_GROUP_ENUM = protobuf.EnumValueDescriptor()
EAUTH_EAUTH_ARTIFACT_DECOMPOSE_ENUM = protobuf.EnumValueDescriptor()
...
EQUERYGUILD_EQUERYGUILD_ALL_ZONE_ENUM = protobuf.EnumValueDescriptor()
EQUERYGUILD_EQUERYGUILD_CUR_ZONE_ENUM = protobuf.EnumValueDescriptor()
EQUERYGUILD_EQUERYGUILD_CUR_GVGGROUP_ENUM = protobuf.EnumValueDescriptor()
...
EGUILDDATA_EGUILDDATA_PATCH_VERSION_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATA_EGUILDDATA_GVG_GROUP_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATA_EGUILDDATA_GVG_GROUP_TIME_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATA_EGUILDDATA_GVG_GROUP_DEST_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATA_EGUILDDATA_DATEBATTLE_MVP_ENUM = protobuf.EnumValueDescriptor()
...
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_DECOMPOSE_ENUM = protobuf.EnumValueDescriptor()
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_RETRIEVE_ALL_ENUM = protobuf.EnumValueDescriptor()
...
EMVPSTATE = protobuf.EnumDescriptor()
EMVPSTATE_EMVP_MIN_ENUM = protobuf.EnumValueDescriptor()
EMVPSTATE_EMVP_WILL_SUMMON_ENUM = protobuf.EnumValueDescriptor()
EMVPSTATE_EMVP_SUMMONED_ENUM = protobuf.EnumValueDescriptor()
EMVPSTATE_EMVP_DIE_ENUM = protobuf.EnumValueDescriptor()
...
EGUILDDATEBATTLEMODE = protobuf.EnumDescriptor()
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MIN_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_BASE_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_CLASSIC_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP3_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP4_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP5_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLESTATE = protobuf.EnumDescriptor()
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_MIN_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVITE_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_REFUSE_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_READY_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_ING_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_END_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVALID_ENUM = protobuf.EnumValueDescriptor()
EDATEBATTLEOPENSTATE = protobuf.EnumDescriptor()
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_MIN_ENUM = protobuf.EnumValueDescriptor()
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_READY_ENUM = protobuf.EnumValueDescriptor()
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_OPEN_ENUM = protobuf.EnumValueDescriptor()
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_CLOSE_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLELISTTYPE = protobuf.EnumDescriptor()
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_MIN_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_READY_ENUM = protobuf.EnumValueDescriptor()
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_END_ENUM = protobuf.EnumValueDescriptor()
...
MEMBERREDTIP = protobuf.Descriptor()
MEMBERREDTIP_ID_FIELD = protobuf.FieldDescriptor()
MEMBERREDTIP_SUBIDS_FIELD = protobuf.FieldDescriptor()
...
GUILDMEMBER_REDTIPS_FIELD = protobuf.FieldDescriptor()
...
GUILDCHALLENGE_REWARDITEM_FIELD = protobuf.FieldDescriptor()
...
GUILDWELFAREITEM_REWARDITEM_FIELD = protobuf.FieldDescriptor()
...
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD = protobuf.FieldDescriptor()
...
GUILDSUMMARYDATA_APPLIED_FIELD = protobuf.FieldDescriptor()
GUILDSUMMARYDATA_MERCENARY_FIELD = protobuf.FieldDescriptor()
GUILDSUMMARYDATA_CHAIRMANID_FIELD = protobuf.FieldDescriptor()
...
GUILDDATA_CHANGE_GROUP_TIME_FIELD = protobuf.FieldDescriptor()
...
GUILDINFONTF_ISMVP_FIELD = protobuf.FieldDescriptor()
...
GUILDCITYINFO_ROADBLOCK_FIELD = protobuf.FieldDescriptor()
...
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD = protobuf.FieldDescriptor()
...
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD = protobuf.FieldDescriptor()
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD = protobuf.FieldDescriptor()
...
CITYSHOWINFO_OCCUPY_GUILDS_FIELD = protobuf.FieldDescriptor()
CITYSHOWINFO_ROADBLOCK_FIELD = protobuf.FieldDescriptor()
CITYSHOWINFO_MVP_STATE_FIELD = protobuf.FieldDescriptor()
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD = protobuf.FieldDescriptor()
...
GVGOPENFIREGUILDCMD_START_TIME_FIELD = protobuf.FieldDescriptor()
...
SUPERGVGGUILDDATA_GVG_GROUP_FIELD = protobuf.FieldDescriptor()
...
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD = protobuf.FieldDescriptor()
...
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD = protobuf.FieldDescriptor()
...
GUILDSHOWINFO_GVG_GROUP_FIELD = protobuf.FieldDescriptor()
...
GVGSCOREDETAILINFO_POINT_SCORE_FIELD = protobuf.FieldDescriptor()
GVGSCOREDETAILINFO_MVP_SCORE_FIELD = protobuf.FieldDescriptor()
...
GVGTASKUPDATEGUILDCMD_TASKS_FIELD = protobuf.FieldDescriptor()
...
GVGSTATUEINFO_POSE_FIELD = protobuf.FieldDescriptor()
...
GVGSCOREINFO_PRECITYID_FIELD = protobuf.FieldDescriptor()
...
GVGSCOREINFO_LOSE_POINTS_FIELD = protobuf.FieldDescriptor()
GVGSCOREINFO_MVP_SCORE_FIELD = protobuf.FieldDescriptor()
...
GVGGUILDGROUPINFO_GROUPID_FIELD = protobuf.FieldDescriptor()
...
GVGSETTLEINFO_PREPARE_CITYS_FIELD = protobuf.FieldDescriptor()
...
GVGUSERFIREDATA = protobuf.Descriptor()
GVGUSERFIREDATA_CHARID_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_USERNAME_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_PROFESSION_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_KILLUSERNUM_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_DIENUM_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_POINTNUM_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_POINTTIME_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_HEALHP_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_RELIVENUM_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_METALDAMAGE_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_HELPNUM_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_EXPELNUM_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_DAMAGE_FIELD = protobuf.FieldDescriptor()
GVGUSERFIREDATA_MVP_DAMAGE_FIELD = protobuf.FieldDescriptor()
GVGFIREREPORTGUILDCMD = protobuf.Descriptor()
GVGFIREREPORTGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
GVGFIREREPORTGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD = protobuf.FieldDescriptor()
GVGFIREREPORTGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
GVGFIREREPORTGUILDCMD_MYDATA_FIELD = protobuf.FieldDescriptor()
GUILDBUILDINGREWARD = protobuf.Descriptor()
GUILDBUILDINGREWARD_TYPE_FIELD = protobuf.FieldDescriptor()
GUILDBUILDINGREWARD_LEVEL_FIELD = protobuf.FieldDescriptor()
GUILDBUILDINGREWARD_REWARD_FIELD = protobuf.FieldDescriptor()
GUILDBUILDINGREWARD_REFRESHTIME_FIELD = protobuf.FieldDescriptor()
BUILDINGUPDATENTFGUILDCMD = protobuf.Descriptor()
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKMODIFYGUILDCMD = protobuf.Descriptor()
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKQUERYGUILDCMD = protobuf.Descriptor()
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD = protobuf.FieldDescriptor()
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD = protobuf.FieldDescriptor()
EXCHANGEGVGGROUPGUILDCMD = protobuf.Descriptor()
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD = protobuf.FieldDescriptor()
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD = protobuf.FieldDescriptor()
GVGDATAQUERYGUILDCMD = protobuf.Descriptor()
GVGDATAQUERYGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
GVGDATAQUERYGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA = protobuf.Descriptor()
DATEBATTLEDATA_ID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_ATK_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_ATK_GUILDNAME_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_ATK_SERVERID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_DEF_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_DEF_GUILDNAME_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_DEF_SERVERID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_INVITE_TIME_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_MODE_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_STATE_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDATA_WINNER_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINFOGUILDCMD = protobuf.Descriptor()
DATEBATTLEINFOGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINFOGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINFOGUILDCMD_ID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINFOGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
DATEBATTLETARGETGUILDCMD = protobuf.Descriptor()
DATEBATTLETARGETGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLETARGETGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLETARGETGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINVITEGUILDCMD = protobuf.Descriptor()
DATEBATTLEINVITEGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINVITEGUILDCMD_MODE_FIELD = protobuf.FieldDescriptor()
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPLYGUILDCMD = protobuf.Descriptor()
DATEBATTLEREPLYGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPLYGUILDCMD_ID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
DATEBATTLEOPENGUILDCMD = protobuf.Descriptor()
DATEBATTLEOPENGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEOPENGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEOPENGUILDCMD_STATE_FIELD = protobuf.FieldDescriptor()
DATEBATTLEOPENGUILDCMD_DATA_FIELD = protobuf.FieldDescriptor()
DATEBATTLEENTERGUILDCMD = protobuf.Descriptor()
DATEBATTLEENTERGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEENTERGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEENTERGUILDCMD_ID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD = protobuf.Descriptor()
DATEBATTLEREPORTGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORT = protobuf.Descriptor()
DATEBATTLEREPORT_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORT_DATAS_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDETAILGUILDCMD = protobuf.Descriptor()
DATEBATTLEDETAILGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD = protobuf.FieldDescriptor()
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLELISTGUILDCMD = protobuf.Descriptor()
DATEBATTLELISTGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLELISTGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLELISTGUILDCMD_TYPE_FIELD = protobuf.FieldDescriptor()
DATEBATTLELISTGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKINFO = protobuf.Descriptor()
DATEBATTLERANKINFO_GUILDID_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKINFO_GUILDNAME_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKINFO_SERVERID_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKINFO_WINTIMES_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKGUILDCMD = protobuf.Descriptor()
DATEBATTLERANKGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKGUILDCMD_MYDATA_FIELD = protobuf.FieldDescriptor()
DATEBATTLERANKGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
REDTIPOPTGUILDCMD = protobuf.Descriptor()
REDTIPOPTGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
REDTIPOPTGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
REDTIPOPTGUILDCMD_REDTIPS_FIELD = protobuf.FieldDescriptor()
REDTIPBROWSEGUILDCMD = protobuf.Descriptor()
REDTIPBROWSEGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
REDTIPBROWSEGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
REDTIPBROWSEGUILDCMD_RED_FIELD = protobuf.FieldDescriptor()
REDTIPBROWSEGUILDCMD_TIPID_FIELD = protobuf.FieldDescriptor()
GUILDPORTRAITDATA = protobuf.Descriptor()
GUILDPORTRAITDATA_GUILDID_FIELD = protobuf.FieldDescriptor()
GUILDPORTRAITDATA_SERVERID_FIELD = protobuf.FieldDescriptor()
GUILDPORTRAITDATA_GUILDNAME_FIELD = protobuf.FieldDescriptor()
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD = protobuf.FieldDescriptor()
DATEBATTLEFLAGGUILDCMD = protobuf.Descriptor()
DATEBATTLEFLAGGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD = protobuf.FieldDescriptor()
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTUISTATECMD = protobuf.Descriptor()
DATEBATTLEREPORTUISTATECMD_CMD_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD = protobuf.FieldDescriptor()
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEINFO = protobuf.Descriptor()
GVGCITYSTATUEINFO_CITYID_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEINFO_INFO_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEQUERYGUILDCMD = protobuf.Descriptor()
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEUPDATEGUILDCMD = protobuf.Descriptor()
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD = protobuf.FieldDescriptor()
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD = protobuf.FieldDescriptor()
QUERYSUPERGVGSTATCMD = protobuf.Descriptor()
QUERYSUPERGVGSTATCMD_CMD_FIELD = protobuf.FieldDescriptor()
QUERYSUPERGVGSTATCMD_PARAM_FIELD = protobuf.FieldDescriptor()
QUERYSUPERGVGSTATCMD_DATAS_FIELD = protobuf.FieldDescriptor()
QUERYSUPERGVGSTATCMD_IS_END_FIELD = protobuf.FieldDescriptor()
...
GUILDPARAM_GUILDPARAM_GVG_FIRE_REPORT_ENUM.name = "GUILDPARAM_GVG_FIRE_REPORT"
GUILDPARAM_GUILDPARAM_GVG_FIRE_REPORT_ENUM.index = 86
GUILDPARAM_GUILDPARAM_GVG_FIRE_REPORT_ENUM.number = 94
GUILDPARAM_GUILDPARAM_BUILDING_UPDATE_ENUM.name = "GUILDPARAM_BUILDING_UPDATE"
GUILDPARAM_GUILDPARAM_BUILDING_UPDATE_ENUM.index = 87
GUILDPARAM_GUILDPARAM_BUILDING_UPDATE_ENUM.number = 95
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_MODIFY_ENUM.name = "GUILDPARAM_GVG_ROADBLOCK_MODIFY"
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_MODIFY_ENUM.index = 88
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_MODIFY_ENUM.number = 96
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_QUERY_ENUM.name = "GUILDPARAM_GVG_ROADBLOCK_QUERY"
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_QUERY_ENUM.index = 89
GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_QUERY_ENUM.number = 97
GUILDPARAM_GUILDPARAM_EXCHANGE_GVGGROUP_ENUM.name = "GUILDPARAM_EXCHANGE_GVGGROUP"
GUILDPARAM_GUILDPARAM_EXCHANGE_GVGGROUP_ENUM.index = 90
GUILDPARAM_GUILDPARAM_EXCHANGE_GVGGROUP_ENUM.number = 98
GUILDPARAM_GUILDPARAM_DATEBATTLE_INFO_ENUM.name = "GUILDPARAM_DATEBATTLE_INFO"
GUILDPARAM_GUILDPARAM_DATEBATTLE_INFO_ENUM.index = 91
GUILDPARAM_GUILDPARAM_DATEBATTLE_INFO_ENUM.number = 99
GUILDPARAM_GUILDPARAM_DATEBATTLE_TARGET_ENUM.name = "GUILDPARAM_DATEBATTLE_TARGET"
GUILDPARAM_GUILDPARAM_DATEBATTLE_TARGET_ENUM.index = 92
GUILDPARAM_GUILDPARAM_DATEBATTLE_TARGET_ENUM.number = 100
GUILDPARAM_GUILDPARAM_DATEBATTLE_INVITE_ENUM.name = "GUILDPARAM_DATEBATTLE_INVITE"
GUILDPARAM_GUILDPARAM_DATEBATTLE_INVITE_ENUM.index = 93
GUILDPARAM_GUILDPARAM_DATEBATTLE_INVITE_ENUM.number = 101
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPLY_ENUM.name = "GUILDPARAM_DATEBATTLE_REPLY"
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPLY_ENUM.index = 94
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPLY_ENUM.number = 102
GUILDPARAM_GUILDPARAM_DATEBATTLE_OPEN_ENUM.name = "GUILDPARAM_DATEBATTLE_OPEN"
GUILDPARAM_GUILDPARAM_DATEBATTLE_OPEN_ENUM.index = 95
GUILDPARAM_GUILDPARAM_DATEBATTLE_OPEN_ENUM.number = 103
GUILDPARAM_GUILDPARAM_DATEBATTLE_ENTER_ENUM.name = "GUILDPARAM_DATEBATTLE_ENTER"
GUILDPARAM_GUILDPARAM_DATEBATTLE_ENTER_ENUM.index = 96
GUILDPARAM_GUILDPARAM_DATEBATTLE_ENTER_ENUM.number = 104
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_ENUM.name = "GUILDPARAM_DATEBATTLE_REPORT"
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_ENUM.index = 97
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_ENUM.number = 105
GUILDPARAM_GUILDPARAM_DATEBATTLE_DETAIL_ENUM.name = "GUILDPARAM_DATEBATTLE_DETAIL"
GUILDPARAM_GUILDPARAM_DATEBATTLE_DETAIL_ENUM.index = 98
GUILDPARAM_GUILDPARAM_DATEBATTLE_DETAIL_ENUM.number = 106
GUILDPARAM_GUILDPARAM_DATEBATTLE_LIST_ENUM.name = "GUILDPARAM_DATEBATTLE_LIST"
GUILDPARAM_GUILDPARAM_DATEBATTLE_LIST_ENUM.index = 99
GUILDPARAM_GUILDPARAM_DATEBATTLE_LIST_ENUM.number = 107
GUILDPARAM_GUILDPARAM_DATEBATTLE_RANK_ENUM.name = "GUILDPARAM_DATEBATTLE_RANK"
GUILDPARAM_GUILDPARAM_DATEBATTLE_RANK_ENUM.index = 100
GUILDPARAM_GUILDPARAM_DATEBATTLE_RANK_ENUM.number = 108
GUILDPARAM_GUILDPARAM_REDTIP_OPT_ENUM.name = "GUILDPARAM_REDTIP_OPT"
GUILDPARAM_GUILDPARAM_REDTIP_OPT_ENUM.index = 101
GUILDPARAM_GUILDPARAM_REDTIP_OPT_ENUM.number = 109
GUILDPARAM_GUILDPARAM_REDTIP_BROWSE_ENUM.name = "GUILDPARAM_REDTIP_BROWSE"
GUILDPARAM_GUILDPARAM_REDTIP_BROWSE_ENUM.index = 102
GUILDPARAM_GUILDPARAM_REDTIP_BROWSE_ENUM.number = 110
GUILDPARAM_GUILDPARAM_DATEBATTLE_FLAG_ENUM.name = "GUILDPARAM_DATEBATTLE_FLAG"
GUILDPARAM_GUILDPARAM_DATEBATTLE_FLAG_ENUM.index = 103
GUILDPARAM_GUILDPARAM_DATEBATTLE_FLAG_ENUM.number = 111
GUILDPARAM_GUILDPARAM_GVG_DATA_QUERY_ENUM.name = "GUILDPARAM_GVG_DATA_QUERY"
GUILDPARAM_GUILDPARAM_GVG_DATA_QUERY_ENUM.index = 104
GUILDPARAM_GUILDPARAM_GVG_DATA_QUERY_ENUM.number = 112
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_UI_STATE_ENUM.name = "GUILDPARAM_DATEBATTLE_REPORT_UI_STATE"
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_UI_STATE_ENUM.index = 105
GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_UI_STATE_ENUM.number = 113
GUILDPARAM_GUILDPARAM_QUERY_SUPER_GVG_STAT_ENUM.name = "GUILDPARAM_QUERY_SUPER_GVG_STAT"
GUILDPARAM_GUILDPARAM_QUERY_SUPER_GVG_STAT_ENUM.index = 106
GUILDPARAM_GUILDPARAM_QUERY_SUPER_GVG_STAT_ENUM.number = 114
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_QUERY_ENUM.name = "GUILDPARAM_GVG_CITY_STATUE_QUERY"
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_QUERY_ENUM.index = 107
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_QUERY_ENUM.number = 115
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_UPDATE_ENUM.name = "GUILDPARAM_GVG_CITY_STATUE_UPDATE"
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_UPDATE_ENUM.index = 108
GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_UPDATE_ENUM.number = 116
...
GUILDPARAM.values = {
  ...
  GUILDPARAM_GUILDPARAM_GVG_FIRE_REPORT_ENUM,
  GUILDPARAM_GUILDPARAM_BUILDING_UPDATE_ENUM,
  GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_MODIFY_ENUM,
  GUILDPARAM_GUILDPARAM_GVG_ROADBLOCK_QUERY_ENUM,
  GUILDPARAM_GUILDPARAM_EXCHANGE_GVGGROUP_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_INFO_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_TARGET_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_INVITE_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_REPLY_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_OPEN_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_ENTER_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_DETAIL_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_LIST_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_RANK_ENUM,
  GUILDPARAM_GUILDPARAM_REDTIP_OPT_ENUM,
  GUILDPARAM_GUILDPARAM_REDTIP_BROWSE_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_FLAG_ENUM,
  GUILDPARAM_GUILDPARAM_GVG_DATA_QUERY_ENUM,
  GUILDPARAM_GUILDPARAM_DATEBATTLE_REPORT_UI_STATE_ENUM,
  GUILDPARAM_GUILDPARAM_QUERY_SUPER_GVG_STAT_ENUM,
  GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_QUERY_ENUM,
  GUILDPARAM_GUILDPARAM_GVG_CITY_STATUE_UPDATE_ENUM
}
...
EPRAYTYPE_EPRAYTYPE_FOUR_ENUM.name = "EPRAYTYPE_FOUR"
EPRAYTYPE_EPRAYTYPE_FOUR_ENUM.index = 5
EPRAYTYPE_EPRAYTYPE_FOUR_ENUM.number = 5
EPRAYTYPE_EPRAYTYPE_MAX_ENUM.name = "EPRAYTYPE_MAX"
EPRAYTYPE_EPRAYTYPE_MAX_ENUM.index = 6
EPRAYTYPE_EPRAYTYPE_MAX_ENUM.number = 6
...
EAUTH_EAUTH_EDIT_AUTH_ENUM.name = "EAUTH_EDIT_AUTH"
EAUTH_EAUTH_EDIT_AUTH_ENUM.index = 33
EAUTH_EAUTH_EDIT_AUTH_ENUM.number = 33
EAUTH_EAUTH_MERCENARY_ENABLE_ENUM.name = "EAUTH_MERCENARY_ENABLE"
EAUTH_EAUTH_MERCENARY_ENABLE_ENUM.index = 34
EAUTH_EAUTH_MERCENARY_ENABLE_ENUM.number = 34
EAUTH_EAUTH_REMOVE_OTHER_PHOTO_ENUM.name = "EAUTH_REMOVE_OTHER_PHOTO"
EAUTH_EAUTH_REMOVE_OTHER_PHOTO_ENUM.index = 35
EAUTH_EAUTH_REMOVE_OTHER_PHOTO_ENUM.number = 35
EAUTH_EAUTH_GVG_SELECT_CITY_ENUM.name = "EAUTH_GVG_SELECT_CITY"
EAUTH_EAUTH_GVG_SELECT_CITY_ENUM.index = 36
EAUTH_EAUTH_GVG_SELECT_CITY_ENUM.number = 36
EAUTH_EAUTH_EXCHANGE_GVG_GROUP_ENUM.name = "EAUTH_EXCHANGE_GVG_GROUP"
EAUTH_EAUTH_EXCHANGE_GVG_GROUP_ENUM.index = 37
EAUTH_EAUTH_EXCHANGE_GVG_GROUP_ENUM.number = 37
EAUTH_EAUTH_ARTIFACT_DECOMPOSE_ENUM.name = "EAUTH_ARTIFACT_DECOMPOSE"
EAUTH_EAUTH_ARTIFACT_DECOMPOSE_ENUM.index = 38
EAUTH_EAUTH_ARTIFACT_DECOMPOSE_ENUM.number = 38
EAUTH_EAUTH_MAX_ENUM.name = "EAUTH_MAX"
EAUTH_EAUTH_MAX_ENUM.index = 39
EAUTH_EAUTH_MAX_ENUM.number = 39
EAUTH.name = "EAuth"
...
EAUTH.values = {
  ...
  EAUTH_EAUTH_EDIT_AUTH_ENUM,
  EAUTH_EAUTH_MERCENARY_ENABLE_ENUM,
  EAUTH_EAUTH_REMOVE_OTHER_PHOTO_ENUM,
  EAUTH_EAUTH_GVG_SELECT_CITY_ENUM,
  EAUTH_EAUTH_EXCHANGE_GVG_GROUP_ENUM,
  EAUTH_EAUTH_ARTIFACT_DECOMPOSE_ENUM,
...
EQUERYGUILD_EQUERYGUILD_ALL_ZONE_ENUM.name = "EQUERYGUILD_ALL_ZONE"
EQUERYGUILD_EQUERYGUILD_ALL_ZONE_ENUM.index = 6
EQUERYGUILD_EQUERYGUILD_ALL_ZONE_ENUM.number = 6
EQUERYGUILD_EQUERYGUILD_CUR_ZONE_ENUM.name = "EQUERYGUILD_CUR_ZONE"
EQUERYGUILD_EQUERYGUILD_CUR_ZONE_ENUM.index = 7
EQUERYGUILD_EQUERYGUILD_CUR_ZONE_ENUM.number = 7
EQUERYGUILD_EQUERYGUILD_CUR_GVGGROUP_ENUM.name = "EQUERYGUILD_CUR_GVGGROUP"
EQUERYGUILD_EQUERYGUILD_CUR_GVGGROUP_ENUM.index = 8
EQUERYGUILD_EQUERYGUILD_CUR_GVGGROUP_ENUM.number = 8
EQUERYGUILD_EQUERYGUILD_MAX_ENUM.name = "EQUERYGUILD_MAX"
EQUERYGUILD_EQUERYGUILD_MAX_ENUM.index = 9
EQUERYGUILD_EQUERYGUILD_MAX_ENUM.number = 9
...
EQUERYGUILD.values = {
  ...
  EQUERYGUILD_EQUERYGUILD_ALL_ZONE_ENUM,
  EQUERYGUILD_EQUERYGUILD_CUR_ZONE_ENUM,
  EQUERYGUILD_EQUERYGUILD_CUR_GVGGROUP_ENUM,
...
EGUILDDATA_EGUILDDATA_PATCH_VERSION_ENUM.name = "EGUILDDATA_PATCH_VERSION"
EGUILDDATA_EGUILDDATA_PATCH_VERSION_ENUM.index = 44
EGUILDDATA_EGUILDDATA_PATCH_VERSION_ENUM.number = 63
EGUILDDATA_EGUILDDATA_GVG_GROUP_ENUM.name = "EGUILDDATA_GVG_GROUP"
EGUILDDATA_EGUILDDATA_GVG_GROUP_ENUM.index = 45
EGUILDDATA_EGUILDDATA_GVG_GROUP_ENUM.number = 64
EGUILDDATA_EGUILDDATA_GVG_GROUP_TIME_ENUM.name = "EGUILDDATA_GVG_GROUP_TIME"
EGUILDDATA_EGUILDDATA_GVG_GROUP_TIME_ENUM.index = 46
EGUILDDATA_EGUILDDATA_GVG_GROUP_TIME_ENUM.number = 65
EGUILDDATA_EGUILDDATA_GVG_GROUP_DEST_ENUM.name = "EGUILDDATA_GVG_GROUP_DEST"
EGUILDDATA_EGUILDDATA_GVG_GROUP_DEST_ENUM.index = 47
EGUILDDATA_EGUILDDATA_GVG_GROUP_DEST_ENUM.number = 66
EGUILDDATA_EGUILDDATA_DATEBATTLE_MVP_ENUM.name = "EGUILDDATA_DATEBATTLE_MVP"
EGUILDDATA_EGUILDDATA_DATEBATTLE_MVP_ENUM.index = 48
EGUILDDATA_EGUILDDATA_DATEBATTLE_MVP_ENUM.number = 67
EGUILDDATA_EGUILDDATA_MAX_ENUM.name = "EGUILDDATA_MAX"
EGUILDDATA_EGUILDDATA_MAX_ENUM.index = 49
EGUILDDATA_EGUILDDATA_MAX_ENUM.number = 68
...
EGUILDDATA.values = {
  ...
  EGUILDDATA_EGUILDDATA_PATCH_VERSION_ENUM,
  EGUILDDATA_EGUILDDATA_GVG_GROUP_ENUM,
  EGUILDDATA_EGUILDDATA_GVG_GROUP_TIME_ENUM,
  EGUILDDATA_EGUILDDATA_GVG_GROUP_DEST_ENUM,
  EGUILDDATA_EGUILDDATA_DATEBATTLE_MVP_ENUM,
...
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_DECOMPOSE_ENUM.name = "EARTIFACTOPTTYPE_DECOMPOSE"
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_DECOMPOSE_ENUM.index = 5
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_DECOMPOSE_ENUM.number = 5
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_RETRIEVE_ALL_ENUM.name = "EARTIFACTOPTTYPE_RETRIEVE_ALL"
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_RETRIEVE_ALL_ENUM.index = 6
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_RETRIEVE_ALL_ENUM.number = 6
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_MAX_ENUM.name = "EARTIFACTOPTTYPE_MAX"
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_MAX_ENUM.index = 7
EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_MAX_ENUM.number = 7
...
EARTIFACTOPTTYPE.values = {
  ...
  EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_DECOMPOSE_ENUM,
  EARTIFACTOPTTYPE_EARTIFACTOPTTYPE_RETRIEVE_ALL_ENUM,
...
EMVPSTATE_EMVP_MIN_ENUM.name = "EMVP_MIN"
EMVPSTATE_EMVP_MIN_ENUM.index = 0
EMVPSTATE_EMVP_MIN_ENUM.number = 0
EMVPSTATE_EMVP_WILL_SUMMON_ENUM.name = "EMVP_WILL_SUMMON"
EMVPSTATE_EMVP_WILL_SUMMON_ENUM.index = 1
EMVPSTATE_EMVP_WILL_SUMMON_ENUM.number = 1
EMVPSTATE_EMVP_SUMMONED_ENUM.name = "EMVP_SUMMONED"
EMVPSTATE_EMVP_SUMMONED_ENUM.index = 2
EMVPSTATE_EMVP_SUMMONED_ENUM.number = 2
EMVPSTATE_EMVP_DIE_ENUM.name = "EMVP_DIE"
EMVPSTATE_EMVP_DIE_ENUM.index = 3
EMVPSTATE_EMVP_DIE_ENUM.number = 3
EMVPSTATE.name = "EMvpState"
EMVPSTATE.full_name = ".Cmd.EMvpState"
EMVPSTATE.values = {
  EMVPSTATE_EMVP_MIN_ENUM,
  EMVPSTATE_EMVP_WILL_SUMMON_ENUM,
  EMVPSTATE_EMVP_SUMMONED_ENUM,
  EMVPSTATE_EMVP_DIE_ENUM
}
...
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MIN_ENUM.name = "EGUILDDATEBATTLEMODE_MIN"
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MIN_ENUM.index = 0
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MIN_ENUM.number = 0
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_BASE_ENUM.name = "EGUILDDATEBATTLEMODE_BASE"
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_BASE_ENUM.index = 1
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_BASE_ENUM.number = 1
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_CLASSIC_ENUM.name = "EGUILDDATEBATTLEMODE_CLASSIC"
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_CLASSIC_ENUM.index = 2
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_CLASSIC_ENUM.number = 2
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP3_ENUM.name = "EGUILDDATEBATTLEMODE_MAP3"
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP3_ENUM.index = 3
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP3_ENUM.number = 3
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP4_ENUM.name = "EGUILDDATEBATTLEMODE_MAP4"
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP4_ENUM.index = 4
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP4_ENUM.number = 4
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP5_ENUM.name = "EGUILDDATEBATTLEMODE_MAP5"
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP5_ENUM.index = 5
EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP5_ENUM.number = 5
EGUILDDATEBATTLEMODE.name = "EGuildDateBattleMode"
EGUILDDATEBATTLEMODE.full_name = ".Cmd.EGuildDateBattleMode"
EGUILDDATEBATTLEMODE.values = {
  EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MIN_ENUM,
  EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_BASE_ENUM,
  EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_CLASSIC_ENUM,
  EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP3_ENUM,
  EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP4_ENUM,
  EGUILDDATEBATTLEMODE_EGUILDDATEBATTLEMODE_MAP5_ENUM
}
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_MIN_ENUM.name = "EGUILDDATEBATTLESTATE_MIN"
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_MIN_ENUM.index = 0
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_MIN_ENUM.number = 0
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVITE_ENUM.name = "EGUILDDATEBATTLESTATE_INVITE"
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVITE_ENUM.index = 1
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVITE_ENUM.number = 1
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_REFUSE_ENUM.name = "EGUILDDATEBATTLESTATE_REFUSE"
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_REFUSE_ENUM.index = 2
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_REFUSE_ENUM.number = 2
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_READY_ENUM.name = "EGUILDDATEBATTLESTATE_READY"
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_READY_ENUM.index = 3
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_READY_ENUM.number = 3
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_ING_ENUM.name = "EGUILDDATEBATTLESTATE_ING"
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_ING_ENUM.index = 4
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_ING_ENUM.number = 4
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_END_ENUM.name = "EGUILDDATEBATTLESTATE_END"
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_END_ENUM.index = 5
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_END_ENUM.number = 5
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVALID_ENUM.name = "EGUILDDATEBATTLESTATE_INVALID"
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVALID_ENUM.index = 6
EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVALID_ENUM.number = 6
EGUILDDATEBATTLESTATE.name = "EGuildDateBattleState"
EGUILDDATEBATTLESTATE.full_name = ".Cmd.EGuildDateBattleState"
EGUILDDATEBATTLESTATE.values = {
  EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_MIN_ENUM,
  EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVITE_ENUM,
  EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_REFUSE_ENUM,
  EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_READY_ENUM,
  EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_ING_ENUM,
  EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_END_ENUM,
  EGUILDDATEBATTLESTATE_EGUILDDATEBATTLESTATE_INVALID_ENUM
}
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_MIN_ENUM.name = "EDATEBATTLE_OPEN_STATE_MIN"
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_MIN_ENUM.index = 0
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_MIN_ENUM.number = 0
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_READY_ENUM.name = "EDATEBATTLE_OPEN_STATE_READY"
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_READY_ENUM.index = 1
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_READY_ENUM.number = 1
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_OPEN_ENUM.name = "EDATEBATTLE_OPEN_STATE_OPEN"
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_OPEN_ENUM.index = 2
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_OPEN_ENUM.number = 2
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_CLOSE_ENUM.name = "EDATEBATTLE_OPEN_STATE_CLOSE"
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_CLOSE_ENUM.index = 3
EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_CLOSE_ENUM.number = 3
EDATEBATTLEOPENSTATE.name = "EDateBattleOpenState"
EDATEBATTLEOPENSTATE.full_name = ".Cmd.EDateBattleOpenState"
EDATEBATTLEOPENSTATE.values = {
  EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_MIN_ENUM,
  EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_READY_ENUM,
  EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_OPEN_ENUM,
  EDATEBATTLEOPENSTATE_EDATEBATTLE_OPEN_STATE_CLOSE_ENUM
}
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_MIN_ENUM.name = "EGUILDDATEBATTLELISTTYPE_MIN"
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_MIN_ENUM.index = 0
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_MIN_ENUM.number = 0
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_READY_ENUM.name = "EGUILDDATEBATTLELISTTYPE_READY"
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_READY_ENUM.index = 1
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_READY_ENUM.number = 1
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_END_ENUM.name = "EGUILDDATEBATTLELISTTYPE_END"
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_END_ENUM.index = 2
EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_END_ENUM.number = 2
EGUILDDATEBATTLELISTTYPE.name = "EGuildDateBattleListType"
EGUILDDATEBATTLELISTTYPE.full_name = ".Cmd.EGuildDateBattleListType"
EGUILDDATEBATTLELISTTYPE.values = {
  EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_MIN_ENUM,
  EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_READY_ENUM,
  EGUILDDATEBATTLELISTTYPE_EGUILDDATEBATTLELISTTYPE_END_ENUM
}
...
MEMBERREDTIP_ID_FIELD.name = "id"
MEMBERREDTIP_ID_FIELD.full_name = ".Cmd.MemberRedTip.id"
MEMBERREDTIP_ID_FIELD.number = 1
MEMBERREDTIP_ID_FIELD.index = 0
MEMBERREDTIP_ID_FIELD.label = 1
MEMBERREDTIP_ID_FIELD.has_default_value = false
MEMBERREDTIP_ID_FIELD.default_value = 0
MEMBERREDTIP_ID_FIELD.type = 13
MEMBERREDTIP_ID_FIELD.cpp_type = 3
MEMBERREDTIP_SUBIDS_FIELD.name = "subids"
MEMBERREDTIP_SUBIDS_FIELD.full_name = ".Cmd.MemberRedTip.subids"
MEMBERREDTIP_SUBIDS_FIELD.number = 2
MEMBERREDTIP_SUBIDS_FIELD.index = 1
MEMBERREDTIP_SUBIDS_FIELD.label = 3
MEMBERREDTIP_SUBIDS_FIELD.has_default_value = false
MEMBERREDTIP_SUBIDS_FIELD.default_value = {}
MEMBERREDTIP_SUBIDS_FIELD.type = 4
MEMBERREDTIP_SUBIDS_FIELD.cpp_type = 4
MEMBERREDTIP.name = "MemberRedTip"
MEMBERREDTIP.full_name = ".Cmd.MemberRedTip"
MEMBERREDTIP.nested_types = {}
MEMBERREDTIP.enum_types = {}
MEMBERREDTIP.fields = {
  MEMBERREDTIP_ID_FIELD,
  MEMBERREDTIP_SUBIDS_FIELD
}
MEMBERREDTIP.is_extendable = false
MEMBERREDTIP.extensions = {}
...
GUILDMEMBER_REDTIPS_FIELD.name = "redtips"
GUILDMEMBER_REDTIPS_FIELD.full_name = ".Cmd.GuildMember.redtips"
GUILDMEMBER_REDTIPS_FIELD.number = 55
GUILDMEMBER_REDTIPS_FIELD.index = 52
GUILDMEMBER_REDTIPS_FIELD.label = 3
GUILDMEMBER_REDTIPS_FIELD.has_default_value = false
GUILDMEMBER_REDTIPS_FIELD.default_value = {}
GUILDMEMBER_REDTIPS_FIELD.message_type = MEMBERREDTIP
GUILDMEMBER_REDTIPS_FIELD.type = 11
GUILDMEMBER_REDTIPS_FIELD.cpp_type = 10
...
GUILDCHALLENGE_REWARDITEM_FIELD.name = "rewarditem"
GUILDCHALLENGE_REWARDITEM_FIELD.full_name = ".Cmd.GuildChallenge.rewarditem"
GUILDCHALLENGE_REWARDITEM_FIELD.number = 5
GUILDCHALLENGE_REWARDITEM_FIELD.index = 4
GUILDCHALLENGE_REWARDITEM_FIELD.label = 1
GUILDCHALLENGE_REWARDITEM_FIELD.has_default_value = false
GUILDCHALLENGE_REWARDITEM_FIELD.default_value = nil
GUILDCHALLENGE_REWARDITEM_FIELD.message_type = SceneItem_pb.ITEMINFO
GUILDCHALLENGE_REWARDITEM_FIELD.type = 11
GUILDCHALLENGE_REWARDITEM_FIELD.cpp_type = 10
...
GUILDCHALLENGE.fields = {
  ...
  GUILDCHALLENGE_REWARDITEM_FIELD
}
...
GUILDWELFAREITEM_REWARDITEM_FIELD.name = "rewarditem"
GUILDWELFAREITEM_REWARDITEM_FIELD.full_name = ".Cmd.GuildWelfareItem.rewarditem"
GUILDWELFAREITEM_REWARDITEM_FIELD.number = 12
GUILDWELFAREITEM_REWARDITEM_FIELD.index = 11
GUILDWELFAREITEM_REWARDITEM_FIELD.label = 1
GUILDWELFAREITEM_REWARDITEM_FIELD.has_default_value = false
GUILDWELFAREITEM_REWARDITEM_FIELD.default_value = nil
GUILDWELFAREITEM_REWARDITEM_FIELD.message_type = SceneItem_pb.ITEMINFO
GUILDWELFAREITEM_REWARDITEM_FIELD.type = 11
GUILDWELFAREITEM_REWARDITEM_FIELD.cpp_type = 10
...
GUILDWELFAREITEM.fields = {
  ...
  GUILDWELFAREITEM_REWARDITEM_FIELD
}
...
GUILDARTIFACTITEM_OWNERID_FIELD.index = 3
...
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.name = "noreceive_back_time"
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.full_name = ".Cmd.GuildArtifactItem.noreceive_back_time"
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.number = 6
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.index = 4
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.label = 1
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.has_default_value = false
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.default_value = 0
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.type = 13
GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD.cpp_type = 3
...
GUILDARTIFACTITEM.fields = {
  ...
  GUILDARTIFACTITEM_NORECEIVE_BACK_TIME_FIELD
}
...
GUILDSUMMARYDATA_APPLIED_FIELD.name = "applied"
GUILDSUMMARYDATA_APPLIED_FIELD.full_name = ".Cmd.GuildSummaryData.applied"
GUILDSUMMARYDATA_APPLIED_FIELD.number = 21
GUILDSUMMARYDATA_APPLIED_FIELD.index = 20
GUILDSUMMARYDATA_APPLIED_FIELD.label = 1
GUILDSUMMARYDATA_APPLIED_FIELD.has_default_value = false
GUILDSUMMARYDATA_APPLIED_FIELD.default_value = false
GUILDSUMMARYDATA_APPLIED_FIELD.type = 8
GUILDSUMMARYDATA_APPLIED_FIELD.cpp_type = 7
GUILDSUMMARYDATA_MERCENARY_FIELD.name = "mercenary"
GUILDSUMMARYDATA_MERCENARY_FIELD.full_name = ".Cmd.GuildSummaryData.mercenary"
GUILDSUMMARYDATA_MERCENARY_FIELD.number = 22
GUILDSUMMARYDATA_MERCENARY_FIELD.index = 21
GUILDSUMMARYDATA_MERCENARY_FIELD.label = 1
GUILDSUMMARYDATA_MERCENARY_FIELD.has_default_value = false
GUILDSUMMARYDATA_MERCENARY_FIELD.default_value = false
GUILDSUMMARYDATA_MERCENARY_FIELD.type = 8
GUILDSUMMARYDATA_MERCENARY_FIELD.cpp_type = 7
GUILDSUMMARYDATA_CHAIRMANID_FIELD.name = "chairmanid"
GUILDSUMMARYDATA_CHAIRMANID_FIELD.full_name = ".Cmd.GuildSummaryData.chairmanid"
GUILDSUMMARYDATA_CHAIRMANID_FIELD.number = 24
GUILDSUMMARYDATA_CHAIRMANID_FIELD.index = 22
GUILDSUMMARYDATA_CHAIRMANID_FIELD.label = 1
GUILDSUMMARYDATA_CHAIRMANID_FIELD.has_default_value = true
GUILDSUMMARYDATA_CHAIRMANID_FIELD.default_value = 0
GUILDSUMMARYDATA_CHAIRMANID_FIELD.type = 4
GUILDSUMMARYDATA_CHAIRMANID_FIELD.cpp_type = 4
...
GUILDSUMMARYDATA.fields = {
  ...
  GUILDSUMMARYDATA_APPLIED_FIELD,
  GUILDSUMMARYDATA_MERCENARY_FIELD,
  GUILDSUMMARYDATA_CHAIRMANID_FIELD
}
...
GUILDDATA_CHANGE_GROUP_TIME_FIELD.name = "change_group_time"
GUILDDATA_CHANGE_GROUP_TIME_FIELD.full_name = ".Cmd.GuildData.change_group_time"
GUILDDATA_CHANGE_GROUP_TIME_FIELD.number = 29
GUILDDATA_CHANGE_GROUP_TIME_FIELD.index = 26
GUILDDATA_CHANGE_GROUP_TIME_FIELD.label = 1
GUILDDATA_CHANGE_GROUP_TIME_FIELD.has_default_value = false
GUILDDATA_CHANGE_GROUP_TIME_FIELD.default_value = 0
GUILDDATA_CHANGE_GROUP_TIME_FIELD.type = 13
GUILDDATA_CHANGE_GROUP_TIME_FIELD.cpp_type = 3
...
GUILDDATA.fields = {
  ...
  GUILDDATA_CHANGE_GROUP_TIME_FIELD
}
...
GUILDINFONTF_ISMVP_FIELD.name = "ismvp"
GUILDINFONTF_ISMVP_FIELD.full_name = ".Cmd.GuildInfoNtf.ismvp"
GUILDINFONTF_ISMVP_FIELD.number = 9
GUILDINFONTF_ISMVP_FIELD.index = 7
GUILDINFONTF_ISMVP_FIELD.label = 1
GUILDINFONTF_ISMVP_FIELD.has_default_value = false
GUILDINFONTF_ISMVP_FIELD.default_value = false
GUILDINFONTF_ISMVP_FIELD.type = 8
GUILDINFONTF_ISMVP_FIELD.cpp_type = 7
...
GUILDINFONTF_MERCENARY_GUILD_FIELD.index = 8
...
GUILDCITYINFO_ROADBLOCK_FIELD.name = "roadblock"
GUILDCITYINFO_ROADBLOCK_FIELD.full_name = ".Cmd.GuildCityInfo.roadblock"
GUILDCITYINFO_ROADBLOCK_FIELD.number = 10
GUILDCITYINFO_ROADBLOCK_FIELD.index = 9
GUILDCITYINFO_ROADBLOCK_FIELD.label = 1
GUILDCITYINFO_ROADBLOCK_FIELD.has_default_value = false
GUILDCITYINFO_ROADBLOCK_FIELD.default_value = 0
GUILDCITYINFO_ROADBLOCK_FIELD.type = 13
GUILDCITYINFO_ROADBLOCK_FIELD.cpp_type = 3
...
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.name = "guild_id"
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.full_name = ".Cmd.ArtifactUpdateNtfGuildCmd.guild_id"
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.number = 6
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.index = 5
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.label = 1
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.has_default_value = false
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.default_value = 0
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.type = 4
ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD.cpp_type = 4
...
ARTIFACTUPDATENTFGUILDCMD.fields = {
  ...
  ARTIFACTUPDATENTFGUILDCMD_GUILD_ID_FIELD
}
...
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.name = "mercenary_queried"
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.full_name = ".Cmd.ArtifactOptGuildCmd.mercenary_queried"
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.number = 6
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.index = 5
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.label = 1
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.has_default_value = false
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.default_value = false
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.type = 8
ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD.cpp_type = 7
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.name = "is_mercenary"
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.full_name = ".Cmd.ArtifactOptGuildCmd.is_mercenary"
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.number = 7
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.index = 6
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.label = 1
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.has_default_value = false
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.default_value = false
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.type = 8
ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD.cpp_type = 7
...
ARTIFACTOPTGUILDCMD.fields = {
  ...
  ARTIFACTOPTGUILDCMD_MERCENARY_QUERIED_FIELD,
  ARTIFACTOPTGUILDCMD_IS_MERCENARY_FIELD
}
...
CITYSHOWINFO_OLDGUILD_FIELD.type = 4
CITYSHOWINFO_OLDGUILD_FIELD.cpp_type = 4
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.name = "occupy_guilds"
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.full_name = ".Cmd.CityShowInfo.occupy_guilds"
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.number = 10
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.index = 9
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.label = 3
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.has_default_value = false
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.default_value = {}
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.type = 4
CITYSHOWINFO_OCCUPY_GUILDS_FIELD.cpp_type = 4
CITYSHOWINFO_ROADBLOCK_FIELD.name = "roadblock"
CITYSHOWINFO_ROADBLOCK_FIELD.full_name = ".Cmd.CityShowInfo.roadblock"
CITYSHOWINFO_ROADBLOCK_FIELD.number = 11
CITYSHOWINFO_ROADBLOCK_FIELD.index = 10
CITYSHOWINFO_ROADBLOCK_FIELD.label = 1
CITYSHOWINFO_ROADBLOCK_FIELD.has_default_value = false
CITYSHOWINFO_ROADBLOCK_FIELD.default_value = 0
CITYSHOWINFO_ROADBLOCK_FIELD.type = 13
CITYSHOWINFO_ROADBLOCK_FIELD.cpp_type = 3
CITYSHOWINFO_MVP_STATE_FIELD.name = "mvp_state"
CITYSHOWINFO_MVP_STATE_FIELD.full_name = ".Cmd.CityShowInfo.mvp_state"
CITYSHOWINFO_MVP_STATE_FIELD.number = 12
CITYSHOWINFO_MVP_STATE_FIELD.index = 11
CITYSHOWINFO_MVP_STATE_FIELD.label = 1
CITYSHOWINFO_MVP_STATE_FIELD.has_default_value = false
CITYSHOWINFO_MVP_STATE_FIELD.default_value = nil
CITYSHOWINFO_MVP_STATE_FIELD.enum_type = EMVPSTATE
CITYSHOWINFO_MVP_STATE_FIELD.type = 14
CITYSHOWINFO_MVP_STATE_FIELD.cpp_type = 8
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.name = "mvp_summon_time"
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.full_name = ".Cmd.CityShowInfo.mvp_summon_time"
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.number = 13
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.index = 12
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.label = 1
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.has_default_value = false
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.default_value = 0
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.type = 13
CITYSHOWINFO_MVP_SUMMON_TIME_FIELD.cpp_type = 3
...
CITYSHOWINFO.fields = {
  ...
  CITYSHOWINFO_OCCUPY_GUILDS_FIELD,
  CITYSHOWINFO_ROADBLOCK_FIELD,
  CITYSHOWINFO_MVP_STATE_FIELD,
  CITYSHOWINFO_MVP_SUMMON_TIME_FIELD
}
...
GVGOPENFIREGUILDCMD_START_TIME_FIELD.name = "start_time"
GVGOPENFIREGUILDCMD_START_TIME_FIELD.full_name = ".Cmd.GvgOpenFireGuildCmd.start_time"
GVGOPENFIREGUILDCMD_START_TIME_FIELD.number = 5
GVGOPENFIREGUILDCMD_START_TIME_FIELD.index = 4
GVGOPENFIREGUILDCMD_START_TIME_FIELD.label = 1
GVGOPENFIREGUILDCMD_START_TIME_FIELD.has_default_value = false
GVGOPENFIREGUILDCMD_START_TIME_FIELD.default_value = 0
GVGOPENFIREGUILDCMD_START_TIME_FIELD.type = 13
GVGOPENFIREGUILDCMD_START_TIME_FIELD.cpp_type = 3
...
GVGOPENFIREGUILDCMD.fields = {
  ...
  GVGOPENFIREGUILDCMD_START_TIME_FIELD
}
...
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.name = "gvg_group"
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.full_name = ".Cmd.SuperGvgGuildData.gvg_group"
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.number = 6
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.index = 5
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.label = 1
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.has_default_value = false
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.default_value = 0
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.type = 13
SUPERGVGGUILDDATA_GVG_GROUP_FIELD.cpp_type = 3
...
SUPERGVGGUILDDATA.fields = {
  ...
  SUPERGVGGUILDDATA_GVG_GROUP_FIELD
}
...
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.name = "end_flag"
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.full_name = ".Cmd.QuerySuperGvgDataGuildCmd.end_flag"
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.number = 4
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.index = 3
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.label = 1
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.has_default_value = false
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.default_value = false
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.type = 8
QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD.cpp_type = 7
...
QUERYSUPERGVGDATAGUILDCMD.fields = {
  ...
  QUERYSUPERGVGDATAGUILDCMD_END_FLAG_FIELD
}
...
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.name = "groupid"
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.full_name = ".Cmd.UpdateMapCityGuildCmd.groupid"
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.number = 4
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.index = 3
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.label = 1
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.has_default_value = false
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.default_value = 0
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.type = 13
UPDATEMAPCITYGUILDCMD_GROUPID_FIELD.cpp_type = 3
...
UPDATEMAPCITYGUILDCMD.fields = {
  ...
  UPDATEMAPCITYGUILDCMD_GROUPID_FIELD
}
...
GUILDSHOWINFO_GVG_GROUP_FIELD.name = "gvg_group"
GUILDSHOWINFO_GVG_GROUP_FIELD.full_name = ".Cmd.GuildShowInfo.gvg_group"
GUILDSHOWINFO_GVG_GROUP_FIELD.number = 7
GUILDSHOWINFO_GVG_GROUP_FIELD.index = 6
GUILDSHOWINFO_GVG_GROUP_FIELD.label = 1
GUILDSHOWINFO_GVG_GROUP_FIELD.has_default_value = false
GUILDSHOWINFO_GVG_GROUP_FIELD.default_value = 0
GUILDSHOWINFO_GVG_GROUP_FIELD.type = 13
GUILDSHOWINFO_GVG_GROUP_FIELD.cpp_type = 3
...
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.name = "point_score"
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.full_name = ".Cmd.GvgScoreDetailInfo.point_score"
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.number = 7
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.index = 6
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.label = 1
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.has_default_value = false
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.default_value = 0
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.type = 13
GVGSCOREDETAILINFO_POINT_SCORE_FIELD.cpp_type = 3
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.name = "mvp_score"
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.full_name = ".Cmd.GvgScoreDetailInfo.mvp_score"
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.number = 8
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.index = 7
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.label = 1
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.has_default_value = false
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.default_value = 0
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.type = 13
GVGSCOREDETAILINFO_MVP_SCORE_FIELD.cpp_type = 3
...
GVGSCOREDETAILINFO.fields = {
  ...
  GVGSCOREDETAILINFO_POINT_SCORE_FIELD,
  GVGSCOREDETAILINFO_MVP_SCORE_FIELD
}
...
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.name = "tasks"
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.full_name = ".Cmd.GvgTaskUpdateGuildCmd.tasks"
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.number = 3
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.index = 2
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.label = 3
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.has_default_value = false
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.default_value = {}
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.message_type = GVGTASKDATA
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.type = 11
GVGTASKUPDATEGUILDCMD_TASKS_FIELD.cpp_type = 10
...
GVGTASKUPDATEGUILDCMD.fields = {
  ...
  GVGTASKUPDATEGUILDCMD_TASKS_FIELD,
...
GVGSTATUEINFO_POSE_FIELD.name = "pose"
GVGSTATUEINFO_POSE_FIELD.full_name = ".Cmd.GvgStatueInfo.pose"
GVGSTATUEINFO_POSE_FIELD.number = 14
GVGSTATUEINFO_POSE_FIELD.index = 11
GVGSTATUEINFO_POSE_FIELD.label = 1
GVGSTATUEINFO_POSE_FIELD.has_default_value = false
GVGSTATUEINFO_POSE_FIELD.default_value = 0
GVGSTATUEINFO_POSE_FIELD.type = 13
GVGSTATUEINFO_POSE_FIELD.cpp_type = 3
...
GVGSCOREINFO_PRECITYID_FIELD.name = "precityid"
GVGSCOREINFO_PRECITYID_FIELD.full_name = ".Cmd.GvgScoreInfo.precityid"
GVGSCOREINFO_PRECITYID_FIELD.number = 1
GVGSCOREINFO_PRECITYID_FIELD.index = 0
GVGSCOREINFO_PRECITYID_FIELD.label = 1
GVGSCOREINFO_PRECITYID_FIELD.has_default_value = false
GVGSCOREINFO_PRECITYID_FIELD.default_value = 0
GVGSCOREINFO_PRECITYID_FIELD.type = 13
GVGSCOREINFO_PRECITYID_FIELD.cpp_type = 3
...
GVGSCOREINFO_DEFENSE_SCORE_FIELD.index = 1
...
GVGSCOREINFO_ATTACK_SCORE_FIELD.index = 2
...
GVGSCOREINFO_PERFECT_SCORE_FIELD.index = 3
...
GVGSCOREINFO_DEFENSECITYS_FIELD.index = 4
...
GVGSCOREINFO_LOSE_POINTS_FIELD.name = "lose_points"
GVGSCOREINFO_LOSE_POINTS_FIELD.full_name = ".Cmd.GvgScoreInfo.lose_points"
GVGSCOREINFO_LOSE_POINTS_FIELD.number = 7
GVGSCOREINFO_LOSE_POINTS_FIELD.index = 5
GVGSCOREINFO_LOSE_POINTS_FIELD.label = 3
GVGSCOREINFO_LOSE_POINTS_FIELD.has_default_value = false
GVGSCOREINFO_LOSE_POINTS_FIELD.default_value = {}
GVGSCOREINFO_LOSE_POINTS_FIELD.type = 13
GVGSCOREINFO_LOSE_POINTS_FIELD.cpp_type = 3
GVGSCOREINFO_MVP_SCORE_FIELD.name = "mvp_score"
GVGSCOREINFO_MVP_SCORE_FIELD.full_name = ".Cmd.GvgScoreInfo.mvp_score"
GVGSCOREINFO_MVP_SCORE_FIELD.number = 8
GVGSCOREINFO_MVP_SCORE_FIELD.index = 6
GVGSCOREINFO_MVP_SCORE_FIELD.label = 1
GVGSCOREINFO_MVP_SCORE_FIELD.has_default_value = false
GVGSCOREINFO_MVP_SCORE_FIELD.default_value = 0
GVGSCOREINFO_MVP_SCORE_FIELD.type = 13
GVGSCOREINFO_MVP_SCORE_FIELD.cpp_type = 3
GVGSCOREINFO.name = "GvgScoreInfo"
GVGSCOREINFO.full_name = ".Cmd.GvgScoreInfo"
GVGSCOREINFO.nested_types = {}
GVGSCOREINFO.enum_types = {}
GVGSCOREINFO.fields = {
  GVGSCOREINFO_PRECITYID_FIELD,
  ...
  GVGSCOREINFO_LOSE_POINTS_FIELD,
  GVGSCOREINFO_MVP_SCORE_FIELD
}
...
GVGGUILDGROUPINFO_GROUPID_FIELD.name = "groupid"
GVGGUILDGROUPINFO_GROUPID_FIELD.full_name = ".Cmd.GvgGuildGroupInfo.groupid"
GVGGUILDGROUPINFO_GROUPID_FIELD.number = 5
GVGGUILDGROUPINFO_GROUPID_FIELD.index = 2
GVGGUILDGROUPINFO_GROUPID_FIELD.label = 1
GVGGUILDGROUPINFO_GROUPID_FIELD.has_default_value = false
GVGGUILDGROUPINFO_GROUPID_FIELD.default_value = 0
GVGGUILDGROUPINFO_GROUPID_FIELD.type = 13
GVGGUILDGROUPINFO_GROUPID_FIELD.cpp_type = 3
...
GVGGUILDGROUPINFO.fields = {
  ...
  GVGGUILDGROUPINFO_GROUPID_FIELD
}
...
GVGSETTLEINFO_PREPARE_CITYS_FIELD.name = "prepare_citys"
GVGSETTLEINFO_PREPARE_CITYS_FIELD.full_name = ".Cmd.GvgSettleInfo.prepare_citys"
GVGSETTLEINFO_PREPARE_CITYS_FIELD.number = 6
GVGSETTLEINFO_PREPARE_CITYS_FIELD.index = 5
GVGSETTLEINFO_PREPARE_CITYS_FIELD.label = 3
GVGSETTLEINFO_PREPARE_CITYS_FIELD.has_default_value = false
GVGSETTLEINFO_PREPARE_CITYS_FIELD.default_value = {}
GVGSETTLEINFO_PREPARE_CITYS_FIELD.type = 13
GVGSETTLEINFO_PREPARE_CITYS_FIELD.cpp_type = 3
...
GVGSETTLEINFO.fields = {
  ...
  GVGSETTLEINFO_PREPARE_CITYS_FIELD
}
...
GVGUSERFIREDATA_CHARID_FIELD.name = "charid"
GVGUSERFIREDATA_CHARID_FIELD.full_name = ".Cmd.GvgUserFireData.charid"
GVGUSERFIREDATA_CHARID_FIELD.number = 1
GVGUSERFIREDATA_CHARID_FIELD.index = 0
GVGUSERFIREDATA_CHARID_FIELD.label = 1
GVGUSERFIREDATA_CHARID_FIELD.has_default_value = false
GVGUSERFIREDATA_CHARID_FIELD.default_value = 0
GVGUSERFIREDATA_CHARID_FIELD.type = 4
GVGUSERFIREDATA_CHARID_FIELD.cpp_type = 4
GVGUSERFIREDATA_USERNAME_FIELD.name = "username"
GVGUSERFIREDATA_USERNAME_FIELD.full_name = ".Cmd.GvgUserFireData.username"
GVGUSERFIREDATA_USERNAME_FIELD.number = 2
GVGUSERFIREDATA_USERNAME_FIELD.index = 1
GVGUSERFIREDATA_USERNAME_FIELD.label = 1
GVGUSERFIREDATA_USERNAME_FIELD.has_default_value = false
GVGUSERFIREDATA_USERNAME_FIELD.default_value = ""
GVGUSERFIREDATA_USERNAME_FIELD.type = 9
GVGUSERFIREDATA_USERNAME_FIELD.cpp_type = 9
GVGUSERFIREDATA_PROFESSION_FIELD.name = "profession"
GVGUSERFIREDATA_PROFESSION_FIELD.full_name = ".Cmd.GvgUserFireData.profession"
GVGUSERFIREDATA_PROFESSION_FIELD.number = 3
GVGUSERFIREDATA_PROFESSION_FIELD.index = 2
GVGUSERFIREDATA_PROFESSION_FIELD.label = 1
GVGUSERFIREDATA_PROFESSION_FIELD.has_default_value = false
GVGUSERFIREDATA_PROFESSION_FIELD.default_value = 0
GVGUSERFIREDATA_PROFESSION_FIELD.type = 13
GVGUSERFIREDATA_PROFESSION_FIELD.cpp_type = 3
GVGUSERFIREDATA_KILLUSERNUM_FIELD.name = "killusernum"
GVGUSERFIREDATA_KILLUSERNUM_FIELD.full_name = ".Cmd.GvgUserFireData.killusernum"
GVGUSERFIREDATA_KILLUSERNUM_FIELD.number = 4
GVGUSERFIREDATA_KILLUSERNUM_FIELD.index = 3
GVGUSERFIREDATA_KILLUSERNUM_FIELD.label = 1
GVGUSERFIREDATA_KILLUSERNUM_FIELD.has_default_value = false
GVGUSERFIREDATA_KILLUSERNUM_FIELD.default_value = 0
GVGUSERFIREDATA_KILLUSERNUM_FIELD.type = 13
GVGUSERFIREDATA_KILLUSERNUM_FIELD.cpp_type = 3
GVGUSERFIREDATA_DIENUM_FIELD.name = "dienum"
GVGUSERFIREDATA_DIENUM_FIELD.full_name = ".Cmd.GvgUserFireData.dienum"
GVGUSERFIREDATA_DIENUM_FIELD.number = 5
GVGUSERFIREDATA_DIENUM_FIELD.index = 4
GVGUSERFIREDATA_DIENUM_FIELD.label = 1
GVGUSERFIREDATA_DIENUM_FIELD.has_default_value = false
GVGUSERFIREDATA_DIENUM_FIELD.default_value = 0
GVGUSERFIREDATA_DIENUM_FIELD.type = 13
GVGUSERFIREDATA_DIENUM_FIELD.cpp_type = 3
GVGUSERFIREDATA_POINTNUM_FIELD.name = "pointnum"
GVGUSERFIREDATA_POINTNUM_FIELD.full_name = ".Cmd.GvgUserFireData.pointnum"
GVGUSERFIREDATA_POINTNUM_FIELD.number = 6
GVGUSERFIREDATA_POINTNUM_FIELD.index = 5
GVGUSERFIREDATA_POINTNUM_FIELD.label = 1
GVGUSERFIREDATA_POINTNUM_FIELD.has_default_value = false
GVGUSERFIREDATA_POINTNUM_FIELD.default_value = 0
GVGUSERFIREDATA_POINTNUM_FIELD.type = 13
GVGUSERFIREDATA_POINTNUM_FIELD.cpp_type = 3
GVGUSERFIREDATA_POINTTIME_FIELD.name = "pointtime"
GVGUSERFIREDATA_POINTTIME_FIELD.full_name = ".Cmd.GvgUserFireData.pointtime"
GVGUSERFIREDATA_POINTTIME_FIELD.number = 7
GVGUSERFIREDATA_POINTTIME_FIELD.index = 6
GVGUSERFIREDATA_POINTTIME_FIELD.label = 1
GVGUSERFIREDATA_POINTTIME_FIELD.has_default_value = false
GVGUSERFIREDATA_POINTTIME_FIELD.default_value = 0
GVGUSERFIREDATA_POINTTIME_FIELD.type = 13
GVGUSERFIREDATA_POINTTIME_FIELD.cpp_type = 3
GVGUSERFIREDATA_HEALHP_FIELD.name = "healhp"
GVGUSERFIREDATA_HEALHP_FIELD.full_name = ".Cmd.GvgUserFireData.healhp"
GVGUSERFIREDATA_HEALHP_FIELD.number = 8
GVGUSERFIREDATA_HEALHP_FIELD.index = 7
GVGUSERFIREDATA_HEALHP_FIELD.label = 1
GVGUSERFIREDATA_HEALHP_FIELD.has_default_value = false
GVGUSERFIREDATA_HEALHP_FIELD.default_value = 0
GVGUSERFIREDATA_HEALHP_FIELD.type = 13
GVGUSERFIREDATA_HEALHP_FIELD.cpp_type = 3
GVGUSERFIREDATA_RELIVENUM_FIELD.name = "relivenum"
GVGUSERFIREDATA_RELIVENUM_FIELD.full_name = ".Cmd.GvgUserFireData.relivenum"
GVGUSERFIREDATA_RELIVENUM_FIELD.number = 9
GVGUSERFIREDATA_RELIVENUM_FIELD.index = 8
GVGUSERFIREDATA_RELIVENUM_FIELD.label = 1
GVGUSERFIREDATA_RELIVENUM_FIELD.has_default_value = false
GVGUSERFIREDATA_RELIVENUM_FIELD.default_value = 0
GVGUSERFIREDATA_RELIVENUM_FIELD.type = 13
GVGUSERFIREDATA_RELIVENUM_FIELD.cpp_type = 3
GVGUSERFIREDATA_METALDAMAGE_FIELD.name = "metaldamage"
GVGUSERFIREDATA_METALDAMAGE_FIELD.full_name = ".Cmd.GvgUserFireData.metaldamage"
GVGUSERFIREDATA_METALDAMAGE_FIELD.number = 10
GVGUSERFIREDATA_METALDAMAGE_FIELD.index = 9
GVGUSERFIREDATA_METALDAMAGE_FIELD.label = 1
GVGUSERFIREDATA_METALDAMAGE_FIELD.has_default_value = false
GVGUSERFIREDATA_METALDAMAGE_FIELD.default_value = 0
GVGUSERFIREDATA_METALDAMAGE_FIELD.type = 13
GVGUSERFIREDATA_METALDAMAGE_FIELD.cpp_type = 3
GVGUSERFIREDATA_HELPNUM_FIELD.name = "helpnum"
GVGUSERFIREDATA_HELPNUM_FIELD.full_name = ".Cmd.GvgUserFireData.helpnum"
GVGUSERFIREDATA_HELPNUM_FIELD.number = 11
GVGUSERFIREDATA_HELPNUM_FIELD.index = 10
GVGUSERFIREDATA_HELPNUM_FIELD.label = 1
GVGUSERFIREDATA_HELPNUM_FIELD.has_default_value = false
GVGUSERFIREDATA_HELPNUM_FIELD.default_value = 0
GVGUSERFIREDATA_HELPNUM_FIELD.type = 13
GVGUSERFIREDATA_HELPNUM_FIELD.cpp_type = 3
GVGUSERFIREDATA_EXPELNUM_FIELD.name = "expelnum"
GVGUSERFIREDATA_EXPELNUM_FIELD.full_name = ".Cmd.GvgUserFireData.expelnum"
GVGUSERFIREDATA_EXPELNUM_FIELD.number = 12
GVGUSERFIREDATA_EXPELNUM_FIELD.index = 11
GVGUSERFIREDATA_EXPELNUM_FIELD.label = 1
GVGUSERFIREDATA_EXPELNUM_FIELD.has_default_value = false
GVGUSERFIREDATA_EXPELNUM_FIELD.default_value = 0
GVGUSERFIREDATA_EXPELNUM_FIELD.type = 13
GVGUSERFIREDATA_EXPELNUM_FIELD.cpp_type = 3
GVGUSERFIREDATA_DAMAGE_FIELD.name = "damage"
GVGUSERFIREDATA_DAMAGE_FIELD.full_name = ".Cmd.GvgUserFireData.damage"
GVGUSERFIREDATA_DAMAGE_FIELD.number = 13
GVGUSERFIREDATA_DAMAGE_FIELD.index = 12
GVGUSERFIREDATA_DAMAGE_FIELD.label = 1
GVGUSERFIREDATA_DAMAGE_FIELD.has_default_value = false
GVGUSERFIREDATA_DAMAGE_FIELD.default_value = 0
GVGUSERFIREDATA_DAMAGE_FIELD.type = 4
GVGUSERFIREDATA_DAMAGE_FIELD.cpp_type = 4
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.name = "mvp_damage"
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.full_name = ".Cmd.GvgUserFireData.mvp_damage"
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.number = 14
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.index = 13
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.label = 1
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.has_default_value = false
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.default_value = 0
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.type = 13
GVGUSERFIREDATA_MVP_DAMAGE_FIELD.cpp_type = 3
GVGUSERFIREDATA.name = "GvgUserFireData"
GVGUSERFIREDATA.full_name = ".Cmd.GvgUserFireData"
GVGUSERFIREDATA.nested_types = {}
GVGUSERFIREDATA.enum_types = {}
GVGUSERFIREDATA.fields = {
  GVGUSERFIREDATA_CHARID_FIELD,
  GVGUSERFIREDATA_USERNAME_FIELD,
  GVGUSERFIREDATA_PROFESSION_FIELD,
  GVGUSERFIREDATA_KILLUSERNUM_FIELD,
  GVGUSERFIREDATA_DIENUM_FIELD,
  GVGUSERFIREDATA_POINTNUM_FIELD,
  GVGUSERFIREDATA_POINTTIME_FIELD,
  GVGUSERFIREDATA_HEALHP_FIELD,
  GVGUSERFIREDATA_RELIVENUM_FIELD,
  GVGUSERFIREDATA_METALDAMAGE_FIELD,
  GVGUSERFIREDATA_HELPNUM_FIELD,
  GVGUSERFIREDATA_EXPELNUM_FIELD,
  GVGUSERFIREDATA_DAMAGE_FIELD,
  GVGUSERFIREDATA_MVP_DAMAGE_FIELD
}
GVGUSERFIREDATA.is_extendable = false
GVGUSERFIREDATA.extensions = {}
GVGFIREREPORTGUILDCMD_CMD_FIELD.name = "cmd"
GVGFIREREPORTGUILDCMD_CMD_FIELD.full_name = ".Cmd.GvgFireReportGuildCmd.cmd"
GVGFIREREPORTGUILDCMD_CMD_FIELD.number = 1
GVGFIREREPORTGUILDCMD_CMD_FIELD.index = 0
GVGFIREREPORTGUILDCMD_CMD_FIELD.label = 1
GVGFIREREPORTGUILDCMD_CMD_FIELD.has_default_value = true
GVGFIREREPORTGUILDCMD_CMD_FIELD.default_value = 50
GVGFIREREPORTGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
GVGFIREREPORTGUILDCMD_CMD_FIELD.type = 14
GVGFIREREPORTGUILDCMD_CMD_FIELD.cpp_type = 8
GVGFIREREPORTGUILDCMD_PARAM_FIELD.name = "param"
GVGFIREREPORTGUILDCMD_PARAM_FIELD.full_name = ".Cmd.GvgFireReportGuildCmd.param"
GVGFIREREPORTGUILDCMD_PARAM_FIELD.number = 2
GVGFIREREPORTGUILDCMD_PARAM_FIELD.index = 1
GVGFIREREPORTGUILDCMD_PARAM_FIELD.label = 1
GVGFIREREPORTGUILDCMD_PARAM_FIELD.has_default_value = true
GVGFIREREPORTGUILDCMD_PARAM_FIELD.default_value = 94
GVGFIREREPORTGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
GVGFIREREPORTGUILDCMD_PARAM_FIELD.type = 14
GVGFIREREPORTGUILDCMD_PARAM_FIELD.cpp_type = 8
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.name = "firetime"
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.full_name = ".Cmd.GvgFireReportGuildCmd.firetime"
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.number = 3
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.index = 2
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.label = 1
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.has_default_value = false
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.default_value = 0
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.type = 13
GVGFIREREPORTGUILDCMD_FIRETIME_FIELD.cpp_type = 3
GVGFIREREPORTGUILDCMD_DATAS_FIELD.name = "datas"
GVGFIREREPORTGUILDCMD_DATAS_FIELD.full_name = ".Cmd.GvgFireReportGuildCmd.datas"
GVGFIREREPORTGUILDCMD_DATAS_FIELD.number = 4
GVGFIREREPORTGUILDCMD_DATAS_FIELD.index = 3
GVGFIREREPORTGUILDCMD_DATAS_FIELD.label = 3
GVGFIREREPORTGUILDCMD_DATAS_FIELD.has_default_value = false
GVGFIREREPORTGUILDCMD_DATAS_FIELD.default_value = {}
GVGFIREREPORTGUILDCMD_DATAS_FIELD.message_type = GVGUSERFIREDATA
GVGFIREREPORTGUILDCMD_DATAS_FIELD.type = 11
GVGFIREREPORTGUILDCMD_DATAS_FIELD.cpp_type = 10
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.name = "mydata"
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.full_name = ".Cmd.GvgFireReportGuildCmd.mydata"
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.number = 5
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.index = 4
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.label = 1
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.has_default_value = false
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.default_value = nil
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.message_type = GVGUSERFIREDATA
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.type = 11
GVGFIREREPORTGUILDCMD_MYDATA_FIELD.cpp_type = 10
GVGFIREREPORTGUILDCMD.name = "GvgFireReportGuildCmd"
GVGFIREREPORTGUILDCMD.full_name = ".Cmd.GvgFireReportGuildCmd"
GVGFIREREPORTGUILDCMD.nested_types = {}
GVGFIREREPORTGUILDCMD.enum_types = {}
GVGFIREREPORTGUILDCMD.fields = {
  GVGFIREREPORTGUILDCMD_CMD_FIELD,
  GVGFIREREPORTGUILDCMD_PARAM_FIELD,
  GVGFIREREPORTGUILDCMD_FIRETIME_FIELD,
  GVGFIREREPORTGUILDCMD_DATAS_FIELD,
  GVGFIREREPORTGUILDCMD_MYDATA_FIELD
}
GVGFIREREPORTGUILDCMD.is_extendable = false
GVGFIREREPORTGUILDCMD.extensions = {}
GUILDBUILDINGREWARD_TYPE_FIELD.name = "type"
GUILDBUILDINGREWARD_TYPE_FIELD.full_name = ".Cmd.GuildBuildingReward.type"
GUILDBUILDINGREWARD_TYPE_FIELD.number = 1
GUILDBUILDINGREWARD_TYPE_FIELD.index = 0
GUILDBUILDINGREWARD_TYPE_FIELD.label = 1
GUILDBUILDINGREWARD_TYPE_FIELD.has_default_value = false
GUILDBUILDINGREWARD_TYPE_FIELD.default_value = nil
GUILDBUILDINGREWARD_TYPE_FIELD.enum_type = EGUILDBUILDING
GUILDBUILDINGREWARD_TYPE_FIELD.type = 14
GUILDBUILDINGREWARD_TYPE_FIELD.cpp_type = 8
GUILDBUILDINGREWARD_LEVEL_FIELD.name = "level"
GUILDBUILDINGREWARD_LEVEL_FIELD.full_name = ".Cmd.GuildBuildingReward.level"
GUILDBUILDINGREWARD_LEVEL_FIELD.number = 2
GUILDBUILDINGREWARD_LEVEL_FIELD.index = 1
GUILDBUILDINGREWARD_LEVEL_FIELD.label = 1
GUILDBUILDINGREWARD_LEVEL_FIELD.has_default_value = false
GUILDBUILDINGREWARD_LEVEL_FIELD.default_value = 0
GUILDBUILDINGREWARD_LEVEL_FIELD.type = 13
GUILDBUILDINGREWARD_LEVEL_FIELD.cpp_type = 3
GUILDBUILDINGREWARD_REWARD_FIELD.name = "reward"
GUILDBUILDINGREWARD_REWARD_FIELD.full_name = ".Cmd.GuildBuildingReward.reward"
GUILDBUILDINGREWARD_REWARD_FIELD.number = 3
GUILDBUILDINGREWARD_REWARD_FIELD.index = 2
GUILDBUILDINGREWARD_REWARD_FIELD.label = 1
GUILDBUILDINGREWARD_REWARD_FIELD.has_default_value = false
GUILDBUILDINGREWARD_REWARD_FIELD.default_value = false
GUILDBUILDINGREWARD_REWARD_FIELD.type = 8
GUILDBUILDINGREWARD_REWARD_FIELD.cpp_type = 7
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.name = "refreshtime"
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.full_name = ".Cmd.GuildBuildingReward.refreshtime"
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.number = 4
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.index = 3
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.label = 1
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.has_default_value = false
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.default_value = 0
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.type = 13
GUILDBUILDINGREWARD_REFRESHTIME_FIELD.cpp_type = 3
GUILDBUILDINGREWARD.name = "GuildBuildingReward"
GUILDBUILDINGREWARD.full_name = ".Cmd.GuildBuildingReward"
GUILDBUILDINGREWARD.nested_types = {}
GUILDBUILDINGREWARD.enum_types = {}
GUILDBUILDINGREWARD.fields = {
  GUILDBUILDINGREWARD_TYPE_FIELD,
  GUILDBUILDINGREWARD_LEVEL_FIELD,
  GUILDBUILDINGREWARD_REWARD_FIELD,
  GUILDBUILDINGREWARD_REFRESHTIME_FIELD
}
GUILDBUILDINGREWARD.is_extendable = false
GUILDBUILDINGREWARD.extensions = {}
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.name = "cmd"
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.full_name = ".Cmd.BuildingUpdateNtfGuildCmd.cmd"
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.number = 1
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.index = 0
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.label = 1
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.has_default_value = true
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.default_value = 50
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.type = 14
BUILDINGUPDATENTFGUILDCMD_CMD_FIELD.cpp_type = 8
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.name = "param"
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.full_name = ".Cmd.BuildingUpdateNtfGuildCmd.param"
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.number = 2
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.index = 1
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.label = 1
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.has_default_value = true
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.default_value = 95
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.type = 14
BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD.cpp_type = 8
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.name = "updates"
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.full_name = ".Cmd.BuildingUpdateNtfGuildCmd.updates"
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.number = 3
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.index = 2
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.label = 3
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.has_default_value = false
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.default_value = {}
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.message_type = GUILDBUILDINGREWARD
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.type = 11
BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD.cpp_type = 10
BUILDINGUPDATENTFGUILDCMD.name = "BuildingUpdateNtfGuildCmd"
BUILDINGUPDATENTFGUILDCMD.full_name = ".Cmd.BuildingUpdateNtfGuildCmd"
BUILDINGUPDATENTFGUILDCMD.nested_types = {}
BUILDINGUPDATENTFGUILDCMD.enum_types = {}
BUILDINGUPDATENTFGUILDCMD.fields = {
  BUILDINGUPDATENTFGUILDCMD_CMD_FIELD,
  BUILDINGUPDATENTFGUILDCMD_PARAM_FIELD,
  BUILDINGUPDATENTFGUILDCMD_UPDATES_FIELD
}
BUILDINGUPDATENTFGUILDCMD.is_extendable = false
BUILDINGUPDATENTFGUILDCMD.extensions = {}
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.name = "cmd"
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.full_name = ".Cmd.GvgRoadblockModifyGuildCmd.cmd"
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.number = 1
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.index = 0
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.label = 1
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.has_default_value = true
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.default_value = 50
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.type = 14
GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD.cpp_type = 8
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.name = "param"
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.full_name = ".Cmd.GvgRoadblockModifyGuildCmd.param"
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.number = 2
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.index = 1
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.label = 1
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.has_default_value = true
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.default_value = 96
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.type = 14
GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD.cpp_type = 8
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.name = "roadblock"
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.full_name = ".Cmd.GvgRoadblockModifyGuildCmd.roadblock"
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.number = 3
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.index = 2
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.label = 1
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.has_default_value = false
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.default_value = 0
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.type = 13
GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD.cpp_type = 3
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.name = "ret"
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.full_name = ".Cmd.GvgRoadblockModifyGuildCmd.ret"
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.number = 4
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.index = 3
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.label = 1
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.has_default_value = false
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.default_value = false
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.type = 8
GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD.cpp_type = 7
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.name = "guildid"
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.full_name = ".Cmd.GvgRoadblockModifyGuildCmd.guildid"
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.number = 5
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.index = 4
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.label = 1
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.has_default_value = false
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.default_value = 0
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.type = 4
GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD.cpp_type = 4
GVGROADBLOCKMODIFYGUILDCMD.name = "GvgRoadblockModifyGuildCmd"
GVGROADBLOCKMODIFYGUILDCMD.full_name = ".Cmd.GvgRoadblockModifyGuildCmd"
GVGROADBLOCKMODIFYGUILDCMD.nested_types = {}
GVGROADBLOCKMODIFYGUILDCMD.enum_types = {}
GVGROADBLOCKMODIFYGUILDCMD.fields = {
  GVGROADBLOCKMODIFYGUILDCMD_CMD_FIELD,
  GVGROADBLOCKMODIFYGUILDCMD_PARAM_FIELD,
  GVGROADBLOCKMODIFYGUILDCMD_ROADBLOCK_FIELD,
  GVGROADBLOCKMODIFYGUILDCMD_RET_FIELD,
  GVGROADBLOCKMODIFYGUILDCMD_GUILDID_FIELD
}
GVGROADBLOCKMODIFYGUILDCMD.is_extendable = false
GVGROADBLOCKMODIFYGUILDCMD.extensions = {}
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.name = "cmd"
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.full_name = ".Cmd.GvgRoadblockQueryGuildCmd.cmd"
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.number = 1
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.index = 0
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.label = 1
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.has_default_value = true
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.default_value = 50
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.type = 14
GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD.cpp_type = 8
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.name = "param"
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.full_name = ".Cmd.GvgRoadblockQueryGuildCmd.param"
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.number = 2
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.index = 1
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.label = 1
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.has_default_value = true
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.default_value = 97
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.type = 14
GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD.cpp_type = 8
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.name = "roadblock"
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.full_name = ".Cmd.GvgRoadblockQueryGuildCmd.roadblock"
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.number = 3
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.index = 2
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.label = 1
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.has_default_value = false
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.default_value = 0
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.type = 13
GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD.cpp_type = 3
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.name = "guildid"
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.full_name = ".Cmd.GvgRoadblockQueryGuildCmd.guildid"
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.number = 4
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.index = 3
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.label = 1
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.has_default_value = false
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.default_value = 0
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.type = 4
GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD.cpp_type = 4
GVGROADBLOCKQUERYGUILDCMD.name = "GvgRoadblockQueryGuildCmd"
GVGROADBLOCKQUERYGUILDCMD.full_name = ".Cmd.GvgRoadblockQueryGuildCmd"
GVGROADBLOCKQUERYGUILDCMD.nested_types = {}
GVGROADBLOCKQUERYGUILDCMD.enum_types = {}
GVGROADBLOCKQUERYGUILDCMD.fields = {
  GVGROADBLOCKQUERYGUILDCMD_CMD_FIELD,
  GVGROADBLOCKQUERYGUILDCMD_PARAM_FIELD,
  GVGROADBLOCKQUERYGUILDCMD_ROADBLOCK_FIELD,
  GVGROADBLOCKQUERYGUILDCMD_GUILDID_FIELD
}
GVGROADBLOCKQUERYGUILDCMD.is_extendable = false
GVGROADBLOCKQUERYGUILDCMD.extensions = {}
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.name = "cmd"
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.full_name = ".Cmd.ExchangeGvgGroupGuildCmd.cmd"
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.number = 1
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.index = 0
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.label = 1
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.has_default_value = true
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.default_value = 50
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.type = 14
EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD.cpp_type = 8
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.name = "param"
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.full_name = ".Cmd.ExchangeGvgGroupGuildCmd.param"
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.number = 2
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.index = 1
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.label = 1
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.has_default_value = true
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.default_value = 98
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.type = 14
EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD.cpp_type = 8
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.name = "gvg_group"
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.full_name = ".Cmd.ExchangeGvgGroupGuildCmd.gvg_group"
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.number = 3
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.index = 2
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.label = 1
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.has_default_value = false
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.default_value = 0
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.type = 13
EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD.cpp_type = 3
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.name = "cancel"
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.full_name = ".Cmd.ExchangeGvgGroupGuildCmd.cancel"
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.number = 4
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.index = 3
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.label = 1
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.has_default_value = false
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.default_value = false
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.type = 8
EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD.cpp_type = 7
EXCHANGEGVGGROUPGUILDCMD.name = "ExchangeGvgGroupGuildCmd"
EXCHANGEGVGGROUPGUILDCMD.full_name = ".Cmd.ExchangeGvgGroupGuildCmd"
EXCHANGEGVGGROUPGUILDCMD.nested_types = {}
EXCHANGEGVGGROUPGUILDCMD.enum_types = {}
EXCHANGEGVGGROUPGUILDCMD.fields = {
  EXCHANGEGVGGROUPGUILDCMD_CMD_FIELD,
  EXCHANGEGVGGROUPGUILDCMD_PARAM_FIELD,
  EXCHANGEGVGGROUPGUILDCMD_GVG_GROUP_FIELD,
  EXCHANGEGVGGROUPGUILDCMD_CANCEL_FIELD
}
EXCHANGEGVGGROUPGUILDCMD.is_extendable = false
EXCHANGEGVGGROUPGUILDCMD.extensions = {}
GVGDATAQUERYGUILDCMD_CMD_FIELD.name = "cmd"
GVGDATAQUERYGUILDCMD_CMD_FIELD.full_name = ".Cmd.GvgDataQueryGuildCmd.cmd"
GVGDATAQUERYGUILDCMD_CMD_FIELD.number = 1
GVGDATAQUERYGUILDCMD_CMD_FIELD.index = 0
GVGDATAQUERYGUILDCMD_CMD_FIELD.label = 1
GVGDATAQUERYGUILDCMD_CMD_FIELD.has_default_value = true
GVGDATAQUERYGUILDCMD_CMD_FIELD.default_value = 50
GVGDATAQUERYGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
GVGDATAQUERYGUILDCMD_CMD_FIELD.type = 14
GVGDATAQUERYGUILDCMD_CMD_FIELD.cpp_type = 8
GVGDATAQUERYGUILDCMD_PARAM_FIELD.name = "param"
GVGDATAQUERYGUILDCMD_PARAM_FIELD.full_name = ".Cmd.GvgDataQueryGuildCmd.param"
GVGDATAQUERYGUILDCMD_PARAM_FIELD.number = 2
GVGDATAQUERYGUILDCMD_PARAM_FIELD.index = 1
GVGDATAQUERYGUILDCMD_PARAM_FIELD.label = 1
GVGDATAQUERYGUILDCMD_PARAM_FIELD.has_default_value = true
GVGDATAQUERYGUILDCMD_PARAM_FIELD.default_value = 112
GVGDATAQUERYGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
GVGDATAQUERYGUILDCMD_PARAM_FIELD.type = 14
GVGDATAQUERYGUILDCMD_PARAM_FIELD.cpp_type = 8
GVGDATAQUERYGUILDCMD.name = "GvgDataQueryGuildCmd"
GVGDATAQUERYGUILDCMD.full_name = ".Cmd.GvgDataQueryGuildCmd"
GVGDATAQUERYGUILDCMD.nested_types = {}
GVGDATAQUERYGUILDCMD.enum_types = {}
GVGDATAQUERYGUILDCMD.fields = {
  GVGDATAQUERYGUILDCMD_CMD_FIELD,
  GVGDATAQUERYGUILDCMD_PARAM_FIELD
}
GVGDATAQUERYGUILDCMD.is_extendable = false
GVGDATAQUERYGUILDCMD.extensions = {}
DATEBATTLEDATA_ID_FIELD.name = "id"
DATEBATTLEDATA_ID_FIELD.full_name = ".Cmd.DateBattleData.id"
DATEBATTLEDATA_ID_FIELD.number = 1
DATEBATTLEDATA_ID_FIELD.index = 0
DATEBATTLEDATA_ID_FIELD.label = 1
DATEBATTLEDATA_ID_FIELD.has_default_value = true
DATEBATTLEDATA_ID_FIELD.default_value = 0
DATEBATTLEDATA_ID_FIELD.type = 4
DATEBATTLEDATA_ID_FIELD.cpp_type = 4
DATEBATTLEDATA_ATK_GUILDID_FIELD.name = "atk_guildid"
DATEBATTLEDATA_ATK_GUILDID_FIELD.full_name = ".Cmd.DateBattleData.atk_guildid"
DATEBATTLEDATA_ATK_GUILDID_FIELD.number = 2
DATEBATTLEDATA_ATK_GUILDID_FIELD.index = 1
DATEBATTLEDATA_ATK_GUILDID_FIELD.label = 1
DATEBATTLEDATA_ATK_GUILDID_FIELD.has_default_value = false
DATEBATTLEDATA_ATK_GUILDID_FIELD.default_value = 0
DATEBATTLEDATA_ATK_GUILDID_FIELD.type = 4
DATEBATTLEDATA_ATK_GUILDID_FIELD.cpp_type = 4
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.name = "atk_guildname"
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.full_name = ".Cmd.DateBattleData.atk_guildname"
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.number = 3
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.index = 2
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.label = 1
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.has_default_value = false
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.default_value = ""
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.type = 9
DATEBATTLEDATA_ATK_GUILDNAME_FIELD.cpp_type = 9
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.name = "atk_guildportrait"
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.full_name = ".Cmd.DateBattleData.atk_guildportrait"
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.number = 4
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.index = 3
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.label = 1
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.has_default_value = false
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.default_value = ""
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.type = 9
DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD.cpp_type = 9
DATEBATTLEDATA_ATK_SERVERID_FIELD.name = "atk_serverid"
DATEBATTLEDATA_ATK_SERVERID_FIELD.full_name = ".Cmd.DateBattleData.atk_serverid"
DATEBATTLEDATA_ATK_SERVERID_FIELD.number = 5
DATEBATTLEDATA_ATK_SERVERID_FIELD.index = 4
DATEBATTLEDATA_ATK_SERVERID_FIELD.label = 1
DATEBATTLEDATA_ATK_SERVERID_FIELD.has_default_value = false
DATEBATTLEDATA_ATK_SERVERID_FIELD.default_value = 0
DATEBATTLEDATA_ATK_SERVERID_FIELD.type = 13
DATEBATTLEDATA_ATK_SERVERID_FIELD.cpp_type = 3
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.name = "atk_chairmanid"
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.full_name = ".Cmd.DateBattleData.atk_chairmanid"
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.number = 6
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.index = 5
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.label = 1
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.has_default_value = false
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.default_value = 0
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.type = 4
DATEBATTLEDATA_ATK_CHAIRMANID_FIELD.cpp_type = 4
DATEBATTLEDATA_DEF_GUILDID_FIELD.name = "def_guildid"
DATEBATTLEDATA_DEF_GUILDID_FIELD.full_name = ".Cmd.DateBattleData.def_guildid"
DATEBATTLEDATA_DEF_GUILDID_FIELD.number = 7
DATEBATTLEDATA_DEF_GUILDID_FIELD.index = 6
DATEBATTLEDATA_DEF_GUILDID_FIELD.label = 1
DATEBATTLEDATA_DEF_GUILDID_FIELD.has_default_value = false
DATEBATTLEDATA_DEF_GUILDID_FIELD.default_value = 0
DATEBATTLEDATA_DEF_GUILDID_FIELD.type = 4
DATEBATTLEDATA_DEF_GUILDID_FIELD.cpp_type = 4
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.name = "def_guildname"
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.full_name = ".Cmd.DateBattleData.def_guildname"
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.number = 8
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.index = 7
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.label = 1
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.has_default_value = false
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.default_value = ""
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.type = 9
DATEBATTLEDATA_DEF_GUILDNAME_FIELD.cpp_type = 9
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.name = "def_guildportrait"
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.full_name = ".Cmd.DateBattleData.def_guildportrait"
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.number = 9
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.index = 8
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.label = 1
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.has_default_value = false
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.default_value = ""
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.type = 9
DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD.cpp_type = 9
DATEBATTLEDATA_DEF_SERVERID_FIELD.name = "def_serverid"
DATEBATTLEDATA_DEF_SERVERID_FIELD.full_name = ".Cmd.DateBattleData.def_serverid"
DATEBATTLEDATA_DEF_SERVERID_FIELD.number = 10
DATEBATTLEDATA_DEF_SERVERID_FIELD.index = 9
DATEBATTLEDATA_DEF_SERVERID_FIELD.label = 1
DATEBATTLEDATA_DEF_SERVERID_FIELD.has_default_value = false
DATEBATTLEDATA_DEF_SERVERID_FIELD.default_value = 0
DATEBATTLEDATA_DEF_SERVERID_FIELD.type = 13
DATEBATTLEDATA_DEF_SERVERID_FIELD.cpp_type = 3
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.name = "def_chairmanid"
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.full_name = ".Cmd.DateBattleData.def_chairmanid"
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.number = 11
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.index = 10
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.label = 1
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.has_default_value = false
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.default_value = 0
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.type = 4
DATEBATTLEDATA_DEF_CHAIRMANID_FIELD.cpp_type = 4
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.name = "battle_starttime"
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.full_name = ".Cmd.DateBattleData.battle_starttime"
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.number = 12
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.index = 11
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.label = 1
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.has_default_value = false
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.default_value = 0
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.type = 13
DATEBATTLEDATA_BATTLE_STARTTIME_FIELD.cpp_type = 3
DATEBATTLEDATA_INVITE_TIME_FIELD.name = "invite_time"
DATEBATTLEDATA_INVITE_TIME_FIELD.full_name = ".Cmd.DateBattleData.invite_time"
DATEBATTLEDATA_INVITE_TIME_FIELD.number = 13
DATEBATTLEDATA_INVITE_TIME_FIELD.index = 12
DATEBATTLEDATA_INVITE_TIME_FIELD.label = 1
DATEBATTLEDATA_INVITE_TIME_FIELD.has_default_value = false
DATEBATTLEDATA_INVITE_TIME_FIELD.default_value = 0
DATEBATTLEDATA_INVITE_TIME_FIELD.type = 13
DATEBATTLEDATA_INVITE_TIME_FIELD.cpp_type = 3
DATEBATTLEDATA_MODE_FIELD.name = "mode"
DATEBATTLEDATA_MODE_FIELD.full_name = ".Cmd.DateBattleData.mode"
DATEBATTLEDATA_MODE_FIELD.number = 14
DATEBATTLEDATA_MODE_FIELD.index = 13
DATEBATTLEDATA_MODE_FIELD.label = 1
DATEBATTLEDATA_MODE_FIELD.has_default_value = false
DATEBATTLEDATA_MODE_FIELD.default_value = nil
DATEBATTLEDATA_MODE_FIELD.enum_type = EGUILDDATEBATTLEMODE
DATEBATTLEDATA_MODE_FIELD.type = 14
DATEBATTLEDATA_MODE_FIELD.cpp_type = 8
DATEBATTLEDATA_STATE_FIELD.name = "state"
DATEBATTLEDATA_STATE_FIELD.full_name = ".Cmd.DateBattleData.state"
DATEBATTLEDATA_STATE_FIELD.number = 15
DATEBATTLEDATA_STATE_FIELD.index = 14
DATEBATTLEDATA_STATE_FIELD.label = 1
DATEBATTLEDATA_STATE_FIELD.has_default_value = false
DATEBATTLEDATA_STATE_FIELD.default_value = nil
DATEBATTLEDATA_STATE_FIELD.enum_type = EGUILDDATEBATTLESTATE
DATEBATTLEDATA_STATE_FIELD.type = 14
DATEBATTLEDATA_STATE_FIELD.cpp_type = 8
DATEBATTLEDATA_WINNER_GUILDID_FIELD.name = "winner_guildid"
DATEBATTLEDATA_WINNER_GUILDID_FIELD.full_name = ".Cmd.DateBattleData.winner_guildid"
DATEBATTLEDATA_WINNER_GUILDID_FIELD.number = 16
DATEBATTLEDATA_WINNER_GUILDID_FIELD.index = 15
DATEBATTLEDATA_WINNER_GUILDID_FIELD.label = 1
DATEBATTLEDATA_WINNER_GUILDID_FIELD.has_default_value = false
DATEBATTLEDATA_WINNER_GUILDID_FIELD.default_value = 0
DATEBATTLEDATA_WINNER_GUILDID_FIELD.type = 4
DATEBATTLEDATA_WINNER_GUILDID_FIELD.cpp_type = 4
DATEBATTLEDATA.name = "DateBattleData"
DATEBATTLEDATA.full_name = ".Cmd.DateBattleData"
DATEBATTLEDATA.nested_types = {}
DATEBATTLEDATA.enum_types = {}
DATEBATTLEDATA.fields = {
  DATEBATTLEDATA_ID_FIELD,
  DATEBATTLEDATA_ATK_GUILDID_FIELD,
  DATEBATTLEDATA_ATK_GUILDNAME_FIELD,
  DATEBATTLEDATA_ATK_GUILDPORTRAIT_FIELD,
  DATEBATTLEDATA_ATK_SERVERID_FIELD,
  DATEBATTLEDATA_ATK_CHAIRMANID_FIELD,
  DATEBATTLEDATA_DEF_GUILDID_FIELD,
  DATEBATTLEDATA_DEF_GUILDNAME_FIELD,
  DATEBATTLEDATA_DEF_GUILDPORTRAIT_FIELD,
  DATEBATTLEDATA_DEF_SERVERID_FIELD,
  DATEBATTLEDATA_DEF_CHAIRMANID_FIELD,
  DATEBATTLEDATA_BATTLE_STARTTIME_FIELD,
  DATEBATTLEDATA_INVITE_TIME_FIELD,
  DATEBATTLEDATA_MODE_FIELD,
  DATEBATTLEDATA_STATE_FIELD,
  DATEBATTLEDATA_WINNER_GUILDID_FIELD
}
DATEBATTLEDATA.is_extendable = false
DATEBATTLEDATA.extensions = {}
DATEBATTLEINFOGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEINFOGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleInfoGuildCmd.cmd"
DATEBATTLEINFOGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEINFOGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEINFOGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEINFOGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEINFOGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEINFOGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEINFOGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEINFOGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleInfoGuildCmd.param"
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.default_value = 99
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEINFOGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEINFOGUILDCMD_ID_FIELD.name = "id"
DATEBATTLEINFOGUILDCMD_ID_FIELD.full_name = ".Cmd.DateBattleInfoGuildCmd.id"
DATEBATTLEINFOGUILDCMD_ID_FIELD.number = 3
DATEBATTLEINFOGUILDCMD_ID_FIELD.index = 2
DATEBATTLEINFOGUILDCMD_ID_FIELD.label = 1
DATEBATTLEINFOGUILDCMD_ID_FIELD.has_default_value = false
DATEBATTLEINFOGUILDCMD_ID_FIELD.default_value = 0
DATEBATTLEINFOGUILDCMD_ID_FIELD.type = 4
DATEBATTLEINFOGUILDCMD_ID_FIELD.cpp_type = 4
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.name = "datas"
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.full_name = ".Cmd.DateBattleInfoGuildCmd.datas"
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.number = 4
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.index = 3
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.label = 3
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.has_default_value = false
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.default_value = {}
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.message_type = DATEBATTLEDATA
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.type = 11
DATEBATTLEINFOGUILDCMD_DATAS_FIELD.cpp_type = 10
DATEBATTLEINFOGUILDCMD.name = "DateBattleInfoGuildCmd"
DATEBATTLEINFOGUILDCMD.full_name = ".Cmd.DateBattleInfoGuildCmd"
DATEBATTLEINFOGUILDCMD.nested_types = {}
DATEBATTLEINFOGUILDCMD.enum_types = {}
DATEBATTLEINFOGUILDCMD.fields = {
  DATEBATTLEINFOGUILDCMD_CMD_FIELD,
  DATEBATTLEINFOGUILDCMD_PARAM_FIELD,
  DATEBATTLEINFOGUILDCMD_ID_FIELD,
  DATEBATTLEINFOGUILDCMD_DATAS_FIELD
}
DATEBATTLEINFOGUILDCMD.is_extendable = false
DATEBATTLEINFOGUILDCMD.extensions = {}
DATEBATTLETARGETGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLETARGETGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleTargetGuildCmd.cmd"
DATEBATTLETARGETGUILDCMD_CMD_FIELD.number = 1
DATEBATTLETARGETGUILDCMD_CMD_FIELD.index = 0
DATEBATTLETARGETGUILDCMD_CMD_FIELD.label = 1
DATEBATTLETARGETGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLETARGETGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLETARGETGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLETARGETGUILDCMD_CMD_FIELD.type = 14
DATEBATTLETARGETGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleTargetGuildCmd.param"
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.default_value = 100
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLETARGETGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.name = "guildid"
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.full_name = ".Cmd.DateBattleTargetGuildCmd.guildid"
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.number = 3
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.index = 2
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.label = 1
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.has_default_value = false
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.default_value = 0
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.type = 4
DATEBATTLETARGETGUILDCMD_GUILDID_FIELD.cpp_type = 4
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.name = "datas"
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.full_name = ".Cmd.DateBattleTargetGuildCmd.datas"
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.number = 4
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.index = 3
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.label = 3
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.has_default_value = false
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.default_value = {}
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.message_type = DATEBATTLEDATA
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.type = 11
DATEBATTLETARGETGUILDCMD_DATAS_FIELD.cpp_type = 10
DATEBATTLETARGETGUILDCMD.name = "DateBattleTargetGuildCmd"
DATEBATTLETARGETGUILDCMD.full_name = ".Cmd.DateBattleTargetGuildCmd"
DATEBATTLETARGETGUILDCMD.nested_types = {}
DATEBATTLETARGETGUILDCMD.enum_types = {}
DATEBATTLETARGETGUILDCMD.fields = {
  DATEBATTLETARGETGUILDCMD_CMD_FIELD,
  DATEBATTLETARGETGUILDCMD_PARAM_FIELD,
  DATEBATTLETARGETGUILDCMD_GUILDID_FIELD,
  DATEBATTLETARGETGUILDCMD_DATAS_FIELD
}
DATEBATTLETARGETGUILDCMD.is_extendable = false
DATEBATTLETARGETGUILDCMD.extensions = {}
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleInviteGuildCmd.cmd"
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEINVITEGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleInviteGuildCmd.param"
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.default_value = 101
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEINVITEGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.name = "guildid"
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.full_name = ".Cmd.DateBattleInviteGuildCmd.guildid"
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.number = 3
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.index = 2
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.label = 1
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.has_default_value = false
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.default_value = 0
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.type = 4
DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD.cpp_type = 4
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.name = "starttime"
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.full_name = ".Cmd.DateBattleInviteGuildCmd.starttime"
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.number = 4
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.index = 3
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.label = 1
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.has_default_value = false
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.default_value = 0
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.type = 13
DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD.cpp_type = 3
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.name = "mode"
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.full_name = ".Cmd.DateBattleInviteGuildCmd.mode"
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.number = 5
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.index = 4
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.label = 1
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.has_default_value = false
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.default_value = nil
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.enum_type = EGUILDDATEBATTLEMODE
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.type = 14
DATEBATTLEINVITEGUILDCMD_MODE_FIELD.cpp_type = 8
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.name = "datas"
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.full_name = ".Cmd.DateBattleInviteGuildCmd.datas"
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.number = 6
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.index = 5
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.label = 3
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.has_default_value = false
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.default_value = {}
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.message_type = DATEBATTLEDATA
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.type = 11
DATEBATTLEINVITEGUILDCMD_DATAS_FIELD.cpp_type = 10
DATEBATTLEINVITEGUILDCMD.name = "DateBattleInviteGuildCmd"
DATEBATTLEINVITEGUILDCMD.full_name = ".Cmd.DateBattleInviteGuildCmd"
DATEBATTLEINVITEGUILDCMD.nested_types = {}
DATEBATTLEINVITEGUILDCMD.enum_types = {}
DATEBATTLEINVITEGUILDCMD.fields = {
  DATEBATTLEINVITEGUILDCMD_CMD_FIELD,
  DATEBATTLEINVITEGUILDCMD_PARAM_FIELD,
  DATEBATTLEINVITEGUILDCMD_GUILDID_FIELD,
  DATEBATTLEINVITEGUILDCMD_STARTTIME_FIELD,
  DATEBATTLEINVITEGUILDCMD_MODE_FIELD,
  DATEBATTLEINVITEGUILDCMD_DATAS_FIELD
}
DATEBATTLEINVITEGUILDCMD.is_extendable = false
DATEBATTLEINVITEGUILDCMD.extensions = {}
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleReplyGuildCmd.cmd"
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEREPLYGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleReplyGuildCmd.param"
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.default_value = 102
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEREPLYGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEREPLYGUILDCMD_ID_FIELD.name = "id"
DATEBATTLEREPLYGUILDCMD_ID_FIELD.full_name = ".Cmd.DateBattleReplyGuildCmd.id"
DATEBATTLEREPLYGUILDCMD_ID_FIELD.number = 3
DATEBATTLEREPLYGUILDCMD_ID_FIELD.index = 2
DATEBATTLEREPLYGUILDCMD_ID_FIELD.label = 1
DATEBATTLEREPLYGUILDCMD_ID_FIELD.has_default_value = false
DATEBATTLEREPLYGUILDCMD_ID_FIELD.default_value = 0
DATEBATTLEREPLYGUILDCMD_ID_FIELD.type = 4
DATEBATTLEREPLYGUILDCMD_ID_FIELD.cpp_type = 4
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.name = "isagree"
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.full_name = ".Cmd.DateBattleReplyGuildCmd.isagree"
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.number = 4
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.index = 3
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.label = 1
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.has_default_value = false
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.default_value = false
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.type = 8
DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD.cpp_type = 7
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.name = "datas"
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.full_name = ".Cmd.DateBattleReplyGuildCmd.datas"
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.number = 5
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.index = 4
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.label = 3
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.has_default_value = false
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.default_value = {}
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.message_type = DATEBATTLEDATA
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.type = 11
DATEBATTLEREPLYGUILDCMD_DATAS_FIELD.cpp_type = 10
DATEBATTLEREPLYGUILDCMD.name = "DateBattleReplyGuildCmd"
DATEBATTLEREPLYGUILDCMD.full_name = ".Cmd.DateBattleReplyGuildCmd"
DATEBATTLEREPLYGUILDCMD.nested_types = {}
DATEBATTLEREPLYGUILDCMD.enum_types = {}
DATEBATTLEREPLYGUILDCMD.fields = {
  DATEBATTLEREPLYGUILDCMD_CMD_FIELD,
  DATEBATTLEREPLYGUILDCMD_PARAM_FIELD,
  DATEBATTLEREPLYGUILDCMD_ID_FIELD,
  DATEBATTLEREPLYGUILDCMD_ISAGREE_FIELD,
  DATEBATTLEREPLYGUILDCMD_DATAS_FIELD
}
DATEBATTLEREPLYGUILDCMD.is_extendable = false
DATEBATTLEREPLYGUILDCMD.extensions = {}
DATEBATTLEOPENGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEOPENGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleOpenGuildCmd.cmd"
DATEBATTLEOPENGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEOPENGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEOPENGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEOPENGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEOPENGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEOPENGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEOPENGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEOPENGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleOpenGuildCmd.param"
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.default_value = 103
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEOPENGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEOPENGUILDCMD_STATE_FIELD.name = "state"
DATEBATTLEOPENGUILDCMD_STATE_FIELD.full_name = ".Cmd.DateBattleOpenGuildCmd.state"
DATEBATTLEOPENGUILDCMD_STATE_FIELD.number = 3
DATEBATTLEOPENGUILDCMD_STATE_FIELD.index = 2
DATEBATTLEOPENGUILDCMD_STATE_FIELD.label = 1
DATEBATTLEOPENGUILDCMD_STATE_FIELD.has_default_value = false
DATEBATTLEOPENGUILDCMD_STATE_FIELD.default_value = nil
DATEBATTLEOPENGUILDCMD_STATE_FIELD.enum_type = EDATEBATTLEOPENSTATE
DATEBATTLEOPENGUILDCMD_STATE_FIELD.type = 14
DATEBATTLEOPENGUILDCMD_STATE_FIELD.cpp_type = 8
DATEBATTLEOPENGUILDCMD_DATA_FIELD.name = "data"
DATEBATTLEOPENGUILDCMD_DATA_FIELD.full_name = ".Cmd.DateBattleOpenGuildCmd.data"
DATEBATTLEOPENGUILDCMD_DATA_FIELD.number = 4
DATEBATTLEOPENGUILDCMD_DATA_FIELD.index = 3
DATEBATTLEOPENGUILDCMD_DATA_FIELD.label = 1
DATEBATTLEOPENGUILDCMD_DATA_FIELD.has_default_value = false
DATEBATTLEOPENGUILDCMD_DATA_FIELD.default_value = nil
DATEBATTLEOPENGUILDCMD_DATA_FIELD.message_type = DATEBATTLEDATA
DATEBATTLEOPENGUILDCMD_DATA_FIELD.type = 11
DATEBATTLEOPENGUILDCMD_DATA_FIELD.cpp_type = 10
DATEBATTLEOPENGUILDCMD.name = "DateBattleOpenGuildCmd"
DATEBATTLEOPENGUILDCMD.full_name = ".Cmd.DateBattleOpenGuildCmd"
DATEBATTLEOPENGUILDCMD.nested_types = {}
DATEBATTLEOPENGUILDCMD.enum_types = {}
DATEBATTLEOPENGUILDCMD.fields = {
  DATEBATTLEOPENGUILDCMD_CMD_FIELD,
  DATEBATTLEOPENGUILDCMD_PARAM_FIELD,
  DATEBATTLEOPENGUILDCMD_STATE_FIELD,
  DATEBATTLEOPENGUILDCMD_DATA_FIELD
}
DATEBATTLEOPENGUILDCMD.is_extendable = false
DATEBATTLEOPENGUILDCMD.extensions = {}
DATEBATTLEENTERGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEENTERGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleEnterGuildCmd.cmd"
DATEBATTLEENTERGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEENTERGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEENTERGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEENTERGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEENTERGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEENTERGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEENTERGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEENTERGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleEnterGuildCmd.param"
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.default_value = 104
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEENTERGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEENTERGUILDCMD_ID_FIELD.name = "id"
DATEBATTLEENTERGUILDCMD_ID_FIELD.full_name = ".Cmd.DateBattleEnterGuildCmd.id"
DATEBATTLEENTERGUILDCMD_ID_FIELD.number = 3
DATEBATTLEENTERGUILDCMD_ID_FIELD.index = 2
DATEBATTLEENTERGUILDCMD_ID_FIELD.label = 1
DATEBATTLEENTERGUILDCMD_ID_FIELD.has_default_value = false
DATEBATTLEENTERGUILDCMD_ID_FIELD.default_value = 0
DATEBATTLEENTERGUILDCMD_ID_FIELD.type = 4
DATEBATTLEENTERGUILDCMD_ID_FIELD.cpp_type = 4
DATEBATTLEENTERGUILDCMD.name = "DateBattleEnterGuildCmd"
DATEBATTLEENTERGUILDCMD.full_name = ".Cmd.DateBattleEnterGuildCmd"
DATEBATTLEENTERGUILDCMD.nested_types = {}
DATEBATTLEENTERGUILDCMD.enum_types = {}
DATEBATTLEENTERGUILDCMD.fields = {
  DATEBATTLEENTERGUILDCMD_CMD_FIELD,
  DATEBATTLEENTERGUILDCMD_PARAM_FIELD,
  DATEBATTLEENTERGUILDCMD_ID_FIELD
}
DATEBATTLEENTERGUILDCMD.is_extendable = false
DATEBATTLEENTERGUILDCMD.extensions = {}
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.cmd"
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEREPORTGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.param"
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.default_value = 105
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEREPORTGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.name = "atk_member_count"
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.atk_member_count"
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.number = 3
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.index = 2
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.has_default_value = false
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.default_value = 0
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.type = 13
DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD.cpp_type = 3
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.name = "def_member_count"
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.def_member_count"
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.number = 4
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.index = 3
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.has_default_value = false
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.default_value = 0
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.type = 13
DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD.cpp_type = 3
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.name = "boss_hp"
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.boss_hp"
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.number = 5
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.index = 4
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.has_default_value = false
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.default_value = 0
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.type = 13
DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD.cpp_type = 3
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.name = "perfect_time"
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.full_name = ".Cmd.DateBattleReportGuildCmd.perfect_time"
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.number = 6
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.index = 5
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.label = 1
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.has_default_value = false
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.default_value = nil
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.message_type = ProtoCommon_pb.GVGPERFECTTIMEINFO
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.type = 11
DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD.cpp_type = 10
DATEBATTLEREPORTGUILDCMD.name = "DateBattleReportGuildCmd"
DATEBATTLEREPORTGUILDCMD.full_name = ".Cmd.DateBattleReportGuildCmd"
DATEBATTLEREPORTGUILDCMD.nested_types = {}
DATEBATTLEREPORTGUILDCMD.enum_types = {}
DATEBATTLEREPORTGUILDCMD.fields = {
  DATEBATTLEREPORTGUILDCMD_CMD_FIELD,
  DATEBATTLEREPORTGUILDCMD_PARAM_FIELD,
  DATEBATTLEREPORTGUILDCMD_ATK_MEMBER_COUNT_FIELD,
  DATEBATTLEREPORTGUILDCMD_DEF_MEMBER_COUNT_FIELD,
  DATEBATTLEREPORTGUILDCMD_BOSS_HP_FIELD,
  DATEBATTLEREPORTGUILDCMD_PERFECT_TIME_FIELD
}
DATEBATTLEREPORTGUILDCMD.is_extendable = false
DATEBATTLEREPORTGUILDCMD.extensions = {}
DATEBATTLEREPORT_GUILDID_FIELD.name = "guildid"
DATEBATTLEREPORT_GUILDID_FIELD.full_name = ".Cmd.DateBattleReport.guildid"
DATEBATTLEREPORT_GUILDID_FIELD.number = 1
DATEBATTLEREPORT_GUILDID_FIELD.index = 0
DATEBATTLEREPORT_GUILDID_FIELD.label = 1
DATEBATTLEREPORT_GUILDID_FIELD.has_default_value = false
DATEBATTLEREPORT_GUILDID_FIELD.default_value = 0
DATEBATTLEREPORT_GUILDID_FIELD.type = 4
DATEBATTLEREPORT_GUILDID_FIELD.cpp_type = 4
DATEBATTLEREPORT_DATAS_FIELD.name = "datas"
DATEBATTLEREPORT_DATAS_FIELD.full_name = ".Cmd.DateBattleReport.datas"
DATEBATTLEREPORT_DATAS_FIELD.number = 2
DATEBATTLEREPORT_DATAS_FIELD.index = 1
DATEBATTLEREPORT_DATAS_FIELD.label = 3
DATEBATTLEREPORT_DATAS_FIELD.has_default_value = false
DATEBATTLEREPORT_DATAS_FIELD.default_value = {}
DATEBATTLEREPORT_DATAS_FIELD.message_type = GVGUSERFIREDATA
DATEBATTLEREPORT_DATAS_FIELD.type = 11
DATEBATTLEREPORT_DATAS_FIELD.cpp_type = 10
DATEBATTLEREPORT.name = "DateBattleReport"
DATEBATTLEREPORT.full_name = ".Cmd.DateBattleReport"
DATEBATTLEREPORT.nested_types = {}
DATEBATTLEREPORT.enum_types = {}
DATEBATTLEREPORT.fields = {
  DATEBATTLEREPORT_GUILDID_FIELD,
  DATEBATTLEREPORT_DATAS_FIELD
}
DATEBATTLEREPORT.is_extendable = false
DATEBATTLEREPORT.extensions = {}
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleDetailGuildCmd.cmd"
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEDETAILGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleDetailGuildCmd.param"
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.default_value = 106
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEDETAILGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.name = "reports"
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.full_name = ".Cmd.DateBattleDetailGuildCmd.reports"
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.number = 3
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.index = 2
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.label = 3
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.has_default_value = false
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.default_value = {}
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.message_type = DATEBATTLEREPORT
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.type = 11
DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD.cpp_type = 10
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.name = "isover"
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.full_name = ".Cmd.DateBattleDetailGuildCmd.isover"
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.number = 4
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.index = 3
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.label = 1
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.has_default_value = true
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.default_value = false
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.type = 8
DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD.cpp_type = 7
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.name = "winner_guildid"
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.full_name = ".Cmd.DateBattleDetailGuildCmd.winner_guildid"
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.number = 5
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.index = 4
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.label = 1
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.has_default_value = false
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.default_value = 0
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.type = 4
DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD.cpp_type = 4
DATEBATTLEDETAILGUILDCMD.name = "DateBattleDetailGuildCmd"
DATEBATTLEDETAILGUILDCMD.full_name = ".Cmd.DateBattleDetailGuildCmd"
DATEBATTLEDETAILGUILDCMD.nested_types = {}
DATEBATTLEDETAILGUILDCMD.enum_types = {}
DATEBATTLEDETAILGUILDCMD.fields = {
  DATEBATTLEDETAILGUILDCMD_CMD_FIELD,
  DATEBATTLEDETAILGUILDCMD_PARAM_FIELD,
  DATEBATTLEDETAILGUILDCMD_REPORTS_FIELD,
  DATEBATTLEDETAILGUILDCMD_ISOVER_FIELD,
  DATEBATTLEDETAILGUILDCMD_WINNER_GUILDID_FIELD
}
DATEBATTLEDETAILGUILDCMD.is_extendable = false
DATEBATTLEDETAILGUILDCMD.extensions = {}
DATEBATTLELISTGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLELISTGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleListGuildCmd.cmd"
DATEBATTLELISTGUILDCMD_CMD_FIELD.number = 1
DATEBATTLELISTGUILDCMD_CMD_FIELD.index = 0
DATEBATTLELISTGUILDCMD_CMD_FIELD.label = 1
DATEBATTLELISTGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLELISTGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLELISTGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLELISTGUILDCMD_CMD_FIELD.type = 14
DATEBATTLELISTGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLELISTGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLELISTGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleListGuildCmd.param"
DATEBATTLELISTGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLELISTGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLELISTGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLELISTGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLELISTGUILDCMD_PARAM_FIELD.default_value = 107
DATEBATTLELISTGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLELISTGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLELISTGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLELISTGUILDCMD_TYPE_FIELD.name = "type"
DATEBATTLELISTGUILDCMD_TYPE_FIELD.full_name = ".Cmd.DateBattleListGuildCmd.type"
DATEBATTLELISTGUILDCMD_TYPE_FIELD.number = 3
DATEBATTLELISTGUILDCMD_TYPE_FIELD.index = 2
DATEBATTLELISTGUILDCMD_TYPE_FIELD.label = 1
DATEBATTLELISTGUILDCMD_TYPE_FIELD.has_default_value = false
DATEBATTLELISTGUILDCMD_TYPE_FIELD.default_value = nil
DATEBATTLELISTGUILDCMD_TYPE_FIELD.enum_type = EGUILDDATEBATTLELISTTYPE
DATEBATTLELISTGUILDCMD_TYPE_FIELD.type = 14
DATEBATTLELISTGUILDCMD_TYPE_FIELD.cpp_type = 8
DATEBATTLELISTGUILDCMD_DATAS_FIELD.name = "datas"
DATEBATTLELISTGUILDCMD_DATAS_FIELD.full_name = ".Cmd.DateBattleListGuildCmd.datas"
DATEBATTLELISTGUILDCMD_DATAS_FIELD.number = 4
DATEBATTLELISTGUILDCMD_DATAS_FIELD.index = 3
DATEBATTLELISTGUILDCMD_DATAS_FIELD.label = 3
DATEBATTLELISTGUILDCMD_DATAS_FIELD.has_default_value = false
DATEBATTLELISTGUILDCMD_DATAS_FIELD.default_value = {}
DATEBATTLELISTGUILDCMD_DATAS_FIELD.message_type = DATEBATTLEDATA
DATEBATTLELISTGUILDCMD_DATAS_FIELD.type = 11
DATEBATTLELISTGUILDCMD_DATAS_FIELD.cpp_type = 10
DATEBATTLELISTGUILDCMD.name = "DateBattleListGuildCmd"
DATEBATTLELISTGUILDCMD.full_name = ".Cmd.DateBattleListGuildCmd"
DATEBATTLELISTGUILDCMD.nested_types = {}
DATEBATTLELISTGUILDCMD.enum_types = {}
DATEBATTLELISTGUILDCMD.fields = {
  DATEBATTLELISTGUILDCMD_CMD_FIELD,
  DATEBATTLELISTGUILDCMD_PARAM_FIELD,
  DATEBATTLELISTGUILDCMD_TYPE_FIELD,
  DATEBATTLELISTGUILDCMD_DATAS_FIELD
}
DATEBATTLELISTGUILDCMD.is_extendable = false
DATEBATTLELISTGUILDCMD.extensions = {}
DATEBATTLERANKINFO_GUILDID_FIELD.name = "guildid"
DATEBATTLERANKINFO_GUILDID_FIELD.full_name = ".Cmd.DateBattleRankInfo.guildid"
DATEBATTLERANKINFO_GUILDID_FIELD.number = 1
DATEBATTLERANKINFO_GUILDID_FIELD.index = 0
DATEBATTLERANKINFO_GUILDID_FIELD.label = 1
DATEBATTLERANKINFO_GUILDID_FIELD.has_default_value = false
DATEBATTLERANKINFO_GUILDID_FIELD.default_value = 0
DATEBATTLERANKINFO_GUILDID_FIELD.type = 4
DATEBATTLERANKINFO_GUILDID_FIELD.cpp_type = 4
DATEBATTLERANKINFO_GUILDNAME_FIELD.name = "guildname"
DATEBATTLERANKINFO_GUILDNAME_FIELD.full_name = ".Cmd.DateBattleRankInfo.guildname"
DATEBATTLERANKINFO_GUILDNAME_FIELD.number = 2
DATEBATTLERANKINFO_GUILDNAME_FIELD.index = 1
DATEBATTLERANKINFO_GUILDNAME_FIELD.label = 1
DATEBATTLERANKINFO_GUILDNAME_FIELD.has_default_value = false
DATEBATTLERANKINFO_GUILDNAME_FIELD.default_value = ""
DATEBATTLERANKINFO_GUILDNAME_FIELD.type = 9
DATEBATTLERANKINFO_GUILDNAME_FIELD.cpp_type = 9
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.name = "guildportrait"
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.full_name = ".Cmd.DateBattleRankInfo.guildportrait"
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.number = 3
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.index = 2
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.label = 1
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.has_default_value = false
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.default_value = ""
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.type = 9
DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD.cpp_type = 9
DATEBATTLERANKINFO_SERVERID_FIELD.name = "serverid"
DATEBATTLERANKINFO_SERVERID_FIELD.full_name = ".Cmd.DateBattleRankInfo.serverid"
DATEBATTLERANKINFO_SERVERID_FIELD.number = 4
DATEBATTLERANKINFO_SERVERID_FIELD.index = 3
DATEBATTLERANKINFO_SERVERID_FIELD.label = 1
DATEBATTLERANKINFO_SERVERID_FIELD.has_default_value = false
DATEBATTLERANKINFO_SERVERID_FIELD.default_value = 0
DATEBATTLERANKINFO_SERVERID_FIELD.type = 13
DATEBATTLERANKINFO_SERVERID_FIELD.cpp_type = 3
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.name = "chairmanname"
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.full_name = ".Cmd.DateBattleRankInfo.chairmanname"
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.number = 5
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.index = 4
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.label = 1
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.has_default_value = false
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.default_value = ""
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.type = 9
DATEBATTLERANKINFO_CHAIRMANNAME_FIELD.cpp_type = 9
DATEBATTLERANKINFO_WINTIMES_FIELD.name = "wintimes"
DATEBATTLERANKINFO_WINTIMES_FIELD.full_name = ".Cmd.DateBattleRankInfo.wintimes"
DATEBATTLERANKINFO_WINTIMES_FIELD.number = 6
DATEBATTLERANKINFO_WINTIMES_FIELD.index = 5
DATEBATTLERANKINFO_WINTIMES_FIELD.label = 1
DATEBATTLERANKINFO_WINTIMES_FIELD.has_default_value = false
DATEBATTLERANKINFO_WINTIMES_FIELD.default_value = 0
DATEBATTLERANKINFO_WINTIMES_FIELD.type = 13
DATEBATTLERANKINFO_WINTIMES_FIELD.cpp_type = 3
DATEBATTLERANKINFO.name = "DateBattleRankInfo"
DATEBATTLERANKINFO.full_name = ".Cmd.DateBattleRankInfo"
DATEBATTLERANKINFO.nested_types = {}
DATEBATTLERANKINFO.enum_types = {}
DATEBATTLERANKINFO.fields = {
  DATEBATTLERANKINFO_GUILDID_FIELD,
  DATEBATTLERANKINFO_GUILDNAME_FIELD,
  DATEBATTLERANKINFO_GUILDPORTRAIT_FIELD,
  DATEBATTLERANKINFO_SERVERID_FIELD,
  DATEBATTLERANKINFO_CHAIRMANNAME_FIELD,
  DATEBATTLERANKINFO_WINTIMES_FIELD
}
DATEBATTLERANKINFO.is_extendable = false
DATEBATTLERANKINFO.extensions = {}
DATEBATTLERANKGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLERANKGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleRankGuildCmd.cmd"
DATEBATTLERANKGUILDCMD_CMD_FIELD.number = 1
DATEBATTLERANKGUILDCMD_CMD_FIELD.index = 0
DATEBATTLERANKGUILDCMD_CMD_FIELD.label = 1
DATEBATTLERANKGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLERANKGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLERANKGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLERANKGUILDCMD_CMD_FIELD.type = 14
DATEBATTLERANKGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLERANKGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLERANKGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleRankGuildCmd.param"
DATEBATTLERANKGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLERANKGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLERANKGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLERANKGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLERANKGUILDCMD_PARAM_FIELD.default_value = 108
DATEBATTLERANKGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLERANKGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLERANKGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.name = "mydata"
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.full_name = ".Cmd.DateBattleRankGuildCmd.mydata"
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.number = 3
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.index = 2
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.label = 1
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.has_default_value = false
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.default_value = nil
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.message_type = DATEBATTLERANKINFO
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.type = 11
DATEBATTLERANKGUILDCMD_MYDATA_FIELD.cpp_type = 10
DATEBATTLERANKGUILDCMD_DATAS_FIELD.name = "datas"
DATEBATTLERANKGUILDCMD_DATAS_FIELD.full_name = ".Cmd.DateBattleRankGuildCmd.datas"
DATEBATTLERANKGUILDCMD_DATAS_FIELD.number = 4
DATEBATTLERANKGUILDCMD_DATAS_FIELD.index = 3
DATEBATTLERANKGUILDCMD_DATAS_FIELD.label = 3
DATEBATTLERANKGUILDCMD_DATAS_FIELD.has_default_value = false
DATEBATTLERANKGUILDCMD_DATAS_FIELD.default_value = {}
DATEBATTLERANKGUILDCMD_DATAS_FIELD.message_type = DATEBATTLERANKINFO
DATEBATTLERANKGUILDCMD_DATAS_FIELD.type = 11
DATEBATTLERANKGUILDCMD_DATAS_FIELD.cpp_type = 10
DATEBATTLERANKGUILDCMD.name = "DateBattleRankGuildCmd"
DATEBATTLERANKGUILDCMD.full_name = ".Cmd.DateBattleRankGuildCmd"
DATEBATTLERANKGUILDCMD.nested_types = {}
DATEBATTLERANKGUILDCMD.enum_types = {}
DATEBATTLERANKGUILDCMD.fields = {
  DATEBATTLERANKGUILDCMD_CMD_FIELD,
  DATEBATTLERANKGUILDCMD_PARAM_FIELD,
  DATEBATTLERANKGUILDCMD_MYDATA_FIELD,
  DATEBATTLERANKGUILDCMD_DATAS_FIELD
}
DATEBATTLERANKGUILDCMD.is_extendable = false
DATEBATTLERANKGUILDCMD.extensions = {}
REDTIPOPTGUILDCMD_CMD_FIELD.name = "cmd"
REDTIPOPTGUILDCMD_CMD_FIELD.full_name = ".Cmd.RedtipOptGuildCmd.cmd"
REDTIPOPTGUILDCMD_CMD_FIELD.number = 1
REDTIPOPTGUILDCMD_CMD_FIELD.index = 0
REDTIPOPTGUILDCMD_CMD_FIELD.label = 1
REDTIPOPTGUILDCMD_CMD_FIELD.has_default_value = true
REDTIPOPTGUILDCMD_CMD_FIELD.default_value = 50
REDTIPOPTGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
REDTIPOPTGUILDCMD_CMD_FIELD.type = 14
REDTIPOPTGUILDCMD_CMD_FIELD.cpp_type = 8
REDTIPOPTGUILDCMD_PARAM_FIELD.name = "param"
REDTIPOPTGUILDCMD_PARAM_FIELD.full_name = ".Cmd.RedtipOptGuildCmd.param"
REDTIPOPTGUILDCMD_PARAM_FIELD.number = 2
REDTIPOPTGUILDCMD_PARAM_FIELD.index = 1
REDTIPOPTGUILDCMD_PARAM_FIELD.label = 1
REDTIPOPTGUILDCMD_PARAM_FIELD.has_default_value = true
REDTIPOPTGUILDCMD_PARAM_FIELD.default_value = 109
REDTIPOPTGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
REDTIPOPTGUILDCMD_PARAM_FIELD.type = 14
REDTIPOPTGUILDCMD_PARAM_FIELD.cpp_type = 8
REDTIPOPTGUILDCMD_REDTIPS_FIELD.name = "redtips"
REDTIPOPTGUILDCMD_REDTIPS_FIELD.full_name = ".Cmd.RedtipOptGuildCmd.redtips"
REDTIPOPTGUILDCMD_REDTIPS_FIELD.number = 3
REDTIPOPTGUILDCMD_REDTIPS_FIELD.index = 2
REDTIPOPTGUILDCMD_REDTIPS_FIELD.label = 3
REDTIPOPTGUILDCMD_REDTIPS_FIELD.has_default_value = false
REDTIPOPTGUILDCMD_REDTIPS_FIELD.default_value = {}
REDTIPOPTGUILDCMD_REDTIPS_FIELD.message_type = SceneTip_pb.REDTIP
REDTIPOPTGUILDCMD_REDTIPS_FIELD.type = 11
REDTIPOPTGUILDCMD_REDTIPS_FIELD.cpp_type = 10
REDTIPOPTGUILDCMD.name = "RedtipOptGuildCmd"
REDTIPOPTGUILDCMD.full_name = ".Cmd.RedtipOptGuildCmd"
REDTIPOPTGUILDCMD.nested_types = {}
REDTIPOPTGUILDCMD.enum_types = {}
REDTIPOPTGUILDCMD.fields = {
  REDTIPOPTGUILDCMD_CMD_FIELD,
  REDTIPOPTGUILDCMD_PARAM_FIELD,
  REDTIPOPTGUILDCMD_REDTIPS_FIELD
}
REDTIPOPTGUILDCMD.is_extendable = false
REDTIPOPTGUILDCMD.extensions = {}
REDTIPBROWSEGUILDCMD_CMD_FIELD.name = "cmd"
REDTIPBROWSEGUILDCMD_CMD_FIELD.full_name = ".Cmd.RedtipBrowseGuildCmd.cmd"
REDTIPBROWSEGUILDCMD_CMD_FIELD.number = 1
REDTIPBROWSEGUILDCMD_CMD_FIELD.index = 0
REDTIPBROWSEGUILDCMD_CMD_FIELD.label = 1
REDTIPBROWSEGUILDCMD_CMD_FIELD.has_default_value = true
REDTIPBROWSEGUILDCMD_CMD_FIELD.default_value = 50
REDTIPBROWSEGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
REDTIPBROWSEGUILDCMD_CMD_FIELD.type = 14
REDTIPBROWSEGUILDCMD_CMD_FIELD.cpp_type = 8
REDTIPBROWSEGUILDCMD_PARAM_FIELD.name = "param"
REDTIPBROWSEGUILDCMD_PARAM_FIELD.full_name = ".Cmd.RedtipBrowseGuildCmd.param"
REDTIPBROWSEGUILDCMD_PARAM_FIELD.number = 2
REDTIPBROWSEGUILDCMD_PARAM_FIELD.index = 1
REDTIPBROWSEGUILDCMD_PARAM_FIELD.label = 1
REDTIPBROWSEGUILDCMD_PARAM_FIELD.has_default_value = true
REDTIPBROWSEGUILDCMD_PARAM_FIELD.default_value = 110
REDTIPBROWSEGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
REDTIPBROWSEGUILDCMD_PARAM_FIELD.type = 14
REDTIPBROWSEGUILDCMD_PARAM_FIELD.cpp_type = 8
REDTIPBROWSEGUILDCMD_RED_FIELD.name = "red"
REDTIPBROWSEGUILDCMD_RED_FIELD.full_name = ".Cmd.RedtipBrowseGuildCmd.red"
REDTIPBROWSEGUILDCMD_RED_FIELD.number = 3
REDTIPBROWSEGUILDCMD_RED_FIELD.index = 2
REDTIPBROWSEGUILDCMD_RED_FIELD.label = 1
REDTIPBROWSEGUILDCMD_RED_FIELD.has_default_value = true
REDTIPBROWSEGUILDCMD_RED_FIELD.default_value = 0
REDTIPBROWSEGUILDCMD_RED_FIELD.enum_type = SCENETIP_PB_EREDSYS
REDTIPBROWSEGUILDCMD_RED_FIELD.type = 14
REDTIPBROWSEGUILDCMD_RED_FIELD.cpp_type = 8
REDTIPBROWSEGUILDCMD_TIPID_FIELD.name = "tipid"
REDTIPBROWSEGUILDCMD_TIPID_FIELD.full_name = ".Cmd.RedtipBrowseGuildCmd.tipid"
REDTIPBROWSEGUILDCMD_TIPID_FIELD.number = 4
REDTIPBROWSEGUILDCMD_TIPID_FIELD.index = 3
REDTIPBROWSEGUILDCMD_TIPID_FIELD.label = 1
REDTIPBROWSEGUILDCMD_TIPID_FIELD.has_default_value = true
REDTIPBROWSEGUILDCMD_TIPID_FIELD.default_value = 0
REDTIPBROWSEGUILDCMD_TIPID_FIELD.type = 4
REDTIPBROWSEGUILDCMD_TIPID_FIELD.cpp_type = 4
REDTIPBROWSEGUILDCMD.name = "RedtipBrowseGuildCmd"
REDTIPBROWSEGUILDCMD.full_name = ".Cmd.RedtipBrowseGuildCmd"
REDTIPBROWSEGUILDCMD.nested_types = {}
REDTIPBROWSEGUILDCMD.enum_types = {}
REDTIPBROWSEGUILDCMD.fields = {
  REDTIPBROWSEGUILDCMD_CMD_FIELD,
  REDTIPBROWSEGUILDCMD_PARAM_FIELD,
  REDTIPBROWSEGUILDCMD_RED_FIELD,
  REDTIPBROWSEGUILDCMD_TIPID_FIELD
}
REDTIPBROWSEGUILDCMD.is_extendable = false
REDTIPBROWSEGUILDCMD.extensions = {}
GUILDPORTRAITDATA_GUILDID_FIELD.name = "guildid"
GUILDPORTRAITDATA_GUILDID_FIELD.full_name = ".Cmd.GuildPortraitData.guildid"
GUILDPORTRAITDATA_GUILDID_FIELD.number = 1
GUILDPORTRAITDATA_GUILDID_FIELD.index = 0
GUILDPORTRAITDATA_GUILDID_FIELD.label = 1
GUILDPORTRAITDATA_GUILDID_FIELD.has_default_value = true
GUILDPORTRAITDATA_GUILDID_FIELD.default_value = 0
GUILDPORTRAITDATA_GUILDID_FIELD.type = 4
GUILDPORTRAITDATA_GUILDID_FIELD.cpp_type = 4
GUILDPORTRAITDATA_SERVERID_FIELD.name = "serverid"
GUILDPORTRAITDATA_SERVERID_FIELD.full_name = ".Cmd.GuildPortraitData.serverid"
GUILDPORTRAITDATA_SERVERID_FIELD.number = 2
GUILDPORTRAITDATA_SERVERID_FIELD.index = 1
GUILDPORTRAITDATA_SERVERID_FIELD.label = 1
GUILDPORTRAITDATA_SERVERID_FIELD.has_default_value = true
GUILDPORTRAITDATA_SERVERID_FIELD.default_value = 0
GUILDPORTRAITDATA_SERVERID_FIELD.type = 13
GUILDPORTRAITDATA_SERVERID_FIELD.cpp_type = 3
GUILDPORTRAITDATA_GUILDNAME_FIELD.name = "guildname"
GUILDPORTRAITDATA_GUILDNAME_FIELD.full_name = ".Cmd.GuildPortraitData.guildname"
GUILDPORTRAITDATA_GUILDNAME_FIELD.number = 3
GUILDPORTRAITDATA_GUILDNAME_FIELD.index = 2
GUILDPORTRAITDATA_GUILDNAME_FIELD.label = 1
GUILDPORTRAITDATA_GUILDNAME_FIELD.has_default_value = false
GUILDPORTRAITDATA_GUILDNAME_FIELD.default_value = ""
GUILDPORTRAITDATA_GUILDNAME_FIELD.type = 9
GUILDPORTRAITDATA_GUILDNAME_FIELD.cpp_type = 9
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.name = "guildportrait"
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.full_name = ".Cmd.GuildPortraitData.guildportrait"
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.number = 4
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.index = 3
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.label = 1
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.has_default_value = false
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.default_value = ""
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.type = 9
GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD.cpp_type = 9
GUILDPORTRAITDATA.name = "GuildPortraitData"
GUILDPORTRAITDATA.full_name = ".Cmd.GuildPortraitData"
GUILDPORTRAITDATA.nested_types = {}
GUILDPORTRAITDATA.enum_types = {}
GUILDPORTRAITDATA.fields = {
  GUILDPORTRAITDATA_GUILDID_FIELD,
  GUILDPORTRAITDATA_SERVERID_FIELD,
  GUILDPORTRAITDATA_GUILDNAME_FIELD,
  GUILDPORTRAITDATA_GUILDPORTRAIT_FIELD
}
GUILDPORTRAITDATA.is_extendable = false
GUILDPORTRAITDATA.extensions = {}
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.name = "cmd"
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.full_name = ".Cmd.DateBattleFlagGuildCmd.cmd"
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.number = 1
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.index = 0
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.label = 1
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.has_default_value = true
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.default_value = 50
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.type = 14
DATEBATTLEFLAGGUILDCMD_CMD_FIELD.cpp_type = 8
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.name = "param"
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.full_name = ".Cmd.DateBattleFlagGuildCmd.param"
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.number = 2
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.index = 1
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.label = 1
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.has_default_value = true
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.default_value = 111
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.type = 14
DATEBATTLEFLAGGUILDCMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.name = "mapid"
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.full_name = ".Cmd.DateBattleFlagGuildCmd.mapid"
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.number = 3
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.index = 2
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.label = 1
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.has_default_value = true
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.default_value = 0
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.type = 13
DATEBATTLEFLAGGUILDCMD_MAPID_FIELD.cpp_type = 3
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.name = "datas"
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.full_name = ".Cmd.DateBattleFlagGuildCmd.datas"
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.number = 4
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.index = 3
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.label = 3
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.has_default_value = false
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.default_value = {}
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.message_type = GUILDPORTRAITDATA
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.type = 11
DATEBATTLEFLAGGUILDCMD_DATAS_FIELD.cpp_type = 10
DATEBATTLEFLAGGUILDCMD.name = "DateBattleFlagGuildCmd"
DATEBATTLEFLAGGUILDCMD.full_name = ".Cmd.DateBattleFlagGuildCmd"
DATEBATTLEFLAGGUILDCMD.nested_types = {}
DATEBATTLEFLAGGUILDCMD.enum_types = {}
DATEBATTLEFLAGGUILDCMD.fields = {
  DATEBATTLEFLAGGUILDCMD_CMD_FIELD,
  DATEBATTLEFLAGGUILDCMD_PARAM_FIELD,
  DATEBATTLEFLAGGUILDCMD_MAPID_FIELD,
  DATEBATTLEFLAGGUILDCMD_DATAS_FIELD
}
DATEBATTLEFLAGGUILDCMD.is_extendable = false
DATEBATTLEFLAGGUILDCMD.extensions = {}
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.name = "cmd"
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.full_name = ".Cmd.DateBattleReportUIStateCmd.cmd"
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.number = 1
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.index = 0
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.label = 1
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.has_default_value = true
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.default_value = 50
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.type = 14
DATEBATTLEREPORTUISTATECMD_CMD_FIELD.cpp_type = 8
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.name = "param"
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.full_name = ".Cmd.DateBattleReportUIStateCmd.param"
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.number = 2
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.index = 1
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.label = 1
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.has_default_value = true
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.default_value = 113
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.enum_type = GUILDPARAM
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.type = 14
DATEBATTLEREPORTUISTATECMD_PARAM_FIELD.cpp_type = 8
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.name = "open"
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.full_name = ".Cmd.DateBattleReportUIStateCmd.open"
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.number = 3
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.index = 2
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.label = 1
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.has_default_value = false
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.default_value = false
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.type = 8
DATEBATTLEREPORTUISTATECMD_OPEN_FIELD.cpp_type = 7
DATEBATTLEREPORTUISTATECMD.name = "DateBattleReportUIStateCmd"
DATEBATTLEREPORTUISTATECMD.full_name = ".Cmd.DateBattleReportUIStateCmd"
DATEBATTLEREPORTUISTATECMD.nested_types = {}
DATEBATTLEREPORTUISTATECMD.enum_types = {}
DATEBATTLEREPORTUISTATECMD.fields = {
  DATEBATTLEREPORTUISTATECMD_CMD_FIELD,
  DATEBATTLEREPORTUISTATECMD_PARAM_FIELD,
  DATEBATTLEREPORTUISTATECMD_OPEN_FIELD
}
DATEBATTLEREPORTUISTATECMD.is_extendable = false
DATEBATTLEREPORTUISTATECMD.extensions = {}
GVGCITYSTATUEINFO_CITYID_FIELD.name = "cityid"
GVGCITYSTATUEINFO_CITYID_FIELD.full_name = ".Cmd.GvgCityStatueInfo.cityid"
GVGCITYSTATUEINFO_CITYID_FIELD.number = 1
GVGCITYSTATUEINFO_CITYID_FIELD.index = 0
GVGCITYSTATUEINFO_CITYID_FIELD.label = 1
GVGCITYSTATUEINFO_CITYID_FIELD.has_default_value = false
GVGCITYSTATUEINFO_CITYID_FIELD.default_value = 0
GVGCITYSTATUEINFO_CITYID_FIELD.type = 13
GVGCITYSTATUEINFO_CITYID_FIELD.cpp_type = 3
GVGCITYSTATUEINFO_INFO_FIELD.name = "info"
GVGCITYSTATUEINFO_INFO_FIELD.full_name = ".Cmd.GvgCityStatueInfo.info"
GVGCITYSTATUEINFO_INFO_FIELD.number = 2
GVGCITYSTATUEINFO_INFO_FIELD.index = 1
GVGCITYSTATUEINFO_INFO_FIELD.label = 1
GVGCITYSTATUEINFO_INFO_FIELD.has_default_value = false
GVGCITYSTATUEINFO_INFO_FIELD.default_value = nil
GVGCITYSTATUEINFO_INFO_FIELD.message_type = GVGSTATUEINFO
GVGCITYSTATUEINFO_INFO_FIELD.type = 11
GVGCITYSTATUEINFO_INFO_FIELD.cpp_type = 10
GVGCITYSTATUEINFO.name = "GvgCityStatueInfo"
GVGCITYSTATUEINFO.full_name = ".Cmd.GvgCityStatueInfo"
GVGCITYSTATUEINFO.nested_types = {}
GVGCITYSTATUEINFO.enum_types = {}
GVGCITYSTATUEINFO.fields = {
  GVGCITYSTATUEINFO_CITYID_FIELD,
  GVGCITYSTATUEINFO_INFO_FIELD
}
GVGCITYSTATUEINFO.is_extendable = false
GVGCITYSTATUEINFO.extensions = {}
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.name = "cmd"
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.full_name = ".Cmd.GvgCityStatueQueryGuildCmd.cmd"
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.number = 1
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.index = 0
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.label = 1
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.has_default_value = true
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.default_value = 50
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.type = 14
GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD.cpp_type = 8
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.name = "param"
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.full_name = ".Cmd.GvgCityStatueQueryGuildCmd.param"
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.number = 2
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.index = 1
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.label = 1
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.has_default_value = true
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.default_value = 115
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.type = 14
GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD.cpp_type = 8
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.name = "groupid"
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.full_name = ".Cmd.GvgCityStatueQueryGuildCmd.groupid"
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.number = 3
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.index = 2
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.label = 1
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.has_default_value = false
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.default_value = 0
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.type = 13
GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD.cpp_type = 3
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.name = "cityid"
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.full_name = ".Cmd.GvgCityStatueQueryGuildCmd.cityid"
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.number = 4
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.index = 3
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.label = 1
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.has_default_value = false
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.default_value = 0
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.type = 13
GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD.cpp_type = 3
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.name = "infos"
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.full_name = ".Cmd.GvgCityStatueQueryGuildCmd.infos"
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.number = 5
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.index = 4
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.label = 3
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.has_default_value = false
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.default_value = {}
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.message_type = GVGCITYSTATUEINFO
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.type = 11
GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD.cpp_type = 10
GVGCITYSTATUEQUERYGUILDCMD.name = "GvgCityStatueQueryGuildCmd"
GVGCITYSTATUEQUERYGUILDCMD.full_name = ".Cmd.GvgCityStatueQueryGuildCmd"
GVGCITYSTATUEQUERYGUILDCMD.nested_types = {}
GVGCITYSTATUEQUERYGUILDCMD.enum_types = {}
GVGCITYSTATUEQUERYGUILDCMD.fields = {
  GVGCITYSTATUEQUERYGUILDCMD_CMD_FIELD,
  GVGCITYSTATUEQUERYGUILDCMD_PARAM_FIELD,
  GVGCITYSTATUEQUERYGUILDCMD_GROUPID_FIELD,
  GVGCITYSTATUEQUERYGUILDCMD_CITYID_FIELD,
  GVGCITYSTATUEQUERYGUILDCMD_INFOS_FIELD
}
GVGCITYSTATUEQUERYGUILDCMD.is_extendable = false
GVGCITYSTATUEQUERYGUILDCMD.extensions = {}
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.name = "cmd"
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.full_name = ".Cmd.GvgCityStatueUpdateGuildCmd.cmd"
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.number = 1
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.index = 0
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.label = 1
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.has_default_value = true
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.default_value = 50
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.type = 14
GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD.cpp_type = 8
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.name = "param"
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.full_name = ".Cmd.GvgCityStatueUpdateGuildCmd.param"
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.number = 2
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.index = 1
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.label = 1
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.has_default_value = true
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.default_value = 116
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.enum_type = GUILDPARAM
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.type = 14
GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD.cpp_type = 8
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.name = "groupid"
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.full_name = ".Cmd.GvgCityStatueUpdateGuildCmd.groupid"
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.number = 3
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.index = 2
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.label = 1
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.has_default_value = false
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.default_value = 0
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.type = 13
GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD.cpp_type = 3
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.name = "cityid"
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.full_name = ".Cmd.GvgCityStatueUpdateGuildCmd.cityid"
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.number = 4
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.index = 3
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.label = 1
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.has_default_value = false
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.default_value = 0
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.type = 13
GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD.cpp_type = 3
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.name = "exterior"
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.full_name = ".Cmd.GvgCityStatueUpdateGuildCmd.exterior"
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.number = 5
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.index = 4
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.label = 1
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.has_default_value = false
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.default_value = false
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.type = 8
GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD.cpp_type = 7
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.name = "info"
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.full_name = ".Cmd.GvgCityStatueUpdateGuildCmd.info"
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.number = 6
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.index = 5
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.label = 1
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.has_default_value = false
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.default_value = nil
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.message_type = GVGCITYSTATUEINFO
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.type = 11
GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD.cpp_type = 10
GVGCITYSTATUEUPDATEGUILDCMD.name = "GvgCityStatueUpdateGuildCmd"
GVGCITYSTATUEUPDATEGUILDCMD.full_name = ".Cmd.GvgCityStatueUpdateGuildCmd"
GVGCITYSTATUEUPDATEGUILDCMD.nested_types = {}
GVGCITYSTATUEUPDATEGUILDCMD.enum_types = {}
GVGCITYSTATUEUPDATEGUILDCMD.fields = {
  GVGCITYSTATUEUPDATEGUILDCMD_CMD_FIELD,
  GVGCITYSTATUEUPDATEGUILDCMD_PARAM_FIELD,
  GVGCITYSTATUEUPDATEGUILDCMD_GROUPID_FIELD,
  GVGCITYSTATUEUPDATEGUILDCMD_CITYID_FIELD,
  GVGCITYSTATUEUPDATEGUILDCMD_EXTERIOR_FIELD,
  GVGCITYSTATUEUPDATEGUILDCMD_INFO_FIELD
}
GVGCITYSTATUEUPDATEGUILDCMD.is_extendable = false
GVGCITYSTATUEUPDATEGUILDCMD.extensions = {}
QUERYSUPERGVGSTATCMD_CMD_FIELD.name = "cmd"
QUERYSUPERGVGSTATCMD_CMD_FIELD.full_name = ".Cmd.QuerySuperGvgStatCmd.cmd"
QUERYSUPERGVGSTATCMD_CMD_FIELD.number = 1
QUERYSUPERGVGSTATCMD_CMD_FIELD.index = 0
QUERYSUPERGVGSTATCMD_CMD_FIELD.label = 1
QUERYSUPERGVGSTATCMD_CMD_FIELD.has_default_value = true
QUERYSUPERGVGSTATCMD_CMD_FIELD.default_value = 50
QUERYSUPERGVGSTATCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
QUERYSUPERGVGSTATCMD_CMD_FIELD.type = 14
QUERYSUPERGVGSTATCMD_CMD_FIELD.cpp_type = 8
QUERYSUPERGVGSTATCMD_PARAM_FIELD.name = "param"
QUERYSUPERGVGSTATCMD_PARAM_FIELD.full_name = ".Cmd.QuerySuperGvgStatCmd.param"
QUERYSUPERGVGSTATCMD_PARAM_FIELD.number = 2
QUERYSUPERGVGSTATCMD_PARAM_FIELD.index = 1
QUERYSUPERGVGSTATCMD_PARAM_FIELD.label = 1
QUERYSUPERGVGSTATCMD_PARAM_FIELD.has_default_value = true
QUERYSUPERGVGSTATCMD_PARAM_FIELD.default_value = 114
QUERYSUPERGVGSTATCMD_PARAM_FIELD.enum_type = GUILDPARAM
QUERYSUPERGVGSTATCMD_PARAM_FIELD.type = 14
QUERYSUPERGVGSTATCMD_PARAM_FIELD.cpp_type = 8
QUERYSUPERGVGSTATCMD_DATAS_FIELD.name = "datas"
QUERYSUPERGVGSTATCMD_DATAS_FIELD.full_name = ".Cmd.QuerySuperGvgStatCmd.datas"
QUERYSUPERGVGSTATCMD_DATAS_FIELD.number = 3
QUERYSUPERGVGSTATCMD_DATAS_FIELD.index = 2
QUERYSUPERGVGSTATCMD_DATAS_FIELD.label = 3
QUERYSUPERGVGSTATCMD_DATAS_FIELD.has_default_value = false
QUERYSUPERGVGSTATCMD_DATAS_FIELD.default_value = {}
QUERYSUPERGVGSTATCMD_DATAS_FIELD.message_type = ProtoCommon_pb.SUPERGVGGUILDUSERDATA
QUERYSUPERGVGSTATCMD_DATAS_FIELD.type = 11
QUERYSUPERGVGSTATCMD_DATAS_FIELD.cpp_type = 10
QUERYSUPERGVGSTATCMD_IS_END_FIELD.name = "is_end"
QUERYSUPERGVGSTATCMD_IS_END_FIELD.full_name = ".Cmd.QuerySuperGvgStatCmd.is_end"
QUERYSUPERGVGSTATCMD_IS_END_FIELD.number = 4
QUERYSUPERGVGSTATCMD_IS_END_FIELD.index = 3
QUERYSUPERGVGSTATCMD_IS_END_FIELD.label = 1
QUERYSUPERGVGSTATCMD_IS_END_FIELD.has_default_value = true
QUERYSUPERGVGSTATCMD_IS_END_FIELD.default_value = false
QUERYSUPERGVGSTATCMD_IS_END_FIELD.type = 8
QUERYSUPERGVGSTATCMD_IS_END_FIELD.cpp_type = 7
QUERYSUPERGVGSTATCMD.name = "QuerySuperGvgStatCmd"
QUERYSUPERGVGSTATCMD.full_name = ".Cmd.QuerySuperGvgStatCmd"
QUERYSUPERGVGSTATCMD.nested_types = {}
QUERYSUPERGVGSTATCMD.enum_types = {}
QUERYSUPERGVGSTATCMD.fields = {
  QUERYSUPERGVGSTATCMD_CMD_FIELD,
  QUERYSUPERGVGSTATCMD_PARAM_FIELD,
  QUERYSUPERGVGSTATCMD_DATAS_FIELD,
  QUERYSUPERGVGSTATCMD_IS_END_FIELD
}
QUERYSUPERGVGSTATCMD.is_extendable = false
QUERYSUPERGVGSTATCMD.extensions = {}
...
BuildingUpdateNtfGuildCmd = protobuf.Message(BUILDINGUPDATENTFGUILDCMD)
...
DateBattleData = protobuf.Message(DATEBATTLEDATA)
DateBattleDetailGuildCmd = protobuf.Message(DATEBATTLEDETAILGUILDCMD)
DateBattleEnterGuildCmd = protobuf.Message(DATEBATTLEENTERGUILDCMD)
DateBattleFlagGuildCmd = protobuf.Message(DATEBATTLEFLAGGUILDCMD)
DateBattleInfoGuildCmd = protobuf.Message(DATEBATTLEINFOGUILDCMD)
DateBattleInviteGuildCmd = protobuf.Message(DATEBATTLEINVITEGUILDCMD)
DateBattleListGuildCmd = protobuf.Message(DATEBATTLELISTGUILDCMD)
DateBattleOpenGuildCmd = protobuf.Message(DATEBATTLEOPENGUILDCMD)
DateBattleRankGuildCmd = protobuf.Message(DATEBATTLERANKGUILDCMD)
DateBattleRankInfo = protobuf.Message(DATEBATTLERANKINFO)
DateBattleReplyGuildCmd = protobuf.Message(DATEBATTLEREPLYGUILDCMD)
DateBattleReport = protobuf.Message(DATEBATTLEREPORT)
DateBattleReportGuildCmd = protobuf.Message(DATEBATTLEREPORTGUILDCMD)
DateBattleReportUIStateCmd = protobuf.Message(DATEBATTLEREPORTUISTATECMD)
DateBattleTargetGuildCmd = protobuf.Message(DATEBATTLETARGETGUILDCMD)
...
ExchangeGvgGroupGuildCmd = protobuf.Message(EXCHANGEGVGGROUPGUILDCMD)
...
GuildBuildingReward = protobuf.Message(GUILDBUILDINGREWARD)
...
GuildPortraitData = protobuf.Message(GUILDPORTRAITDATA)
...
GvgCityStatueInfo = protobuf.Message(GVGCITYSTATUEINFO)
GvgCityStatueQueryGuildCmd = protobuf.Message(GVGCITYSTATUEQUERYGUILDCMD)
GvgCityStatueUpdateGuildCmd = protobuf.Message(GVGCITYSTATUEUPDATEGUILDCMD)
GvgCookingCmd = protobuf.Message(GVGCOOKINGCMD)
GvgCookingUpdateCmd = protobuf.Message(GVGCOOKINGUPDATECMD)
GvgDataQueryGuildCmd = protobuf.Message(GVGDATAQUERYGUILDCMD)
GvgDefenseData = protobuf.Message(GVGDEFENSEDATA)
GvgFireReportGuildCmd = protobuf.Message(GVGFIREREPORTGUILDCMD)
...
GvgRoadblockModifyGuildCmd = protobuf.Message(GVGROADBLOCKMODIFYGUILDCMD)
GvgRoadblockQueryGuildCmd = protobuf.Message(GVGROADBLOCKQUERYGUILDCMD)
...
GvgUserFireData = protobuf.Message(GVGUSERFIREDATA)
...
MemberRedTip = protobuf.Message(MEMBERREDTIP)
...
QuerySuperGvgStatCmd = protobuf.Message(QUERYSUPERGVGSTATCMD)
QueryTreasureResultGuildCmd = protobuf.Message(QUERYTREASURERESULTGUILDCMD)
RedtipBrowseGuildCmd = protobuf.Message(REDTIPBROWSEGUILDCMD)
RedtipOptGuildCmd = protobuf.Message(REDTIPOPTGUILDCMD)
