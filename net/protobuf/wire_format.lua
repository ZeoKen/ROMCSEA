...
WIRETYPE_FIXED32 = 5
_WIRETYPE_MAX = 5
local _VarUInt64ByteSizeNoTag = function(uint64)
  if uint64 <= 127 then
    return 1
  end
  ...
  if uint64 <= 34359738367 then
    return 5
  end
  if uint64 <= 4398046511103 then
    return 6
  end
  if uint64 <= 562949953421311 then
    return 7
  end
  if uint64 <= 72057594037927935 then
    return 8
  end
  if uint64 <= 9223372036854775807 then
    return 9
  end
  return 10
end
