...
function NumberUtility.Square(a)
  return a * a
end
...
function NumberUtility.TryLerpAngleUnclamped(a, b, t)
  if a ~= nil and b ~= nil then
    return NumberUtility.LerpAngleUnclamped(a, b, t)
  else
    return b
  end
end
