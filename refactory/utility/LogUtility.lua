...
function mylog(arg1, arg2, arg3, arg4, arg5)
end
...
function slog(arg1, arg2, arg3, arg4, arg5)
  local oriEnable = LogUtility.traceEnable
  LogUtility.traceEnable = false
  _helplog("<color=red>", arg1, arg2, arg3, arg4, arg5)
  LogUtility.traceEnable = oriEnable
end

function XDLog(key, data)
  MyLuaSrv.EnablePrint = true
  LogUtility.InfoFormat("<color=lime>X.D. Overseas key ===> {0}</color>", key)
  print(innerString(data))
end

function Buglylog(log)
  BuglyManager.GetInstance():Log(log)
end
