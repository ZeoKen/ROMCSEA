...
function GOManager_CullingObject:RegisterGameObject(obj)
  ...
  local cullingDistance = Game.LogicManager_MapCell:DistanceLevelToDistance(tonumber(obj:GetProperty(0)))
  Game.LogicManager_MapCell:RegisterGameObject(obj.gameObject, LogicManager_MapCell.ObjType.CullingObj, objID, cullingDistance, LogicManager_MapCell.CullingType.AutoSetActive)
  return true
end
...
function GOManager_CullingObject:UnregisterGameObject(obj)
  ...
  Game.LogicManager_MapCell:UnRegisterGameObject(obj.gameObject)
  return true
end
