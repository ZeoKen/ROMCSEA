...
function FunctionTempItem:SetItemGainCount(itemId, count)
  if not self.gainCountMap then
    self.gainCountMap = {}
  end
  self.gainCountMap[itemId] = count
end

function FunctionTempItem:GetItemGainCount(itemId)
  return self.gainCountMap and self.gainCountMap[itemId] or 0
end
