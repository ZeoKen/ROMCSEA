...
function FunctionADBuiltInTyrantdb:SendTrackEvent(eventName)
  FunctionTyrantdb.Instance:trackEvent(eventName, nil)
end

function FunctionADBuiltInTyrantdb:SendTrackEventWithProperties(eventName, propertiesTable)
end
