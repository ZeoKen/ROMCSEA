...
function FaceBookFavPanel:InitThumbsUp()
  ...
  self:AddClickEvent(self.favBtn, function(go)
    ...
    elseif BranchMgr.IsNA() then
      Application.OpenURL("https://www.facebook.com/PlayRagnarokMGlobal/")
    elseif BranchMgr.IsEU() then
      Application.OpenURL("https://www.facebook.com/PlayRagnarokMEU/")
    elseif not BranchMgr.IsChina() then
