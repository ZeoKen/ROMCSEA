...
function RandomUtil.RandomInCircle(range)
  range = range or 1
  return RandomUtil.Range(-1, 1) * range, RandomUtil.Range(-1, 1) * range
end

function RandomUtil.RandomInSphere(range)
  range = range or 1
  return RandomUtil.Range(-1, 1) * range, RandomUtil.Range(-1, 1) * range, RandomUtil.Range(-1, 1) * range
end
