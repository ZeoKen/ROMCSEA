...
function UIWarning:FindObjs()
  self.bords = {
    WaitingBord = Game.GameObjectUtil:DeepFindChild(self.gameObject, "WaitingBord")
  }
  self.bgCollider = Game.GameObjectUtil:DeepFindChild(self.gameObject, "bgCollider")
...
function UIWarning:TryPopupWarning()
  if self.warnPopupsData == nil then
    return
  end
