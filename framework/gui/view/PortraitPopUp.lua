...
function PortraitPopUp:RegistRedTip()
  ...
  self:AddTabEvent(roleTog, function()
    self:UpdateRolePortrait()
  end)
  self:AddTabEvent(moreTog, function()
    self:UpdateMorePortrait()
  end)
  self:AddTabEvent(frameTog, function()
  ...
  self:RegisterRedTipCheck(SceneTip_pb.EREDSYS_PORTRAIT_FRAME, moreTog:GetComponentInChildren(UISprite), 50)
  self:RegisterRedTipCheck(SceneTip_pb.EREDSYS_BACKGROUND_FRAME, moreTog:GetComponentInChildren(UISprite), 50)
end
