...
function QuotaCardView:FindObjs()
  ...
  self.titleLab.text = ZhString.QuotaCard_Title
end
...
function QuotaCardView:InitUIView()
  ...
  local helpData = Table_Help[32597]
  self.desc.text = helpData and helpData.Desc
...
function QuotaCardView:OnClickGoBtn()
  local tab = BranchMgr.IsKorea() and FunctionNewRecharge.InnerTab.Deposit_ROB or FunctionNewRecharge.InnerTab.Deposit_Zeny
  FunctionNewRecharge.Instance():OpenUI(PanelConfig.NewRecharge_TDeposit, tab)
end
