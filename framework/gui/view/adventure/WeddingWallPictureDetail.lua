...
function WeddingWallPictureDetail:OnEnter()
  WeddingWallPictureDetail.super.OnEnter(self)
  self:showAnim()
  if self.photo then
...
function WeddingWallPictureDetail:DestroyPhotoTexture()
  local texture = self.photo and self.photo.mainTexture
  if texture and texture.name ~= "Wedding_Photo" then
...
function WeddingWallPictureDetail:OnExit()
  ...
  WeddingWallPictureDetail.super.OnExit(self)
end
