...
function AdventureRewardPanel:OnDestroy()
  AdventureRewardPanel.super.OnDestroy(self)
end
...
function AdventureRewardPanel:cellClick(obj)
  ...
  if tip then
    tip.gameObject.transform.localPosition = LuaGeometry.GetTempVector3(400, 0, 0)
  end
end
