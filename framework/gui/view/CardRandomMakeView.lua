...
function CardRandomMakeView:OnShow()
...
function CardRandomMakeView:InitRandomGetCard()
  CardMakeProxy.Instance:InitRandomGetList()
end
...
function CardRandomMakeView:_Confirm()
  if self.canMake then
...
function CardRandomMakeView:LockCall()
...
function CardRandomMakeView:CancelLockCall()
