...
function TutorGraduationView:CreateList()
  ...
  self.itemListTable = WrapScrollViewHelper.new(ConditionItem, rid, self.scrollview.gameObject, self.table, #data)
  self:UpdateList()
end
...
function TutorGraduationView:UpdateLabel()
  ...
  self.canGraduation = gradLevel <= level
...
function TutorGraduationView:Graduation()
  ...
  elseif TutorProxy.Instance.needRedTip then
