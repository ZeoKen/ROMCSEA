...
function BoothChatView:TryEnableSpeechBtns()
  local isShow = FunctionPerformanceSetting.Me():GetVoicePartShowing() and ApplicationInfo.NeedOpenVoiceSend()
  self.teamSpeech.gameObject:SetActive(isShow)
  self.guildSpeech.gameObject:SetActive(isShow)
end

function BoothChatView:ToView(viewconfig, viewdata)
