...
function TypeNineFloatPanel:PlayShowGrp()
  if self.showingGrp == nil and #self.waitingGrps > 0 then
...
function TypeNineFloatGrp._EffectCreated(effectHandle, args, assetEffect)
...
function TypeNineFloatGrp:_RealPlayEffect(effectHandle, index)
  ...
  effectHandle.transform.localPosition = LuaGeometry.GetTempVector3(0, index * 25)
...
local _RealSortMsg = function(l, r)
  return l[1] < r[1]
end
