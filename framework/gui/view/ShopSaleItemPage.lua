...
function ShopSaleItemPage:FindObjs()
  ...
  self.totalCostIcon = self:FindGO("totalCostIcon", self.LeftBord):GetComponent(UISprite)
  ...
  self.nonetip = self:FindGO("NoneTip", self.LeftBord)
  ...
  IconManager:SetItemIcon(Table_Item[100].Icon, self.totalCostIcon)
end
...
function ShopSaleItemPage:HandleClickCanelSale(cellctl)
  if cellctl and cellctl.data then
    ...
    self.container.ShopSaleBagPage.walletPage.itemlist:UpdateList(true)
  end
end
