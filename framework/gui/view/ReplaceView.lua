        ...
        for i = 1, #composeCost do
          ...
          if bagItems then
            for j = #bagItems, 1, -1 do
              ...
              if equipInfo and (0 < equipInfo.strengthlv or 0 < equipInfo.refinelv or equipCards and 0 < #equipCards or enchantInfo and enchantInfo:HasAttri()) then
...
function ReplaceView:ShowEndDialog()
  local viewdata = {
    viewname = "DialogView",
    dialoglist = {
      ZhString.ReplaceView_ReplaceSuccess
    },
