...
function BossCardComposeView:InitShow()
  ...
  self.effectPic = self:FindGO("EffectPic"):GetComponent(UITexture)
  self.sample = self:FindGO("sample"):GetComponent(UITexture)
  self.center = self:FindGO("center"):GetComponent(UITexture)
  PictureManager.Instance:SetUI("boss-card-synthesis_bg_matrix", self.effectPic)
  PictureManager.Instance:SetUI("boss-card-synthesis_bg_card", self.sample)
  PictureManager.Instance:SetUI("boss-card-synthesis_bg_card_boli", self.center)
  ...
  self:PlayUIEffect(EffectMap.UI.MVPCard_Btn, btneffectContainer, false, function(obj, args, assetEffect)
...
function BossCardComposeView:CallExchangeCardItem()
  ...
  ServiceItemProxy.Instance:CallExchangeCardItemCmd(CardMakeProxy.MakeType.BossCompose, self.npcId, nil, nil, nil, not skipValue)
end
...
function BossCardComposeView:OnExit()
  BossCardComposeView.super.OnExit(self)
  PictureManager.Instance:UnLoadUI("boss-card-synthesis_bg_matrix", self.effectPic)
  PictureManager.Instance:UnLoadUI("boss-card-synthesis_bg_card", self.sample)
  PictureManager.Instance:UnLoadUI("boss-card-synthesis_bg_card_boli", self.center)
end
