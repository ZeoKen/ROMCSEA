...
function AuctionRecordView:InitShow()
  self.tips.text = string.format(ZhString.Auction_RecordMaxLog, tostring(math.floor(GameConfig.Auction.LogTime / day)), tostring(math.floor(GameConfig.Auction.ReceiveTime / day)))
  local wrapConfig = {
