PersonalArtifactChatShareView = class("PersonalArtifactChatShareView", BaseView)
autoImport("PhotographResultPanel")
autoImport("ItemTipBaseCell")
PersonalArtifactChatShareView.ViewType = UIViewType.ShareLayer
PersonalArtifactChatShareView.ShareType = {
  NormalShare = 1,
  SkadaShare = 2,
  RaidResultShare = 3
}

function PersonalArtifactChatShareView:Init()
  self:initView()
  self:initData()
end

function PersonalArtifactChatShareView:initView()
...
function PersonalArtifactChatShareView:ShareToGlobalChannel()
end

function PersonalArtifactChatShareView:setItemProperty(itemData)
  local label = ""
...
function PersonalArtifactChatShareView:SetData(data)
  self.data = data
...
function PersonalArtifactChatShareView:GetGameObjects()
end

function PersonalArtifactChatShareView:RegisterButtonClickEvent()
end

function PersonalArtifactChatShareView:changeUIState(isStart)
  if isStart then
...
function PersonalArtifactChatShareView:initData()
...
function PersonalArtifactChatShareView:OnExit()
end
