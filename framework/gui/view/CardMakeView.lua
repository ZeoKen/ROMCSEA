...
function CardMakeView:FindObjs()
  ...
  local eParent = self:FindComponent("Effect", ChangeRqByTex)
  local ePath = ResourcePathHelper.UIEffect("13itemShine_02")
  ePath = ResourcePathHelper.Effect(ePath)
  self:LoadPreferb_ByFullPath(ePath, eParent.gameObject)
  eParent.excute = true
end
