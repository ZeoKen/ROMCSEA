...
LineColor = Color(0.1411764705882353, 0.4980392156862745, 0.7529411764705882, 1)
...
function MPLineCell:Init()
  ...
  self.CRoot.gameObject.transform.localScale = LuaGeometry.GetTempVector3(size[1] / 1280, 1, 1)
  ...
  self.CRoot_right4h = self:FindGO("right4h", self.CRoot)
  self.CRoot_right4s = self:FindGO("right4s", self.CRoot)
  ...
  self.CRoot_right4h_UISprite = self.CRoot_right4h:GetComponent(UISprite)
  self.CRoot_right4s_UISprite = self.CRoot_right4s:GetComponent(UISprite)
...
function MPLineCell:CRootSetState(p1, p2, p3, p4, p5, p6, p7)
  ...
  if p7 then
    self.CRoot_right4s_UISprite.color = self.blueColor
    self.CRoot_right4h_UISprite.color = self.blueColor
  else
    self.CRoot_right4s_UISprite.color = self.greyColor
    self.CRoot_right4h_UISprite.color = self.greyColor
  end
end
