...
function SkyWheelSearchView:InitShow()
  if GameConfig.Social.findfriend and GameConfig.Social.findfriend.idonly and GameConfig.Social.findfriend.idonly == 1 then
    self.ContentInputLabel.text = ZhString.Friend_SearchContentWithoutName
  else
