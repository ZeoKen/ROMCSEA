    ...
    if staticData ~= nil then
      ...
      if self:CheckCanAnswer(data.charids) then
        if self.questionid == 11 then
          question = string.format(question, Game.Myself.data:GetName(), _WeddingProxy:GetPartnerName())
        end
        ...
        if self.questionid == 11 then
          question = string.format(question, _WeddingProxy:GetPartnerName(), Game.Myself.data:GetName())
        end
