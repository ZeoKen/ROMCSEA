...
function CreateGuildPopUp:InitUI()
  ...
  UIUtil.LimitInputCharacter(self.nameInput, GameConfig.System.guildname_max)
...
function CreateGuildPopUp:CreateGuild()
  ...
  if not FunctionMaskWord.Me():CheckMaskWord(name, self.filterType) and StringUtil.CheckTextValidForDisplay(name) then
