...
SelectServerPanel.ServerSt = {
  {
    id = SelectServerPanel.ServerConfig.Normal,
    name = ZhString.SelectServerPanel_StateNormal
  },
  {
    id = SelectServerPanel.ServerConfig.Crowd,
    name = ZhString.SelectServerPanel_StateCrowd
  },
  {
    id = SelectServerPanel.ServerConfig.Hot,
    name = ZhString.SelectServerPanel_StateHot
  },
  {
    id = SelectServerPanel.ServerConfig.Maintain,
    name = ZhString.SelectServerPanel_StateMaintain
  }
}
...
function SelectServerPanel:initView()
  ...
  hasRoles.transform.localPosition = LuaGeometry.GetTempVector3(x, y - 30, z)
  self:Hide(hasRoles)
  ...
  RegionCellHolder.transform.localPosition = LuaGeometry.GetTempVector3(0, 0, 0)
