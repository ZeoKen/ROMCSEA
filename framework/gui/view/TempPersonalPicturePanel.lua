  ...
  if cellCtl and cellCtl.data then
    ...
    if cellCtl.status == PersonalPictureCell.PhotoStatus.Success then
      ...
      GameFacade.Instance:sendNotification(UIEvent.JumpPanel, {
        view = PanelConfig.TempPersonalPictureDetailPanel,
        viewdata = viewdata
      })
    end
  end
...
function TempPersonalPicturePanel:OnEnter()
  TempPersonalPicturePanel.super.OnEnter(self)
  TimeTickManager.Me():CreateTick(1000, 500, self.refreshLRIndicator, self, SceneryListPage.ClickId.RefreshIndicator)
end

function TempPersonalPicturePanel:OnExit()
  TimeTickManager.Me():ClearTick(self)
  TempPersonalPicturePanel.super.OnExit(self)
end

function TempPersonalPicturePanel:OnDestroy()
  self.wraplist:Destroy()
  TempPersonalPicturePanel.super.OnDestroy(self)
end
