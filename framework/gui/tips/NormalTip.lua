...
function NormalTip:InitTip()
  ...
  local upPanel = Game.GameObjectUtil:FindCompInParents(self.stick.gameObject, UIPanel)
...
function NormalTip:SetOverflow(overflowMethod)
  self.desc.overflowMethod = overflowMethod
