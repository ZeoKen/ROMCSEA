...
local StudentTipColor = Color(1.0, 0.9372549019607843, 0.6352941176470588, 1)
local TutorTipColor = Color(0.8156862745098039, 0.9098039215686274, 0.9921568627450981, 1)
local StudentTipLabelColor = Color(0.7019607843137254, 0.4196078431372549, 0.1411764705882353, 1)
local TutorTipLabelColor = Color(0.12156862745098039, 0.4549019607843137, 0.7490196078431373, 1)
