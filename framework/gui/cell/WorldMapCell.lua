...
function WorldMapCell:SetChooseLabel(bool)
  if bool then
    self.name.effectStyle = UILabel.Effect.Outline
    self.lvname.effectStyle = UILabel.Effect.Outline
    self.name.effectColor = LuaGeometry.GetTempVector4(0.22745098039215686, 0.47843137254901963, 0.6980392156862745, 1)
    self.lvname.effectColor = LuaGeometry.GetTempVector4(0.22745098039215686, 0.47843137254901963, 0.6980392156862745, 1)
  else
    self.name.effectStyle = UILabel.Effect.None
    self.lvname.effectStyle = UILabel.Effect.None
  end
end
