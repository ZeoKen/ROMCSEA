...
function GvgFinalRankCell:initView()
  ...
  local l_progressForeSp = self:FindComponent("foreSp", UISprite, self.progress.gameObject)
  local l_progressBG = self:FindComponent("bg", UISprite, self.progress.gameObject)
  IconManager:SetItemIcon("item_52007", l_progressForeSp)
  IconManager:SetItemIcon("item_52007", l_progressBG)
end
