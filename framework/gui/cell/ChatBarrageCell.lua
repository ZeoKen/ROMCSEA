...
function ChatBarrageCell:SetData(data)
  if data then
    self.label.text = OverSea.LangManager.Instance():GetLangByKey(data.name) .. ZhString.Colon .. data.text
    ...
    tmpPos[1] = -640 - self.label.localSize.x
