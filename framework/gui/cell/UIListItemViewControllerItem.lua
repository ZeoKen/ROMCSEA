...
function UIListItemViewControllerItem:OnClickForSelf()
  ...
  if not NewRechargeProxy.Ins.UseCompatVer then
    self:ShowItemTip(tab, self.ItemTipAnchor, NGUIUtil.AnchorSide.Left, {-168, -28})
  else
...
function UIListItemViewControllerItem:SetItemTipAnchor(widget)
  self.ItemTipAnchorWidget = widget
end
