...
function MaintenanceMsg:ctor(parent)
  if parent then
    ...
    UIManagerProxy.Instance:RegisterChildPopObj(UIViewType.FloatLayer, self.gameObject)
    tempV3[2] = 20
...
function MaintenanceMsg:Exit()
  UIManagerProxy.Instance:UnRegisterChildPopObj(UIViewType.FloatLayer, self.gameObject)
