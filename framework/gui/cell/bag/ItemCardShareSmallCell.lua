...
ItemCardShareSmallCell = class("ItemCardShareSmallCell", BaseCell)
CardUIConfig_Quality = {
  ...
  [5] = {bgColor = "F9E9B6", cardQualityColor = "FFDB35"},
  [6] = {bgColor = "F9C0BC", cardQualityColor = "FF3D31"}
}

function ItemCardShareSmallCell:ctor(go)
  ItemCardShareSmallCell.super.ctor(self, go)
end

function ItemCardShareSmallCell:Init()
  self:FindObj()
end

function ItemCardShareSmallCell:FindObj()
...
function ItemCardShareSmallCell:SetData(data)
...
function ItemCardShareSmallCell:SetIcon(spriteName)
end

function ItemCardShareSmallCell:SetCardGrey(grey)
  if grey == nil then
    grey = false
  end
  if grey then
