...
function Astrolabe_LineCell:ctor()
  self.gameObject = AstrolabeCellPool.Instance:CreateAstrolabeAsset(Line_Path)
...
function Astrolabe_LineCell:ReSetPos(p1_x, p1_y, p1_z, p2_x, p2_y, p2_z)
  LuaVector3.Better_Set(tempV3_1, p1_x, p1_y, p1_z)
  LuaVector3.Better_Set(tempV3_2, p2_x, p2_y, p2_z)
  ...
  LuaVector3.Better_Set(tempV3_1, tempV3_2[1] - x, tempV3_2[2] - y, tempV3_2[3] - z)
  LuaVector3.Better_Set(tempV3_2, 1, 0, 0)
  local angle = LuaVector3.Angle(tempV3_2, tempV3_1)
  angle = tempV3_1[2] > 0 and angle or -angle
  LuaVector3.Better_Set(tempV3_1, 0, 0, angle)
