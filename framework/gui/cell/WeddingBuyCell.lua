...
function WeddingBuyCell:SetDisCountTip(b, pct)
  if self.discountTip then
    if b then
      ...
      self.discountTip_Label.text = math.ceil(pct) .. "%"
    else
