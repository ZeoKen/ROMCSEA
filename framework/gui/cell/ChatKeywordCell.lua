...
function ChatKeywordCell:SetData(data)
  ...
  if data then
    ...
    self.tweenPosition.from = Vector3(math.random(self.corners[2].x + self.sprite.localSize.x / 2, self.corners[3].x - self.sprite.localSize.x / 2), self.corners[2].y - self.sprite.localSize.y / 2, self.corners[2].z)
    self.tweenPosition.to = Vector3(math.random(self.corners[1].x + self.sprite.localSize.x / 2, self.corners[4].x - self.sprite.localSize.x / 2), self.corners[1].y + self.sprite.localSize.y / 2, self.corners[1].z)
