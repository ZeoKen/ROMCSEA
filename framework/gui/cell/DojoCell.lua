...
function DojoCell:FindObjs()
  ...
  IconManager:SetArtFontIcon("Rewardtask_txt_1", self.completed:GetComponent(UISprite))
  ...
  if data then
    ...
    if dojoData then
      if dojoData.HeadImage then
        ...
        self.head.gameObject.transform.localScale = LuaGeometry.GetTempVector3(0.67, 0.67, 1)
      else
