...
function CardCell:SetData(data)
  ...
  if data and data.staticData then
    ...
    self.icon.color = showGrey and Color(0.00392156862745098, 0.00784313725490196, 0.011764705882352941, 0.01568627450980392) or Color(1, 1, 1)
    if self.num then
      if 0 < data.num then
    ...
    local isNew = (data:IsNew() or false) and 0 < data.num
