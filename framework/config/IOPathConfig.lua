...
IOPathConfig.Paths.PublicVideoRoot = "PublicVideoRoot"
...
function IOPathConfig.Init(userGuid, server, roleID)
  ...
  IOPathConfig.Paths.Extension.AudioHD = IOPathConfig.Paths.Extension.Root .. "/AudioHD"
  IOPathConfig.Paths.Extension.Postcard = IOPathConfig.Paths.Extension.ServerX .. "/Postcard"
  IOPathConfig.Datas = {}
  IOPathConfig.Datas.USER = {
    Root = {
      Directory = IOPathConfig.Paths.Root,
      LRU_Count = 1
    },
    UserGuid = {
      Directory = IOPathConfig.Paths.USER.UserGuid,
      LRU_Count = 2
    },
    Server = {
      Directory = IOPathConfig.Paths.USER.Server
    },
    Role = {
      Directory = IOPathConfig.Paths.USER.Role
    },
    ScenicSpot = {
      Directory = IOPathConfig.Paths.USER.ScenicSpot
    },
    ScenicSpotPreview = {
      Directory = IOPathConfig.Paths.USER.ScenicSpotPreview
    },
    ScenicSpotPhoto = {
      Directory = IOPathConfig.Paths.USER.ScenicSpotPhoto,
      LRU_Count = 40
    },
    UnionWallPhoto = {
      Directory = IOPathConfig.Paths.USER.UnionWallPhoto
    },
    UnionWallPhotoOrigin = {
      Directory = IOPathConfig.Paths.USER.UnionWallPhotoOrigin,
      LRU_Count = 50
    },
    UnionWallPhotoThumbnail = {
      Directory = IOPathConfig.Paths.USER.UnionWallPhotoThumbnail,
      LRU_Count = 500
    },
    PersonalPhoto = {
      Directory = IOPathConfig.Paths.USER.PersonalPhoto
    },
    PersonalPhotoOrigin = {
      Directory = IOPathConfig.Paths.USER.PersonalPhotoOrigin,
      LRU_Count = 50
    },
    PersonalPhotoThumbnail = {
      Directory = IOPathConfig.Paths.USER.PersonalPhotoThumbnail,
      LRU_Count = 500
    },
    UnionLogo = {
      Directory = IOPathConfig.Paths.USER.UnionLogo
    },
    UnionLogoOrigin = {
      Directory = IOPathConfig.Paths.USER.UnionLogoOrigin,
      LRU_Count = 50
    },
    UnionLogoThumbnail = {
      Directory = IOPathConfig.Paths.USER.UnionLogoThumbnail,
      LRU_Count = 500
    },
    MarryPhoto = {
      Directory = IOPathConfig.Paths.USER.MarryPhoto
    },
    MarryPhotoOrigin = {
      Directory = IOPathConfig.Paths.USER.MarryPhotoOrigin,
      LRU_Count = 10
    },
    MarryPhotoThumbnail = {
      Directory = IOPathConfig.Paths.USER.MarryPhotoThumbnail,
      LRU_Count = 100
    },
    PrivateChat = {
      Directory = IOPathConfig.Paths.USER.PrivateChat
    },
    PrivateChatUser = {
      Directory = IOPathConfig.Paths.USER.PrivateChatUser
    },
    Chat = {
      Directory = IOPathConfig.Paths.USER.Chat
    },
    ChatSpeech = {
      Directory = IOPathConfig.Paths.USER.ChatSpeech,
      LRU_Count = 10
    }
  }
  IOPathConfig.Datas.PUBLICPIC = {
    Root = {
      Directory = IOPathConfig.Paths.PublicPicRoot
    },
    ActivityPicture = {
      Directory = IOPathConfig.Paths.PUBLICPIC.ActivityPicture,
      LRU_Count = 30
    },
    LotteryPicture = {
      Directory = IOPathConfig.Paths.PUBLICPIC.LotteryPicture,
      LRU_Count = 10
    }
  }
  ...
  IOPathConfig.Datas.Extension.Postcard = {}
end
