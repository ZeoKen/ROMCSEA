...
ReloadDatasCommand = autoImport("ReloadDatasCommand")
...
autoImport("ServiceMapAnimeCommand")
...
function PrepCMDCommand:execute(notifi)
  ...
  GameFacade.Instance:registerCommand(ServiceEvent.ReloadDatas, ReloadDatasCommand)
  ...
  GameFacade.Instance:registerCommand(ServiceEvent.NUserMapAnimeUserCmd, ServiceMapAnimeCommand)
  ...
  GameFacade.Instance:registerCommand(TeamEvent.MemberAfkChange, FollowCommand)
  GameFacade.Instance:registerCommand(TeamEvent.MemberOffline, FollowCommand)
  ...
  GameFacade.Instance:registerCommand(MyselfEvent.AddWeakDialog, WeakDialogCommand)
end
