...
QuotaCardProxy.Type = {
  ...
  ExchangeGiveLock = SceneItem_pb.EQuotaType_L_Give_Trade,
  ExchangeGiveUnLock = SceneItem_pb.EQuotaType_U_Give_Trade,
  ExchangeGiveCost = SceneItem_pb.EQuotaType_C_Give_Trade,
  Reward = SceneItem_pb.EQuotaType_G_Reward,
  GuildMaterial = SceneItem_pb.EQuotaType_C_GuildMaterial,
  ChargeLock = SceneItem_pb.EQuotaType_L_Charge,
  ChargeUnLock = SceneItem_pb.EQuotaType_U_Charge,
  ChargeBack = SceneItem_pb.EQuotaType_C_ChargeBack
}
