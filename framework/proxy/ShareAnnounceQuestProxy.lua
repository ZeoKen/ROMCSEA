...
function ShareAnnounceQuestProxy:RecvQuestWantedQuestTeamCmd(data)
  helplog("YYF==================function ShareAnnounceQuestProxy:RecvQuestWantedQuestTeamCmd(data)")
...
function ShareAnnounceQuestProxy:RecvUpdateWantedQuestTeamCmd(data)
  helplog("YYF==================function ShareAnnounceQuestProxy:RecvUpdateWantedQuestTeamCmd(data)")
  local bRet = false
...
function ShareAnnounceQuestProxy:RecvUpdateHelpWantedTeamCmd(data)
  ...
  if dels and 0 < #dels then
    for i = 1, #dels do
      self:removeHelpQuestId(dels[i])
    end
  end
  if adds and 0 < #adds then
    for i = 1, #adds do
