...
BusinessmanMakeProxy.Skill = {
  Businessman = {
    Type = 3,
    Category = {
      BusinessmanMakeProxy.Category.AttributeWeapon,
      BusinessmanMakeProxy.Category.MagicStone,
      BusinessmanMakeProxy.Category.SharpGold
    }
  },
  Alchemist = {
    Type = 4,
    Category = {
      BusinessmanMakeProxy.Category.Medicine,
      BusinessmanMakeProxy.Category.Property
    }
  },
  Knight = {
    Type = 5,
    Category = {
      BusinessmanMakeProxy.Category.Runestone
    }
  },
  Hollgrehenn = {
    Type = 6,
    Category = {
      BusinessmanMakeProxy.Category.HGold
    }
  }
}
