...
function ServiceErrorUserCmdProxy:RecvRegErrUserCmd(data)
  ...
  FunctionNetError.Me():ShowErrorById(data.ret, data.args, data.lockreason)
...
function ServiceErrorUserCmdProxy:RecvMaintainUserCmd(data)
  ...
  FloatingPanel.Instance:ShowMaintenanceMsg(ZhString.ServiceErrorUserCmdProxy_Maintain, data.content, data.tip, ZhString.ServiceErrorUserCmdProxy_Confirm, data.picture)
