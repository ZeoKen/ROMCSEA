...
function ServiceSceneSealProxy:CallBeginSeal(sealid, etype, finishall)
  helplog("Call-->BeginSeal", sealid, etype, finishall)
  ServiceSceneSealProxy.super.CallBeginSeal(self, sealid, etype, finishall)
end
...
function ServiceSceneSealProxy:RecvSealQueryList(data)
  ...
  SealProxy.Instance:SetQuickFinishForbid(data.configparts)
