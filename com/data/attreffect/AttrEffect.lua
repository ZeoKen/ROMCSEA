...
function AttrEffectB:IsOnWolf()
  return BitUtil.bandOneZero(self.value, 17) > 0
end

function AttrEffectB:IsHideCancelTransformBtn()
  return BitUtil.bandOneZero(self.value, 26) > 0
end

function AttrEffectB:IsEatBeing()
  return BitUtil.bandOneZero(self.value, 28) > 0
end

AttrEffectC = class("AttrEffectC")

function AttrEffectC:ctor()
  self:Reset()
end

function AttrEffectC:Reset()
  self.value = 0
end

function AttrEffectC:Set(value)
  self.value = value
end

function AttrEffectC:Get(flag)
  return BitUtil.bandOneZero(self.value, flag)
end

function AttrEffectC:HideMyself()
  return self:Get(6)
end

function AttrEffectC:NextTargetSkillLargeLaunchRange()
  return self:Get(14) > 0
end

function AttrEffectC:BlindnessState()
  return self:Get(16) > 0
end
