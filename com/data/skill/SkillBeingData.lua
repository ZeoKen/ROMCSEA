...
function SkillBeingData:CheckBeing(skill)
  ...
  if limitLevel then
    ...
    if being then
      return limitLevel <= being.lv, limitLevel
    end
    return limitLevel <= 6, limitLevel
  end
...
function SkillBeingData:UpdateSingleSkill(skillItemData, serverSkillItem)
  ...
  if skillItemData and skillItemData.learned and TableUtility.ArrayFindIndex(self.learnedSkills, skillItemData) == 0 then
