...
Table_PveRaidEntrance = {
  [1] = {
    ...
    Monster = Table_PveRaidEntrance_t.Monster[2],
    TimeCost = 7200,
    ClientRewards = Table_PveRaidEntrance_t.ClientRewards[2],
    ShowKillBoss = 3,
    WeekLimit = 1
  },
  [2] = {
    ...
    ChallengeCount = 4,
    FreeBattleTimeCount = 1,
    Monster = Table_PveRaidEntrance_t.Monster[3],
    TimeCost = 7200,
    ClientRewards = Table_PveRaidEntrance_t.ClientRewards[3],
    ShowKillBoss = 3,
    WeekLimit = 1
  },
  [4] = {
    ...
    ChallengeCount = 4,
    FreeBattleTimeCount = 1,
    Monster = Table_PveRaidEntrance_t.Monster[5],
    TimeCost = 7200,
    ClientRewards = Table_PveRaidEntrance_t.ClientRewards[5],
    ShowKillBoss = 3,
    WeekLimit = 2
  },
  [5] = {
    ...
    ChallengeCount = 4,
    FreeBattleTimeCount = 1,
    Monster = Table_PveRaidEntrance_t.Monster[6],
    TimeCost = 7200,
    ClientRewards = Table_PveRaidEntrance_t.ClientRewards[6],
    ShowKillBoss = 3,
    WeekLimit = 2
  },
  [12] = {
  ...
  [15] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 4,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[11],
    Difficulty = 31,
    UnlockLv = 50,
    RecommendLv = 65,
    RecommendPlayerNum = 1,
  ...
  [16] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 4,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[12],
    Difficulty = 41,
    UnlockLv = 50,
    RecommendPlayerNum = 1,
    ChallengeContent = 2,
  ...
  [17] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 4,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[13],
    Difficulty = 51,
    UnlockLv = 50,
    RecommendLv = 75,
    RecommendPlayerNum = 1,
  ...
  [18] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 4,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[14],
    Difficulty = 61,
    UnlockLv = 50,
    RecommendLv = 85,
    RecommendPlayerNum = 1,
  ...
  [19] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 4,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[15],
    Difficulty = 71,
    UnlockLv = 50,
    RecommendLv = 95,
    RecommendPlayerNum = 1,
  ...
  [20] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 4,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[16],
    Difficulty = 81,
    UnlockLv = 50,
    RecommendLv = 100,
    RecommendPlayerNum = 1,
  ...
  [21] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 4,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[17],
    Difficulty = 91,
    UnlockLv = 50,
    RecommendLv = 100,
    RecommendPlayerNum = 1,
  ...
  [254] = {
    ...
    Catalog = Table_PveRaidEntrance_t.Catalog[1],
    RaidType = 73,
    DifficultyName = Table_PveRaidEntrance_t.DifficultyName[1],
    Difficulty = 1004204,
    UnlockMsgId = 43504,
    UnlockLv = 60,
    RecommendLv = 60,
    PlayerNumCount = 30,
    FreeBattleTimeCount = 1,
    Monster = Table_PveRaidEntrance_t.Monster[1],
    TimeCost = 1800,
    ClientRewards = Table_PveRaidEntrance_t.ClientRewards[1]
  },
  [255] = {
    id = 255,
    GroupId = 32,
  ...
  [261] = {
    ...
    PlayerNumCount = 30,
    FreeBattleTimeCount = 1,
    Monster = Table_PveRaidEntrance_t.Monster[8],
    TimeCost = 1800,
    ClientRewards = Table_PveRaidEntrance_t.ClientRewards[8]
  },
  [262] = {
    id = 262,
    GroupId = 32,
    ...
    PlayerNumCount = 30,
    FreeBattleTimeCount = 1,
    Monster = Table_PveRaidEntrance_t.Monster[9],
    TimeCost = 1800,
